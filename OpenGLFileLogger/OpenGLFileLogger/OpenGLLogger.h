...
#ifndef __OpenGLFileLogger__OpenGLLogger__
#define __OpenGLFileLogger__OpenGLLogger__
...
{
public:
	OpenGLLogger(std::string log_path);
	~OpenGLLogger();
...
#endif /* defined(__OpenGLFileLogger__OpenGLLogger__) */
