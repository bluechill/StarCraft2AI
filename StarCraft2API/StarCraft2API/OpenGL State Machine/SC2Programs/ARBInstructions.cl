...
float4 RCP(float tmp)
{
	...
	result.x = native_recip(tmp);
	result.y = native_recip(tmp);
	result.z = native_recip(tmp);
	result.w = native_recip(tmp);
...
float4 RSQ(float op0)
{
	...
	result.x = native_recip(sqrt(tmp));
	result.y = native_recip(sqrt(tmp));
	result.z = native_recip(sqrt(tmp));
	result.w = native_recip(sqrt(tmp));
