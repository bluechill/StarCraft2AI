...
static void HandleCGLGetCurrentContext(CGLContextObj obj)
{
	...
	if (obj && overriden_ctx.find(obj->rend) == overriden_ctx.end())
	{
		...
		MACH_OVERRIDE(void,accum,(GLIContext ctx, GLenum op, GLfloat value), err ) {
			file_log("accum called: ctx (GLIContext : %p)op (GLenum : %s)value (GLfloat : %f)", ctx, op, value);
		...
		MACH_OVERRIDE(void,alpha_func,(GLIContext ctx, GLenum func, GLclampf ref), err ) {
			file_log("alpha_func called: ctx (GLIContext : %p)func (GLenum : %s)ref (GLclampf : %f)", ctx, func, ref);
		...
		MACH_OVERRIDE(GLboolean,are_textures_resident,(GLIContext ctx, GLsizei n, const GLuint *textures, GLboolean *residences), err ) {
			file_log("are_textures_resident called: ctx (GLIContext : %p)n (GLsizei : %i)textures (const GLuint* : %p)residences (GLboolean* : %p)", ctx, n, textures, residences);
		...
		MACH_OVERRIDE(void,array_element,(GLIContext ctx, GLint i), err ) {
			file_log("array_element called: ctx (GLIContext : %p)i (GLint : %i)", ctx, i);
		...
		MACH_OVERRIDE(void,begin,(GLIContext ctx, GLenum mode), err ) {
			file_log("begin called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,bind_texture,(GLIContext ctx, GLenum target, GLuint texture), err ) {
			file_log("bind_texture called: ctx (GLIContext : %p)target (GLenum : %s)texture (GLuint : %u)", ctx, target, texture);
		...
		MACH_OVERRIDE(void,bitmap,(GLIContext ctx, GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap), err ) {
			file_log("bitmap called: ctx (GLIContext : %p)width (GLsizei : %i)height (GLsizei : %i)xorig (GLfloat : %f)yorig (GLfloat : %f)xmove (GLfloat : %f)ymove (GLfloat : %f)bitmap (const GLubyte* : %p)", ctx, width, height, xorig, yorig, xmove, ymove, bitmap);
		...
		MACH_OVERRIDE(void,blend_func,(GLIContext ctx, GLenum sfactor, GLenum dfactor), err ) {
			file_log("blend_func called: ctx (GLIContext : %p)sfactor (GLenum : %s)dfactor (GLenum : %s)", ctx, sfactor, dfactor);
		...
		MACH_OVERRIDE(void,call_list,(GLIContext ctx, GLuint list), err ) {
			file_log("call_list called: ctx (GLIContext : %p)list (GLuint : %u)", ctx, list);
		...
		MACH_OVERRIDE(void,call_lists,(GLIContext ctx, GLsizei n, GLenum type, const GLvoid *lists), err ) {
			file_log("call_lists called: ctx (GLIContext : %p)n (GLsizei : %i)type (GLenum : %s)lists (const GLvoid* : %p)", ctx, n, type, lists);
		...
		MACH_OVERRIDE(void,clear,(GLIContext ctx, GLbitfield mask), err ) {
			file_log("clear called: ctx (GLIContext : %p)mask (GLbitfield : %u)", ctx, mask);
		...
		MACH_OVERRIDE(void,clear_accum,(GLIContext ctx, GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha), err ) {
			file_log("clear_accum called: ctx (GLIContext : %p)red (GLfloat : %f)green (GLfloat : %f)blue (GLfloat : %f)alpha (GLfloat : %f)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,clear_color,(GLIContext ctx, GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha), err ) {
			file_log("clear_color called: ctx (GLIContext : %p)red (GLclampf : %f)green (GLclampf : %f)blue (GLclampf : %f)alpha (GLclampf : %f)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,clear_depth,(GLIContext ctx, GLclampd depth), err ) {
			file_log("clear_depth called: ctx (GLIContext : %p)depth (GLclampd : %f)", ctx, depth);
		...
		MACH_OVERRIDE(void,clear_index,(GLIContext ctx, GLfloat c), err ) {
			file_log("clear_index called: ctx (GLIContext : %p)c (GLfloat : %f)", ctx, c);
		...
		MACH_OVERRIDE(void,clear_stencil,(GLIContext ctx, GLint s), err ) {
			file_log("clear_stencil called: ctx (GLIContext : %p)s (GLint : %i)", ctx, s);
		...
		MACH_OVERRIDE(void,clip_plane,(GLIContext ctx, GLenum plane, const GLdouble *equation), err ) {
			file_log("clip_plane called: ctx (GLIContext : %p)plane (GLenum : %s)equation (const GLdouble* : %p)", ctx, plane, equation);
		...
		MACH_OVERRIDE(void,color3b,(GLIContext ctx, GLbyte red, GLbyte green, GLbyte blue), err ) {
			file_log("color3b called: ctx (GLIContext : %p)red (GLbyte : %i)green (GLbyte : %i)blue (GLbyte : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3bv,(GLIContext ctx, const GLbyte *v), err ) {
			file_log("color3bv called: ctx (GLIContext : %p)v (const GLbyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3d,(GLIContext ctx, GLdouble red, GLdouble green, GLdouble blue), err ) {
			file_log("color3d called: ctx (GLIContext : %p)red (GLdouble : %f)green (GLdouble : %f)blue (GLdouble : %f)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("color3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3f,(GLIContext ctx, GLfloat red, GLfloat green, GLfloat blue), err ) {
			file_log("color3f called: ctx (GLIContext : %p)red (GLfloat : %f)green (GLfloat : %f)blue (GLfloat : %f)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("color3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3i,(GLIContext ctx, GLint red, GLint green, GLint blue), err ) {
			file_log("color3i called: ctx (GLIContext : %p)red (GLint : %i)green (GLint : %i)blue (GLint : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("color3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3s,(GLIContext ctx, GLshort red, GLshort green, GLshort blue), err ) {
			file_log("color3s called: ctx (GLIContext : %p)red (GLshort : %i)green (GLshort : %i)blue (GLshort : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("color3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3ub,(GLIContext ctx, GLubyte red, GLubyte green, GLubyte blue), err ) {
			file_log("color3ub called: ctx (GLIContext : %p)red (GLubyte : %u)green (GLubyte : %u)blue (GLubyte : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3ubv,(GLIContext ctx, const GLubyte *v), err ) {
			file_log("color3ubv called: ctx (GLIContext : %p)v (const GLubyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3ui,(GLIContext ctx, GLuint red, GLuint green, GLuint blue), err ) {
			file_log("color3ui called: ctx (GLIContext : %p)red (GLuint : %u)green (GLuint : %u)blue (GLuint : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3uiv,(GLIContext ctx, const GLuint *v), err ) {
			file_log("color3uiv called: ctx (GLIContext : %p)v (const GLuint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color3us,(GLIContext ctx, GLushort red, GLushort green, GLushort blue), err ) {
			file_log("color3us called: ctx (GLIContext : %p)red (GLushort : %u)green (GLushort : %u)blue (GLushort : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,color3usv,(GLIContext ctx, const GLushort *v), err ) {
			file_log("color3usv called: ctx (GLIContext : %p)v (const GLushort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4b,(GLIContext ctx, GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha), err ) {
			file_log("color4b called: ctx (GLIContext : %p)red (GLbyte : %i)green (GLbyte : %i)blue (GLbyte : %i)alpha (GLbyte : %i)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4bv,(GLIContext ctx, const GLbyte *v), err ) {
			file_log("color4bv called: ctx (GLIContext : %p)v (const GLbyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4d,(GLIContext ctx, GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha), err ) {
			file_log("color4d called: ctx (GLIContext : %p)red (GLdouble : %f)green (GLdouble : %f)blue (GLdouble : %f)alpha (GLdouble : %f)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("color4dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4f,(GLIContext ctx, GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha), err ) {
			file_log("color4f called: ctx (GLIContext : %p)red (GLfloat : %f)green (GLfloat : %f)blue (GLfloat : %f)alpha (GLfloat : %f)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("color4fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4i,(GLIContext ctx, GLint red, GLint green, GLint blue, GLint alpha), err ) {
			file_log("color4i called: ctx (GLIContext : %p)red (GLint : %i)green (GLint : %i)blue (GLint : %i)alpha (GLint : %i)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("color4iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4s,(GLIContext ctx, GLshort red, GLshort green, GLshort blue, GLshort alpha), err ) {
			file_log("color4s called: ctx (GLIContext : %p)red (GLshort : %i)green (GLshort : %i)blue (GLshort : %i)alpha (GLshort : %i)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("color4sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4ub,(GLIContext ctx, GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha), err ) {
			file_log("color4ub called: ctx (GLIContext : %p)red (GLubyte : %u)green (GLubyte : %u)blue (GLubyte : %u)alpha (GLubyte : %u)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4ubv,(GLIContext ctx, const GLubyte *v), err ) {
			file_log("color4ubv called: ctx (GLIContext : %p)v (const GLubyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4ui,(GLIContext ctx, GLuint red, GLuint green, GLuint blue, GLuint alpha), err ) {
			file_log("color4ui called: ctx (GLIContext : %p)red (GLuint : %u)green (GLuint : %u)blue (GLuint : %u)alpha (GLuint : %u)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4uiv,(GLIContext ctx, const GLuint *v), err ) {
			file_log("color4uiv called: ctx (GLIContext : %p)v (const GLuint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color4us,(GLIContext ctx, GLushort red, GLushort green, GLushort blue, GLushort alpha), err ) {
			file_log("color4us called: ctx (GLIContext : %p)red (GLushort : %u)green (GLushort : %u)blue (GLushort : %u)alpha (GLushort : %u)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color4usv,(GLIContext ctx, const GLushort *v), err ) {
			file_log("color4usv called: ctx (GLIContext : %p)v (const GLushort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,color_mask,(GLIContext ctx, GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha), err ) {
			file_log("color_mask called: ctx (GLIContext : %p)red (GLboolean : %i)green (GLboolean : %i)blue (GLboolean : %i)alpha (GLboolean : %i)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,color_material,(GLIContext ctx, GLenum face, GLenum mode), err ) {
			file_log("color_material called: ctx (GLIContext : %p)face (GLenum : %s)mode (GLenum : %s)", ctx, face, mode);
		...
		MACH_OVERRIDE(void,color_pointer,(GLIContext ctx, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("color_pointer called: ctx (GLIContext : %p)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,copy_pixels,(GLIContext ctx, GLint x, GLint y, GLsizei width, GLsizei height, GLenum type), err ) {
			file_log("copy_pixels called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)type (GLenum : %s)", ctx, x, y, width, height, type);
		...
		MACH_OVERRIDE(void,copy_tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border), err ) {
			file_log("copy_tex_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalFormat (GLenum : %s)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)border (GLint : %i)", ctx, target, level, internalFormat, x, y, width, border);
		...
		MACH_OVERRIDE(void,copy_tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border), err ) {
			file_log("copy_tex_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalFormat (GLenum : %s)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)border (GLint : %i)", ctx, target, level, internalFormat, x, y, width, height, border);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width), err ) {
			file_log("copy_tex_sub_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)", ctx, target, level, xoffset, x, y, width);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			file_log("copy_tex_sub_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, level, xoffset, yoffset, x, y, width, height);
		...
		MACH_OVERRIDE(void,cull_face,(GLIContext ctx, GLenum mode), err ) {
			file_log("cull_face called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,delete_lists,(GLIContext ctx, GLuint list, GLsizei range), err ) {
			file_log("delete_lists called: ctx (GLIContext : %p)list (GLuint : %u)range (GLsizei : %i)", ctx, list, range);
		...
		MACH_OVERRIDE(void,delete_textures,(GLIContext ctx, GLsizei n, const GLuint *textures), err ) {
			file_log("delete_textures called: ctx (GLIContext : %p)n (GLsizei : %i)textures (const GLuint* : %p)", ctx, n, textures);
		...
		MACH_OVERRIDE(void,depth_func,(GLIContext ctx, GLenum func), err ) {
			file_log("depth_func called: ctx (GLIContext : %p)func (GLenum : %s)", ctx, func);
		...
		MACH_OVERRIDE(void,depth_mask,(GLIContext ctx, GLboolean flag), err ) {
			file_log("depth_mask called: ctx (GLIContext : %p)flag (GLboolean : %i)", ctx, flag);
		...
		MACH_OVERRIDE(void,depth_range,(GLIContext ctx, GLclampd zNear, GLclampd zFar), err ) {
			file_log("depth_range called: ctx (GLIContext : %p)zNear (GLclampd : %f)zFar (GLclampd : %f)", ctx, zNear, zFar);
		...
		MACH_OVERRIDE(void,disable,(GLIContext ctx, GLenum cap), err ) {
			file_log("disable called: ctx (GLIContext : %p)cap (GLenum : %s)", ctx, cap);
		...
		MACH_OVERRIDE(void,disable_client_state,(GLIContext ctx, GLenum array), err ) {
			file_log("disable_client_state called: ctx (GLIContext : %p)array (GLenum : %s)", ctx, array);
		...
		MACH_OVERRIDE(void,draw_arrays,(GLIContext ctx, GLenum mode, GLint first, GLsizei count), err ) {
			file_log("draw_arrays called: ctx (GLIContext : %p)mode (GLenum : %s)first (GLint : %i)count (GLsizei : %i)", ctx, mode, first, count);
		...
		MACH_OVERRIDE(void,draw_buffer,(GLIContext ctx, GLenum mode), err ) {
			file_log("draw_buffer called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,draw_elements,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices), err ) {
			file_log("draw_elements called: ctx (GLIContext : %p)mode (GLenum : %s)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)", ctx, mode, count, type, indices);
		...
		MACH_OVERRIDE(void,draw_pixels,(GLIContext ctx, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("draw_pixels called: ctx (GLIContext : %p)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, width, height, format, type, pixels);
		...
		MACH_OVERRIDE(void,edge_flag,(GLIContext ctx, GLboolean flag), err ) {
			file_log("edge_flag called: ctx (GLIContext : %p)flag (GLboolean : %i)", ctx, flag);
		...
		MACH_OVERRIDE(void,edge_flag_pointer,(GLIContext ctx, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("edge_flag_pointer called: ctx (GLIContext : %p)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, stride, pointer);
		...
		MACH_OVERRIDE(void,edge_flagv,(GLIContext ctx, const GLboolean *flag), err ) {
			file_log("edge_flagv called: ctx (GLIContext : %p)flag (const GLboolean* : %p)", ctx, flag);
		...
		MACH_OVERRIDE(void,enable,(GLIContext ctx, GLenum cap), err ) {
			file_log("enable called: ctx (GLIContext : %p)cap (GLenum : %s)", ctx, cap);
		...
		MACH_OVERRIDE(void,enable_client_state,(GLIContext ctx, GLenum array), err ) {
			file_log("enable_client_state called: ctx (GLIContext : %p)array (GLenum : %s)", ctx, array);
		...
		MACH_OVERRIDE(void,end,(GLIContext ctx), err ) {
			file_log("end called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,end_list,(GLIContext ctx), err ) {
			file_log("end_list called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,eval_coord1d,(GLIContext ctx, GLdouble u), err ) {
			file_log("eval_coord1d called: ctx (GLIContext : %p)u (GLdouble : %f)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_coord1dv,(GLIContext ctx, const GLdouble *u), err ) {
			file_log("eval_coord1dv called: ctx (GLIContext : %p)u (const GLdouble* : %p)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_coord1f,(GLIContext ctx, GLfloat u), err ) {
			file_log("eval_coord1f called: ctx (GLIContext : %p)u (GLfloat : %f)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_coord1fv,(GLIContext ctx, const GLfloat *u), err ) {
			file_log("eval_coord1fv called: ctx (GLIContext : %p)u (const GLfloat* : %p)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_coord2d,(GLIContext ctx, GLdouble u, GLdouble v), err ) {
			file_log("eval_coord2d called: ctx (GLIContext : %p)u (GLdouble : %f)v (GLdouble : %f)", ctx, u, v);
		...
		MACH_OVERRIDE(void,eval_coord2dv,(GLIContext ctx, const GLdouble *u), err ) {
			file_log("eval_coord2dv called: ctx (GLIContext : %p)u (const GLdouble* : %p)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_coord2f,(GLIContext ctx, GLfloat u, GLfloat v), err ) {
			file_log("eval_coord2f called: ctx (GLIContext : %p)u (GLfloat : %f)v (GLfloat : %f)", ctx, u, v);
		...
		MACH_OVERRIDE(void,eval_coord2fv,(GLIContext ctx, const GLfloat *u), err ) {
			file_log("eval_coord2fv called: ctx (GLIContext : %p)u (const GLfloat* : %p)", ctx, u);
		...
		MACH_OVERRIDE(void,eval_mesh1,(GLIContext ctx, GLenum mode, GLint i1, GLint i2), err ) {
			file_log("eval_mesh1 called: ctx (GLIContext : %p)mode (GLenum : %s)i1 (GLint : %i)i2 (GLint : %i)", ctx, mode, i1, i2);
		...
		MACH_OVERRIDE(void,eval_mesh2,(GLIContext ctx, GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2), err ) {
			file_log("eval_mesh2 called: ctx (GLIContext : %p)mode (GLenum : %s)i1 (GLint : %i)i2 (GLint : %i)j1 (GLint : %i)j2 (GLint : %i)", ctx, mode, i1, i2, j1, j2);
		...
		MACH_OVERRIDE(void,eval_point1,(GLIContext ctx, GLint i), err ) {
			file_log("eval_point1 called: ctx (GLIContext : %p)i (GLint : %i)", ctx, i);
		...
		MACH_OVERRIDE(void,eval_point2,(GLIContext ctx, GLint i, GLint j), err ) {
			file_log("eval_point2 called: ctx (GLIContext : %p)i (GLint : %i)j (GLint : %i)", ctx, i, j);
		...
		MACH_OVERRIDE(void,feedback_buffer,(GLIContext ctx, GLsizei size, GLenum type, GLfloat *buffer), err ) {
			file_log("feedback_buffer called: ctx (GLIContext : %p)size (GLsizei : %i)type (GLenum : %s)buffer (GLfloat* : %p)", ctx, size, type, buffer);
		...
		MACH_OVERRIDE(void,finish,(GLIContext ctx), err ) {
			file_log("finish called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,flush,(GLIContext ctx), err ) {
			file_log("flush called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,fogf,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("fogf called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,fogfv,(GLIContext ctx, GLenum pname, const GLfloat *params), err ) {
			file_log("fogfv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,fogi,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("fogi called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,fogiv,(GLIContext ctx, GLenum pname, const GLint *params), err ) {
			file_log("fogiv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLint* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,front_face,(GLIContext ctx, GLenum mode), err ) {
			file_log("front_face called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,frustum,(GLIContext ctx, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar), err ) {
			file_log("frustum called: ctx (GLIContext : %p)left (GLdouble : %f)right (GLdouble : %f)bottom (GLdouble : %f)top (GLdouble : %f)zNear (GLdouble : %f)zFar (GLdouble : %f)", ctx, left, right, bottom, top, zNear, zFar);
		...
		MACH_OVERRIDE(GLuint,gen_lists,(GLIContext ctx, GLsizei range), err ) {
			file_log("gen_lists called: ctx (GLIContext : %p)range (GLsizei : %i)", ctx, range);
		...
		MACH_OVERRIDE(void,gen_textures,(GLIContext ctx, GLsizei n, GLuint *textures), err ) {
			file_log("gen_textures called: ctx (GLIContext : %p)n (GLsizei : %i)textures (GLuint* : %p)", ctx, n, textures);
		...
		MACH_OVERRIDE(void,get_booleanv,(GLIContext ctx, GLenum pname, GLboolean *params), err ) {
			file_log("get_booleanv called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLboolean* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,get_clip_plane,(GLIContext ctx, GLenum plane, GLdouble *equation), err ) {
			file_log("get_clip_plane called: ctx (GLIContext : %p)plane (GLenum : %s)equation (GLdouble* : %p)", ctx, plane, equation);
		...
		MACH_OVERRIDE(void,get_doublev,(GLIContext ctx, GLenum pname, GLdouble *params), err ) {
			file_log("get_doublev called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLdouble* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(GLenum,get_error,(GLIContext ctx), err ) {
			file_log("get_error called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,get_floatv,(GLIContext ctx, GLenum pname, GLfloat *params), err ) {
			file_log("get_floatv called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLfloat* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,get_integerv,(GLIContext ctx, GLenum pname, GLint *params), err ) {
			file_log("get_integerv called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLint* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,get_lightfv,(GLIContext ctx, GLenum light, GLenum pname, GLfloat *params), err ) {
			file_log("get_lightfv called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, light, pname, params);
		...
		MACH_OVERRIDE(void,get_lightiv,(GLIContext ctx, GLenum light, GLenum pname, GLint *params), err ) {
			file_log("get_lightiv called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, light, pname, params);
		...
		MACH_OVERRIDE(void,get_mapdv,(GLIContext ctx, GLenum target, GLenum query, GLdouble *v), err ) {
			file_log("get_mapdv called: ctx (GLIContext : %p)target (GLenum : %s)query (GLenum : %s)v (GLdouble* : %p)", ctx, target, query, v);
		...
		MACH_OVERRIDE(void,get_mapfv,(GLIContext ctx, GLenum target, GLenum query, GLfloat *v), err ) {
			file_log("get_mapfv called: ctx (GLIContext : %p)target (GLenum : %s)query (GLenum : %s)v (GLfloat* : %p)", ctx, target, query, v);
		...
		MACH_OVERRIDE(void,get_mapiv,(GLIContext ctx, GLenum target, GLenum query, GLint *v), err ) {
			file_log("get_mapiv called: ctx (GLIContext : %p)target (GLenum : %s)query (GLenum : %s)v (GLint* : %p)", ctx, target, query, v);
		...
		MACH_OVERRIDE(void,get_materialfv,(GLIContext ctx, GLenum face, GLenum pname, GLfloat *params), err ) {
			file_log("get_materialfv called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, face, pname, params);
		...
		MACH_OVERRIDE(void,get_materialiv,(GLIContext ctx, GLenum face, GLenum pname, GLint *params), err ) {
			file_log("get_materialiv called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, face, pname, params);
		...
		MACH_OVERRIDE(void,get_pixel_mapfv,(GLIContext ctx, GLenum map, GLfloat *values), err ) {
			file_log("get_pixel_mapfv called: ctx (GLIContext : %p)map (GLenum : %s)values (GLfloat* : %p)", ctx, map, values);
		...
		MACH_OVERRIDE(void,get_pixel_mapuiv,(GLIContext ctx, GLenum map, GLuint *values), err ) {
			file_log("get_pixel_mapuiv called: ctx (GLIContext : %p)map (GLenum : %s)values (GLuint* : %p)", ctx, map, values);
		...
		MACH_OVERRIDE(void,get_pixel_mapusv,(GLIContext ctx, GLenum map, GLushort *values), err ) {
			file_log("get_pixel_mapusv called: ctx (GLIContext : %p)map (GLenum : %s)values (GLushort* : %p)", ctx, map, values);
		...
		MACH_OVERRIDE(void,get_pointerv,(GLIContext ctx, GLenum pname, GLvoid **params), err ) {
			file_log("get_pointerv called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLvoid** : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,get_polygon_stipple,(GLIContext ctx, GLubyte *mask), err ) {
			file_log("get_polygon_stipple called: ctx (GLIContext : %p)mask (GLubyte* : %p)", ctx, mask);
		...
		MACH_OVERRIDE(void,get_tex_envfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_tex_envfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_enviv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_tex_enviv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_gendv,(GLIContext ctx, GLenum coord, GLenum pname, GLdouble *params), err ) {
			file_log("get_tex_gendv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (GLdouble* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_genfv,(GLIContext ctx, GLenum coord, GLenum pname, GLfloat *params), err ) {
			file_log("get_tex_genfv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_geniv,(GLIContext ctx, GLenum coord, GLenum pname, GLint *params), err ) {
			file_log("get_tex_geniv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_image,(GLIContext ctx, GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels), err ) {
			file_log("get_tex_image called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)format (GLenum : %s)type (GLenum : %s)pixels (GLvoid* : %p)", ctx, target, level, format, type, pixels);
		...
		MACH_OVERRIDE(void,get_tex_level_parameterfv,(GLIContext ctx, GLenum target, GLint level, GLenum pname, GLfloat *params), err ) {
			file_log("get_tex_level_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, level, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_level_parameteriv,(GLIContext ctx, GLenum target, GLint level, GLenum pname, GLint *params), err ) {
			file_log("get_tex_level_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)pname (GLenum : %s)params (GLint* : %p)", ctx, target, level, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_tex_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_tex_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,hint,(GLIContext ctx, GLenum target, GLenum mode), err ) {
			file_log("hint called: ctx (GLIContext : %p)target (GLenum : %s)mode (GLenum : %s)", ctx, target, mode);
		...
		MACH_OVERRIDE(void,index_mask,(GLIContext ctx, GLuint mask), err ) {
			file_log("index_mask called: ctx (GLIContext : %p)mask (GLuint : %u)", ctx, mask);
		...
		MACH_OVERRIDE(void,index_pointer,(GLIContext ctx, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("index_pointer called: ctx (GLIContext : %p)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, type, stride, pointer);
		...
		MACH_OVERRIDE(void,indexd,(GLIContext ctx, GLdouble c), err ) {
			file_log("indexd called: ctx (GLIContext : %p)c (GLdouble : %f)", ctx, c);
		...
		MACH_OVERRIDE(void,indexdv,(GLIContext ctx, const GLdouble *c), err ) {
			file_log("indexdv called: ctx (GLIContext : %p)c (const GLdouble* : %p)", ctx, c);
		...
		MACH_OVERRIDE(void,indexf,(GLIContext ctx, GLfloat c), err ) {
			file_log("indexf called: ctx (GLIContext : %p)c (GLfloat : %f)", ctx, c);
		...
		MACH_OVERRIDE(void,indexfv,(GLIContext ctx, const GLfloat *c), err ) {
			file_log("indexfv called: ctx (GLIContext : %p)c (const GLfloat* : %p)", ctx, c);
		...
		MACH_OVERRIDE(void,indexi,(GLIContext ctx, GLint c), err ) {
			file_log("indexi called: ctx (GLIContext : %p)c (GLint : %i)", ctx, c);
		...
		MACH_OVERRIDE(void,indexiv,(GLIContext ctx, const GLint *c), err ) {
			file_log("indexiv called: ctx (GLIContext : %p)c (const GLint* : %p)", ctx, c);
		...
		MACH_OVERRIDE(void,indexs,(GLIContext ctx, GLshort c), err ) {
			file_log("indexs called: ctx (GLIContext : %p)c (GLshort : %i)", ctx, c);
		...
		MACH_OVERRIDE(void,indexsv,(GLIContext ctx, const GLshort *c), err ) {
			file_log("indexsv called: ctx (GLIContext : %p)c (const GLshort* : %p)", ctx, c);
		...
		MACH_OVERRIDE(void,indexub,(GLIContext ctx, GLubyte c), err ) {
			file_log("indexub called: ctx (GLIContext : %p)c (GLubyte : %u)", ctx, c);
		...
		MACH_OVERRIDE(void,indexubv,(GLIContext ctx, const GLubyte *c), err ) {
			file_log("indexubv called: ctx (GLIContext : %p)c (const GLubyte* : %p)", ctx, c);
		...
		MACH_OVERRIDE(void,init_names,(GLIContext ctx), err ) {
			file_log("init_names called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,interleaved_arrays,(GLIContext ctx, GLenum format, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("interleaved_arrays called: ctx (GLIContext : %p)format (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, format, stride, pointer);
		...
		MACH_OVERRIDE(GLboolean,is_enabled,(GLIContext ctx, GLenum cap), err ) {
			file_log("is_enabled called: ctx (GLIContext : %p)cap (GLenum : %s)", ctx, cap);
		...
		MACH_OVERRIDE(GLboolean,is_list,(GLIContext ctx, GLuint list), err ) {
			file_log("is_list called: ctx (GLIContext : %p)list (GLuint : %u)", ctx, list);
		...
		MACH_OVERRIDE(GLboolean,is_texture,(GLIContext ctx, GLuint texture), err ) {
			file_log("is_texture called: ctx (GLIContext : %p)texture (GLuint : %u)", ctx, texture);
		...
		MACH_OVERRIDE(void,light_modelf,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("light_modelf called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,light_modelfv,(GLIContext ctx, GLenum pname, const GLfloat *params), err ) {
			file_log("light_modelfv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,light_modeli,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("light_modeli called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,light_modeliv,(GLIContext ctx, GLenum pname, const GLint *params), err ) {
			file_log("light_modeliv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLint* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,lightf,(GLIContext ctx, GLenum light, GLenum pname, GLfloat param), err ) {
			file_log("lightf called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)param (GLfloat : %f)", ctx, light, pname, param);
		...
		MACH_OVERRIDE(void,lightfv,(GLIContext ctx, GLenum light, GLenum pname, const GLfloat *params), err ) {
			file_log("lightfv called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, light, pname, params);
		...
		MACH_OVERRIDE(void,lighti,(GLIContext ctx, GLenum light, GLenum pname, GLint param), err ) {
			file_log("lighti called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, light, pname, param);
		...
		MACH_OVERRIDE(void,lightiv,(GLIContext ctx, GLenum light, GLenum pname, const GLint *params), err ) {
			file_log("lightiv called: ctx (GLIContext : %p)light (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, light, pname, params);
		...
		MACH_OVERRIDE(void,line_stipple,(GLIContext ctx, GLint factor, GLushort pattern), err ) {
			file_log("line_stipple called: ctx (GLIContext : %p)factor (GLint : %i)pattern (GLushort : %u)", ctx, factor, pattern);
		...
		MACH_OVERRIDE(void,line_width,(GLIContext ctx, GLfloat width), err ) {
			file_log("line_width called: ctx (GLIContext : %p)width (GLfloat : %f)", ctx, width);
		...
		MACH_OVERRIDE(void,list_base,(GLIContext ctx, GLuint base), err ) {
			file_log("list_base called: ctx (GLIContext : %p)base (GLuint : %u)", ctx, base);
		...
		MACH_OVERRIDE(void,load_identity,(GLIContext ctx), err ) {
			file_log("load_identity called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,load_matrixd,(GLIContext ctx, const GLdouble *m), err ) {
			file_log("load_matrixd called: ctx (GLIContext : %p)m (const GLdouble* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,load_matrixf,(GLIContext ctx, const GLfloat *m), err ) {
			file_log("load_matrixf called: ctx (GLIContext : %p)m (const GLfloat* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,load_name,(GLIContext ctx, GLuint name), err ) {
			file_log("load_name called: ctx (GLIContext : %p)name (GLuint : %u)", ctx, name);
		...
		MACH_OVERRIDE(void,logic_op,(GLIContext ctx, GLenum opcode), err ) {
			file_log("logic_op called: ctx (GLIContext : %p)opcode (GLenum : %s)", ctx, opcode);
		...
		MACH_OVERRIDE(void,map1d,(GLIContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), err ) {
			file_log("map1d called: ctx (GLIContext : %p)target (GLenum : %s)u1 (GLdouble : %f)u2 (GLdouble : %f)stride (GLint : %i)order (GLint : %i)points (const GLdouble* : %p)", ctx, target, u1, u2, stride, order, points);
		...
		MACH_OVERRIDE(void,map1f,(GLIContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), err ) {
			file_log("map1f called: ctx (GLIContext : %p)target (GLenum : %s)u1 (GLfloat : %f)u2 (GLfloat : %f)stride (GLint : %i)order (GLint : %i)points (const GLfloat* : %p)", ctx, target, u1, u2, stride, order, points);
		...
		MACH_OVERRIDE(void,map2d,(GLIContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points), err ) {
			file_log("map2d called: ctx (GLIContext : %p)target (GLenum : %s)u1 (GLdouble : %f)u2 (GLdouble : %f)ustride (GLint : %i)uorder (GLint : %i)v1 (GLdouble : %f)v2 (GLdouble : %f)vstride (GLint : %i)vorder (GLint : %i)points (const GLdouble* : %p)", ctx, target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		MACH_OVERRIDE(void,map2f,(GLIContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points), err ) {
			file_log("map2f called: ctx (GLIContext : %p)target (GLenum : %s)u1 (GLfloat : %f)u2 (GLfloat : %f)ustride (GLint : %i)uorder (GLint : %i)v1 (GLfloat : %f)v2 (GLfloat : %f)vstride (GLint : %i)vorder (GLint : %i)points (const GLfloat* : %p)", ctx, target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		MACH_OVERRIDE(void,map_grid1d,(GLIContext ctx, GLint un, GLdouble u1, GLdouble u2), err ) {
			file_log("map_grid1d called: ctx (GLIContext : %p)un (GLint : %i)u1 (GLdouble : %f)u2 (GLdouble : %f)", ctx, un, u1, u2);
		...
		MACH_OVERRIDE(void,map_grid1f,(GLIContext ctx, GLint un, GLfloat u1, GLfloat u2), err ) {
			file_log("map_grid1f called: ctx (GLIContext : %p)un (GLint : %i)u1 (GLfloat : %f)u2 (GLfloat : %f)", ctx, un, u1, u2);
		...
		MACH_OVERRIDE(void,map_grid2d,(GLIContext ctx, GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2), err ) {
			file_log("map_grid2d called: ctx (GLIContext : %p)un (GLint : %i)u1 (GLdouble : %f)u2 (GLdouble : %f)vn (GLint : %i)v1 (GLdouble : %f)v2 (GLdouble : %f)", ctx, un, u1, u2, vn, v1, v2);
		...
		MACH_OVERRIDE(void,map_grid2f,(GLIContext ctx, GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2), err ) {
			file_log("map_grid2f called: ctx (GLIContext : %p)un (GLint : %i)u1 (GLfloat : %f)u2 (GLfloat : %f)vn (GLint : %i)v1 (GLfloat : %f)v2 (GLfloat : %f)", ctx, un, u1, u2, vn, v1, v2);
		...
		MACH_OVERRIDE(void,materialf,(GLIContext ctx, GLenum face, GLenum pname, GLfloat param), err ) {
			file_log("materialf called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)param (GLfloat : %f)", ctx, face, pname, param);
		...
		MACH_OVERRIDE(void,materialfv,(GLIContext ctx, GLenum face, GLenum pname, const GLfloat *params), err ) {
			file_log("materialfv called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, face, pname, params);
		...
		MACH_OVERRIDE(void,materiali,(GLIContext ctx, GLenum face, GLenum pname, GLint param), err ) {
			file_log("materiali called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, face, pname, param);
		...
		MACH_OVERRIDE(void,materialiv,(GLIContext ctx, GLenum face, GLenum pname, const GLint *params), err ) {
			file_log("materialiv called: ctx (GLIContext : %p)face (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, face, pname, params);
		...
		MACH_OVERRIDE(void,matrix_mode,(GLIContext ctx, GLenum mode), err ) {
			file_log("matrix_mode called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,mult_matrixd,(GLIContext ctx, const GLdouble *m), err ) {
			file_log("mult_matrixd called: ctx (GLIContext : %p)m (const GLdouble* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,mult_matrixf,(GLIContext ctx, const GLfloat *m), err ) {
			file_log("mult_matrixf called: ctx (GLIContext : %p)m (const GLfloat* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,new_list,(GLIContext ctx, GLuint list, GLenum mode), err ) {
			file_log("new_list called: ctx (GLIContext : %p)list (GLuint : %u)mode (GLenum : %s)", ctx, list, mode);
		...
		MACH_OVERRIDE(void,normal3b,(GLIContext ctx, GLbyte nx, GLbyte ny, GLbyte nz), err ) {
			file_log("normal3b called: ctx (GLIContext : %p)nx (GLbyte : %i)ny (GLbyte : %i)nz (GLbyte : %i)", ctx, nx, ny, nz);
		...
		MACH_OVERRIDE(void,normal3bv,(GLIContext ctx, const GLbyte *v), err ) {
			file_log("normal3bv called: ctx (GLIContext : %p)v (const GLbyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,normal3d,(GLIContext ctx, GLdouble nx, GLdouble ny, GLdouble nz), err ) {
			file_log("normal3d called: ctx (GLIContext : %p)nx (GLdouble : %f)ny (GLdouble : %f)nz (GLdouble : %f)", ctx, nx, ny, nz);
		...
		MACH_OVERRIDE(void,normal3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("normal3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,normal3f,(GLIContext ctx, GLfloat nx, GLfloat ny, GLfloat nz), err ) {
			file_log("normal3f called: ctx (GLIContext : %p)nx (GLfloat : %f)ny (GLfloat : %f)nz (GLfloat : %f)", ctx, nx, ny, nz);
		...
		MACH_OVERRIDE(void,normal3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("normal3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,normal3i,(GLIContext ctx, GLint nx, GLint ny, GLint nz), err ) {
			file_log("normal3i called: ctx (GLIContext : %p)nx (GLint : %i)ny (GLint : %i)nz (GLint : %i)", ctx, nx, ny, nz);
		...
		MACH_OVERRIDE(void,normal3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("normal3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,normal3s,(GLIContext ctx, GLshort nx, GLshort ny, GLshort nz), err ) {
			file_log("normal3s called: ctx (GLIContext : %p)nx (GLshort : %i)ny (GLshort : %i)nz (GLshort : %i)", ctx, nx, ny, nz);
		...
		MACH_OVERRIDE(void,normal3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("normal3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,normal_pointer,(GLIContext ctx, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("normal_pointer called: ctx (GLIContext : %p)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, type, stride, pointer);
		...
		MACH_OVERRIDE(void,ortho,(GLIContext ctx, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar), err ) {
			file_log("ortho called: ctx (GLIContext : %p)left (GLdouble : %f)right (GLdouble : %f)bottom (GLdouble : %f)top (GLdouble : %f)zNear (GLdouble : %f)zFar (GLdouble : %f)", ctx, left, right, bottom, top, zNear, zFar);
		...
		MACH_OVERRIDE(void,pass_through,(GLIContext ctx, GLfloat token), err ) {
			file_log("pass_through called: ctx (GLIContext : %p)token (GLfloat : %f)", ctx, token);
		...
		MACH_OVERRIDE(void,pixel_mapfv,(GLIContext ctx, GLenum map, GLsizei mapsize, const GLfloat *values), err ) {
			file_log("pixel_mapfv called: ctx (GLIContext : %p)map (GLenum : %s)mapsize (GLsizei : %i)values (const GLfloat* : %p)", ctx, map, mapsize, values);
		...
		MACH_OVERRIDE(void,pixel_mapuiv,(GLIContext ctx, GLenum map, GLsizei mapsize, const GLuint *values), err ) {
			file_log("pixel_mapuiv called: ctx (GLIContext : %p)map (GLenum : %s)mapsize (GLsizei : %i)values (const GLuint* : %p)", ctx, map, mapsize, values);
		...
		MACH_OVERRIDE(void,pixel_mapusv,(GLIContext ctx, GLenum map, GLsizei mapsize, const GLushort *values), err ) {
			file_log("pixel_mapusv called: ctx (GLIContext : %p)map (GLenum : %s)mapsize (GLsizei : %i)values (const GLushort* : %p)", ctx, map, mapsize, values);
		...
		MACH_OVERRIDE(void,pixel_storef,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("pixel_storef called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,pixel_storei,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("pixel_storei called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,pixel_transferf,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("pixel_transferf called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,pixel_transferi,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("pixel_transferi called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,pixel_zoom,(GLIContext ctx, GLfloat xfactor, GLfloat yfactor), err ) {
			file_log("pixel_zoom called: ctx (GLIContext : %p)xfactor (GLfloat : %f)yfactor (GLfloat : %f)", ctx, xfactor, yfactor);
		...
		MACH_OVERRIDE(void,point_size,(GLIContext ctx, GLfloat size), err ) {
			file_log("point_size called: ctx (GLIContext : %p)size (GLfloat : %f)", ctx, size);
		...
		MACH_OVERRIDE(void,polygon_mode,(GLIContext ctx, GLenum face, GLenum mode), err ) {
			file_log("polygon_mode called: ctx (GLIContext : %p)face (GLenum : %s)mode (GLenum : %s)", ctx, face, mode);
		...
		MACH_OVERRIDE(void,polygon_offset,(GLIContext ctx, GLfloat factor, GLfloat units), err ) {
			file_log("polygon_offset called: ctx (GLIContext : %p)factor (GLfloat : %f)units (GLfloat : %f)", ctx, factor, units);
		...
		MACH_OVERRIDE(void,polygon_stipple,(GLIContext ctx, const GLubyte *mask), err ) {
			file_log("polygon_stipple called: ctx (GLIContext : %p)mask (const GLubyte* : %p)", ctx, mask);
		...
		MACH_OVERRIDE(void,pop_attrib,(GLIContext ctx), err ) {
			file_log("pop_attrib called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,pop_client_attrib,(GLIContext ctx), err ) {
			file_log("pop_client_attrib called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,pop_matrix,(GLIContext ctx), err ) {
			file_log("pop_matrix called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,pop_name,(GLIContext ctx), err ) {
			file_log("pop_name called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,prioritize_textures,(GLIContext ctx, GLsizei n, const GLuint *textures, const GLclampf *priorities), err ) {
			file_log("prioritize_textures called: ctx (GLIContext : %p)n (GLsizei : %i)textures (const GLuint* : %p)priorities (const GLclampf* : %p)", ctx, n, textures, priorities);
		...
		MACH_OVERRIDE(void,push_attrib,(GLIContext ctx, GLbitfield mask), err ) {
			file_log("push_attrib called: ctx (GLIContext : %p)mask (GLbitfield : %u)", ctx, mask);
		...
		MACH_OVERRIDE(void,push_client_attrib,(GLIContext ctx, GLbitfield mask), err ) {
			file_log("push_client_attrib called: ctx (GLIContext : %p)mask (GLbitfield : %u)", ctx, mask);
		...
		MACH_OVERRIDE(void,push_matrix,(GLIContext ctx), err ) {
			file_log("push_matrix called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,push_name,(GLIContext ctx, GLuint name), err ) {
			file_log("push_name called: ctx (GLIContext : %p)name (GLuint : %u)", ctx, name);
		...
		MACH_OVERRIDE(void,raster_pos2d,(GLIContext ctx, GLdouble x, GLdouble y), err ) {
			file_log("raster_pos2d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,raster_pos2dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("raster_pos2dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos2f,(GLIContext ctx, GLfloat x, GLfloat y), err ) {
			file_log("raster_pos2f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,raster_pos2fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("raster_pos2fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos2i,(GLIContext ctx, GLint x, GLint y), err ) {
			file_log("raster_pos2i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,raster_pos2iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("raster_pos2iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos2s,(GLIContext ctx, GLshort x, GLshort y), err ) {
			file_log("raster_pos2s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,raster_pos2sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("raster_pos2sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos3d,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("raster_pos3d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,raster_pos3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("raster_pos3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos3f,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("raster_pos3f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,raster_pos3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("raster_pos3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos3i,(GLIContext ctx, GLint x, GLint y, GLint z), err ) {
			file_log("raster_pos3i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)z (GLint : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,raster_pos3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("raster_pos3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos3s,(GLIContext ctx, GLshort x, GLshort y, GLshort z), err ) {
			file_log("raster_pos3s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,raster_pos3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("raster_pos3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos4d,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("raster_pos4d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,raster_pos4dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("raster_pos4dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos4f,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("raster_pos4f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,raster_pos4fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("raster_pos4fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos4i,(GLIContext ctx, GLint x, GLint y, GLint z, GLint w), err ) {
			file_log("raster_pos4i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)z (GLint : %i)w (GLint : %i)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,raster_pos4iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("raster_pos4iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,raster_pos4s,(GLIContext ctx, GLshort x, GLshort y, GLshort z, GLshort w), err ) {
			file_log("raster_pos4s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)w (GLshort : %i)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,raster_pos4sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("raster_pos4sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,read_buffer,(GLIContext ctx, GLenum mode), err ) {
			file_log("read_buffer called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,read_pixels,(GLIContext ctx, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels), err ) {
			file_log("read_pixels called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)pixels (GLvoid* : %p)", ctx, x, y, width, height, format, type, pixels);
		...
		MACH_OVERRIDE(void,rectd,(GLIContext ctx, GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2), err ) {
			file_log("rectd called: ctx (GLIContext : %p)x1 (GLdouble : %f)y1 (GLdouble : %f)x2 (GLdouble : %f)y2 (GLdouble : %f)", ctx, x1, y1, x2, y2);
		...
		MACH_OVERRIDE(void,rectdv,(GLIContext ctx, const GLdouble *v1, const GLdouble *v2), err ) {
			file_log("rectdv called: ctx (GLIContext : %p)v1 (const GLdouble* : %p)v2 (const GLdouble* : %p)", ctx, v1, v2);
		...
		MACH_OVERRIDE(void,rectf,(GLIContext ctx, GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2), err ) {
			file_log("rectf called: ctx (GLIContext : %p)x1 (GLfloat : %f)y1 (GLfloat : %f)x2 (GLfloat : %f)y2 (GLfloat : %f)", ctx, x1, y1, x2, y2);
		...
		MACH_OVERRIDE(void,rectfv,(GLIContext ctx, const GLfloat *v1, const GLfloat *v2), err ) {
			file_log("rectfv called: ctx (GLIContext : %p)v1 (const GLfloat* : %p)v2 (const GLfloat* : %p)", ctx, v1, v2);
		...
		MACH_OVERRIDE(void,recti,(GLIContext ctx, GLint x1, GLint y1, GLint x2, GLint y2), err ) {
			file_log("recti called: ctx (GLIContext : %p)x1 (GLint : %i)y1 (GLint : %i)x2 (GLint : %i)y2 (GLint : %i)", ctx, x1, y1, x2, y2);
		...
		MACH_OVERRIDE(void,rectiv,(GLIContext ctx, const GLint *v1, const GLint *v2), err ) {
			file_log("rectiv called: ctx (GLIContext : %p)v1 (const GLint* : %p)v2 (const GLint* : %p)", ctx, v1, v2);
		...
		MACH_OVERRIDE(void,rects,(GLIContext ctx, GLshort x1, GLshort y1, GLshort x2, GLshort y2), err ) {
			file_log("rects called: ctx (GLIContext : %p)x1 (GLshort : %i)y1 (GLshort : %i)x2 (GLshort : %i)y2 (GLshort : %i)", ctx, x1, y1, x2, y2);
		...
		MACH_OVERRIDE(void,rectsv,(GLIContext ctx, const GLshort *v1, const GLshort *v2), err ) {
			file_log("rectsv called: ctx (GLIContext : %p)v1 (const GLshort* : %p)v2 (const GLshort* : %p)", ctx, v1, v2);
		...
		MACH_OVERRIDE(GLint,render_mode,(GLIContext ctx, GLenum mode), err ) {
			file_log("render_mode called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,rotated,(GLIContext ctx, GLdouble angle, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("rotated called: ctx (GLIContext : %p)angle (GLdouble : %f)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, angle, x, y, z);
		...
		MACH_OVERRIDE(void,rotatef,(GLIContext ctx, GLfloat angle, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("rotatef called: ctx (GLIContext : %p)angle (GLfloat : %f)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, angle, x, y, z);
		...
		MACH_OVERRIDE(void,scaled,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("scaled called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,scalef,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("scalef called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,scissor,(GLIContext ctx, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			file_log("scissor called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, x, y, width, height);
		...
		MACH_OVERRIDE(void,select_buffer,(GLIContext ctx, GLsizei size, GLuint *buffer), err ) {
			file_log("select_buffer called: ctx (GLIContext : %p)size (GLsizei : %i)buffer (GLuint* : %p)", ctx, size, buffer);
		...
		MACH_OVERRIDE(void,shade_model,(GLIContext ctx, GLenum mode), err ) {
			file_log("shade_model called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,stencil_func,(GLIContext ctx, GLenum func, GLint ref, GLuint mask), err ) {
			file_log("stencil_func called: ctx (GLIContext : %p)func (GLenum : %s)ref (GLint : %i)mask (GLuint : %u)", ctx, func, ref, mask);
		...
		MACH_OVERRIDE(void,stencil_mask,(GLIContext ctx, GLuint mask), err ) {
			file_log("stencil_mask called: ctx (GLIContext : %p)mask (GLuint : %u)", ctx, mask);
		...
		MACH_OVERRIDE(void,stencil_op,(GLIContext ctx, GLenum fail, GLenum zfail, GLenum zpass), err ) {
			file_log("stencil_op called: ctx (GLIContext : %p)fail (GLenum : %s)zfail (GLenum : %s)zpass (GLenum : %s)", ctx, fail, zfail, zpass);
		...
		MACH_OVERRIDE(void,tex_coord1d,(GLIContext ctx, GLdouble s), err ) {
			file_log("tex_coord1d called: ctx (GLIContext : %p)s (GLdouble : %f)", ctx, s);
		...
		MACH_OVERRIDE(void,tex_coord1dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("tex_coord1dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord1f,(GLIContext ctx, GLfloat s), err ) {
			file_log("tex_coord1f called: ctx (GLIContext : %p)s (GLfloat : %f)", ctx, s);
		...
		MACH_OVERRIDE(void,tex_coord1fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("tex_coord1fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord1i,(GLIContext ctx, GLint s), err ) {
			file_log("tex_coord1i called: ctx (GLIContext : %p)s (GLint : %i)", ctx, s);
		...
		MACH_OVERRIDE(void,tex_coord1iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("tex_coord1iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord1s,(GLIContext ctx, GLshort s), err ) {
			file_log("tex_coord1s called: ctx (GLIContext : %p)s (GLshort : %i)", ctx, s);
		...
		MACH_OVERRIDE(void,tex_coord1sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("tex_coord1sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord2d,(GLIContext ctx, GLdouble s, GLdouble t), err ) {
			file_log("tex_coord2d called: ctx (GLIContext : %p)s (GLdouble : %f)t (GLdouble : %f)", ctx, s, t);
		...
		MACH_OVERRIDE(void,tex_coord2dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("tex_coord2dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord2f,(GLIContext ctx, GLfloat s, GLfloat t), err ) {
			file_log("tex_coord2f called: ctx (GLIContext : %p)s (GLfloat : %f)t (GLfloat : %f)", ctx, s, t);
		...
		MACH_OVERRIDE(void,tex_coord2fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("tex_coord2fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord2i,(GLIContext ctx, GLint s, GLint t), err ) {
			file_log("tex_coord2i called: ctx (GLIContext : %p)s (GLint : %i)t (GLint : %i)", ctx, s, t);
		...
		MACH_OVERRIDE(void,tex_coord2iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("tex_coord2iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord2s,(GLIContext ctx, GLshort s, GLshort t), err ) {
			file_log("tex_coord2s called: ctx (GLIContext : %p)s (GLshort : %i)t (GLshort : %i)", ctx, s, t);
		...
		MACH_OVERRIDE(void,tex_coord2sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("tex_coord2sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord3d,(GLIContext ctx, GLdouble s, GLdouble t, GLdouble r), err ) {
			file_log("tex_coord3d called: ctx (GLIContext : %p)s (GLdouble : %f)t (GLdouble : %f)r (GLdouble : %f)", ctx, s, t, r);
		...
		MACH_OVERRIDE(void,tex_coord3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("tex_coord3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord3f,(GLIContext ctx, GLfloat s, GLfloat t, GLfloat r), err ) {
			file_log("tex_coord3f called: ctx (GLIContext : %p)s (GLfloat : %f)t (GLfloat : %f)r (GLfloat : %f)", ctx, s, t, r);
		...
		MACH_OVERRIDE(void,tex_coord3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("tex_coord3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord3i,(GLIContext ctx, GLint s, GLint t, GLint r), err ) {
			file_log("tex_coord3i called: ctx (GLIContext : %p)s (GLint : %i)t (GLint : %i)r (GLint : %i)", ctx, s, t, r);
		...
		MACH_OVERRIDE(void,tex_coord3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("tex_coord3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord3s,(GLIContext ctx, GLshort s, GLshort t, GLshort r), err ) {
			file_log("tex_coord3s called: ctx (GLIContext : %p)s (GLshort : %i)t (GLshort : %i)r (GLshort : %i)", ctx, s, t, r);
		...
		MACH_OVERRIDE(void,tex_coord3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("tex_coord3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord4d,(GLIContext ctx, GLdouble s, GLdouble t, GLdouble r, GLdouble q), err ) {
			file_log("tex_coord4d called: ctx (GLIContext : %p)s (GLdouble : %f)t (GLdouble : %f)r (GLdouble : %f)q (GLdouble : %f)", ctx, s, t, r, q);
		...
		MACH_OVERRIDE(void,tex_coord4dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("tex_coord4dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord4f,(GLIContext ctx, GLfloat s, GLfloat t, GLfloat r, GLfloat q), err ) {
			file_log("tex_coord4f called: ctx (GLIContext : %p)s (GLfloat : %f)t (GLfloat : %f)r (GLfloat : %f)q (GLfloat : %f)", ctx, s, t, r, q);
		...
		MACH_OVERRIDE(void,tex_coord4fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("tex_coord4fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord4i,(GLIContext ctx, GLint s, GLint t, GLint r, GLint q), err ) {
			file_log("tex_coord4i called: ctx (GLIContext : %p)s (GLint : %i)t (GLint : %i)r (GLint : %i)q (GLint : %i)", ctx, s, t, r, q);
		...
		MACH_OVERRIDE(void,tex_coord4iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("tex_coord4iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord4s,(GLIContext ctx, GLshort s, GLshort t, GLshort r, GLshort q), err ) {
			file_log("tex_coord4s called: ctx (GLIContext : %p)s (GLshort : %i)t (GLshort : %i)r (GLshort : %i)q (GLshort : %i)", ctx, s, t, r, q);
		...
		MACH_OVERRIDE(void,tex_coord4sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("tex_coord4sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,tex_coord_pointer,(GLIContext ctx, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("tex_coord_pointer called: ctx (GLIContext : %p)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,tex_envf,(GLIContext ctx, GLenum target, GLenum pname, GLfloat param), err ) {
			file_log("tex_envf called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)param (GLfloat : %f)", ctx, target, pname, param);
		...
		MACH_OVERRIDE(void,tex_envfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			file_log("tex_envfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,tex_envi,(GLIContext ctx, GLenum target, GLenum pname, GLint param), err ) {
			file_log("tex_envi called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, target, pname, param);
		...
		MACH_OVERRIDE(void,tex_enviv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			file_log("tex_enviv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,tex_gend,(GLIContext ctx, GLenum coord, GLenum pname, GLdouble param), err ) {
			file_log("tex_gend called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)param (GLdouble : %f)", ctx, coord, pname, param);
		...
		MACH_OVERRIDE(void,tex_gendv,(GLIContext ctx, GLenum coord, GLenum pname, const GLdouble *params), err ) {
			file_log("tex_gendv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (const GLdouble* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,tex_genf,(GLIContext ctx, GLenum coord, GLenum pname, GLfloat param), err ) {
			file_log("tex_genf called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)param (GLfloat : %f)", ctx, coord, pname, param);
		...
		MACH_OVERRIDE(void,tex_genfv,(GLIContext ctx, GLenum coord, GLenum pname, const GLfloat *params), err ) {
			file_log("tex_genfv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,tex_geni,(GLIContext ctx, GLenum coord, GLenum pname, GLint param), err ) {
			file_log("tex_geni called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, coord, pname, param);
		...
		MACH_OVERRIDE(void,tex_geniv,(GLIContext ctx, GLenum coord, GLenum pname, const GLint *params), err ) {
			file_log("tex_geniv called: ctx (GLIContext : %p)coord (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, coord, pname, params);
		...
		MACH_OVERRIDE(void,tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalformat (GLenum : %s)width (GLsizei : %i)border (GLint : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, internalformat, width, border, format, type, pixels);
		...
		MACH_OVERRIDE(void,tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)border (GLint : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, internalformat, width, height, border, format, type, pixels);
		...
		MACH_OVERRIDE(void,tex_parameterf,(GLIContext ctx, GLenum target, GLenum pname, GLfloat param), err ) {
			file_log("tex_parameterf called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)param (GLfloat : %f)", ctx, target, pname, param);
		...
		MACH_OVERRIDE(void,tex_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			file_log("tex_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,tex_parameteri,(GLIContext ctx, GLenum target, GLenum pname, GLint param), err ) {
			file_log("tex_parameteri called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, target, pname, param);
		...
		MACH_OVERRIDE(void,tex_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			file_log("tex_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_sub_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)width (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, xoffset, width, format, type, pixels);
		...
		MACH_OVERRIDE(void,tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_sub_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, xoffset, yoffset, width, height, format, type, pixels);
		...
		MACH_OVERRIDE(void,translated,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("translated called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,translatef,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("translatef called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,vertex2d,(GLIContext ctx, GLdouble x, GLdouble y), err ) {
			file_log("vertex2d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,vertex2dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("vertex2dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex2f,(GLIContext ctx, GLfloat x, GLfloat y), err ) {
			file_log("vertex2f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,vertex2fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("vertex2fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex2i,(GLIContext ctx, GLint x, GLint y), err ) {
			file_log("vertex2i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,vertex2iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("vertex2iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex2s,(GLIContext ctx, GLshort x, GLshort y), err ) {
			file_log("vertex2s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,vertex2sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("vertex2sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex3d,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("vertex3d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,vertex3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("vertex3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex3f,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("vertex3f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,vertex3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("vertex3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex3i,(GLIContext ctx, GLint x, GLint y, GLint z), err ) {
			file_log("vertex3i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)z (GLint : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,vertex3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("vertex3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex3s,(GLIContext ctx, GLshort x, GLshort y, GLshort z), err ) {
			file_log("vertex3s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,vertex3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("vertex3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex4d,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("vertex4d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex4dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("vertex4dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex4f,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("vertex4f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex4fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("vertex4fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex4i,(GLIContext ctx, GLint x, GLint y, GLint z, GLint w), err ) {
			file_log("vertex4i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)z (GLint : %i)w (GLint : %i)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex4iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("vertex4iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex4s,(GLIContext ctx, GLshort x, GLshort y, GLshort z, GLshort w), err ) {
			file_log("vertex4s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)w (GLshort : %i)", ctx, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex4sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("vertex4sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,vertex_pointer,(GLIContext ctx, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("vertex_pointer called: ctx (GLIContext : %p)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,viewport,(GLIContext ctx, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			file_log("viewport called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, x, y, width, height);
		...
		MACH_OVERRIDE(void,blend_func_separate,(GLIContext ctx, GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha), err ) {
			file_log("blend_func_separate called: ctx (GLIContext : %p)sfactorRGB (GLenum : %s)dfactorRGB (GLenum : %s)sfactorAlpha (GLenum : %s)dfactorAlpha (GLenum : %s)", ctx, sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
		...
		MACH_OVERRIDE(void,blend_color,(GLIContext ctx, GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha), err ) {
			file_log("blend_color called: ctx (GLIContext : %p)red (GLclampf : %f)green (GLclampf : %f)blue (GLclampf : %f)alpha (GLclampf : %f)", ctx, red, green, blue, alpha);
		...
		MACH_OVERRIDE(void,blend_equation,(GLIContext ctx, GLenum mode), err ) {
			file_log("blend_equation called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,lock_arrays_EXT,(GLIContext ctx, GLint first, GLsizei count), err ) {
			file_log("lock_arrays_EXT called: ctx (GLIContext : %p)first (GLint : %i)count (GLsizei : %i)", ctx, first, count);
		...
		MACH_OVERRIDE(void,unlock_arrays_EXT,(GLIContext ctx), err ) {
			file_log("unlock_arrays_EXT called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,client_active_texture,(GLIContext ctx, GLenum target), err ) {
			file_log("client_active_texture called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,active_texture,(GLIContext ctx, GLenum target), err ) {
			file_log("active_texture called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,multi_tex_coord1d,(GLIContext ctx, GLenum target, GLdouble s), err ) {
			file_log("multi_tex_coord1d called: ctx (GLIContext : %p)target (GLenum : %s)s (GLdouble : %f)", ctx, target, s);
		...
		MACH_OVERRIDE(void,multi_tex_coord1dv,(GLIContext ctx, GLenum target, const GLdouble *v), err ) {
			file_log("multi_tex_coord1dv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLdouble* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord1f,(GLIContext ctx, GLenum target, GLfloat s), err ) {
			file_log("multi_tex_coord1f called: ctx (GLIContext : %p)target (GLenum : %s)s (GLfloat : %f)", ctx, target, s);
		...
		MACH_OVERRIDE(void,multi_tex_coord1fv,(GLIContext ctx, GLenum target, const GLfloat *v), err ) {
			file_log("multi_tex_coord1fv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLfloat* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord1i,(GLIContext ctx, GLenum target, GLint s), err ) {
			file_log("multi_tex_coord1i called: ctx (GLIContext : %p)target (GLenum : %s)s (GLint : %i)", ctx, target, s);
		...
		MACH_OVERRIDE(void,multi_tex_coord1iv,(GLIContext ctx, GLenum target, const GLint *v), err ) {
			file_log("multi_tex_coord1iv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLint* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord1s,(GLIContext ctx, GLenum target, GLshort s), err ) {
			file_log("multi_tex_coord1s called: ctx (GLIContext : %p)target (GLenum : %s)s (GLshort : %i)", ctx, target, s);
		...
		MACH_OVERRIDE(void,multi_tex_coord1sv,(GLIContext ctx, GLenum target, const GLshort *v), err ) {
			file_log("multi_tex_coord1sv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLshort* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord2d,(GLIContext ctx, GLenum target, GLdouble s, GLdouble t), err ) {
			file_log("multi_tex_coord2d called: ctx (GLIContext : %p)target (GLenum : %s)s (GLdouble : %f)t (GLdouble : %f)", ctx, target, s, t);
		...
		MACH_OVERRIDE(void,multi_tex_coord2dv,(GLIContext ctx, GLenum target, const GLdouble *v), err ) {
			file_log("multi_tex_coord2dv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLdouble* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord2f,(GLIContext ctx, GLenum target, GLfloat s, GLfloat t), err ) {
			file_log("multi_tex_coord2f called: ctx (GLIContext : %p)target (GLenum : %s)s (GLfloat : %f)t (GLfloat : %f)", ctx, target, s, t);
		...
		MACH_OVERRIDE(void,multi_tex_coord2fv,(GLIContext ctx, GLenum target, const GLfloat *v), err ) {
			file_log("multi_tex_coord2fv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLfloat* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord2i,(GLIContext ctx, GLenum target, GLint s, GLint t), err ) {
			file_log("multi_tex_coord2i called: ctx (GLIContext : %p)target (GLenum : %s)s (GLint : %i)t (GLint : %i)", ctx, target, s, t);
		...
		MACH_OVERRIDE(void,multi_tex_coord2iv,(GLIContext ctx, GLenum target, const GLint *v), err ) {
			file_log("multi_tex_coord2iv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLint* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord2s,(GLIContext ctx, GLenum target, GLshort s, GLshort t), err ) {
			file_log("multi_tex_coord2s called: ctx (GLIContext : %p)target (GLenum : %s)s (GLshort : %i)t (GLshort : %i)", ctx, target, s, t);
		...
		MACH_OVERRIDE(void,multi_tex_coord2sv,(GLIContext ctx, GLenum target, const GLshort *v), err ) {
			file_log("multi_tex_coord2sv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLshort* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord3d,(GLIContext ctx, GLenum target, GLdouble s, GLdouble t, GLdouble r), err ) {
			file_log("multi_tex_coord3d called: ctx (GLIContext : %p)target (GLenum : %s)s (GLdouble : %f)t (GLdouble : %f)r (GLdouble : %f)", ctx, target, s, t, r);
		...
		MACH_OVERRIDE(void,multi_tex_coord3dv,(GLIContext ctx, GLenum target, const GLdouble *v), err ) {
			file_log("multi_tex_coord3dv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLdouble* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord3f,(GLIContext ctx, GLenum target, GLfloat s, GLfloat t, GLfloat r), err ) {
			file_log("multi_tex_coord3f called: ctx (GLIContext : %p)target (GLenum : %s)s (GLfloat : %f)t (GLfloat : %f)r (GLfloat : %f)", ctx, target, s, t, r);
		...
		MACH_OVERRIDE(void,multi_tex_coord3fv,(GLIContext ctx, GLenum target, const GLfloat *v), err ) {
			file_log("multi_tex_coord3fv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLfloat* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord3i,(GLIContext ctx, GLenum target, GLint s, GLint t, GLint r), err ) {
			file_log("multi_tex_coord3i called: ctx (GLIContext : %p)target (GLenum : %s)s (GLint : %i)t (GLint : %i)r (GLint : %i)", ctx, target, s, t, r);
		...
		MACH_OVERRIDE(void,multi_tex_coord3iv,(GLIContext ctx, GLenum target, const GLint *v), err ) {
			file_log("multi_tex_coord3iv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLint* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord3s,(GLIContext ctx, GLenum target, GLshort s, GLshort t, GLshort r), err ) {
			file_log("multi_tex_coord3s called: ctx (GLIContext : %p)target (GLenum : %s)s (GLshort : %i)t (GLshort : %i)r (GLshort : %i)", ctx, target, s, t, r);
		...
		MACH_OVERRIDE(void,multi_tex_coord3sv,(GLIContext ctx, GLenum target, const GLshort *v), err ) {
			file_log("multi_tex_coord3sv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLshort* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord4d,(GLIContext ctx, GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q), err ) {
			file_log("multi_tex_coord4d called: ctx (GLIContext : %p)target (GLenum : %s)s (GLdouble : %f)t (GLdouble : %f)r (GLdouble : %f)q (GLdouble : %f)", ctx, target, s, t, r, q);
		...
		MACH_OVERRIDE(void,multi_tex_coord4dv,(GLIContext ctx, GLenum target, const GLdouble *v), err ) {
			file_log("multi_tex_coord4dv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLdouble* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord4f,(GLIContext ctx, GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q), err ) {
			file_log("multi_tex_coord4f called: ctx (GLIContext : %p)target (GLenum : %s)s (GLfloat : %f)t (GLfloat : %f)r (GLfloat : %f)q (GLfloat : %f)", ctx, target, s, t, r, q);
		...
		MACH_OVERRIDE(void,multi_tex_coord4fv,(GLIContext ctx, GLenum target, const GLfloat *v), err ) {
			file_log("multi_tex_coord4fv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLfloat* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord4i,(GLIContext ctx, GLenum target, GLint s, GLint t, GLint r, GLint q), err ) {
			file_log("multi_tex_coord4i called: ctx (GLIContext : %p)target (GLenum : %s)s (GLint : %i)t (GLint : %i)r (GLint : %i)q (GLint : %i)", ctx, target, s, t, r, q);
		...
		MACH_OVERRIDE(void,multi_tex_coord4iv,(GLIContext ctx, GLenum target, const GLint *v), err ) {
			file_log("multi_tex_coord4iv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLint* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,multi_tex_coord4s,(GLIContext ctx, GLenum target, GLshort s, GLshort t, GLshort r, GLshort q), err ) {
			file_log("multi_tex_coord4s called: ctx (GLIContext : %p)target (GLenum : %s)s (GLshort : %i)t (GLshort : %i)r (GLshort : %i)q (GLshort : %i)", ctx, target, s, t, r, q);
		...
		MACH_OVERRIDE(void,multi_tex_coord4sv,(GLIContext ctx, GLenum target, const GLshort *v), err ) {
			file_log("multi_tex_coord4sv called: ctx (GLIContext : %p)target (GLenum : %s)v (const GLshort* : %p)", ctx, target, v);
		...
		MACH_OVERRIDE(void,load_transpose_matrixd,(GLIContext ctx, const GLdouble *m), err ) {
			file_log("load_transpose_matrixd called: ctx (GLIContext : %p)m (const GLdouble* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,load_transpose_matrixf,(GLIContext ctx, const GLfloat *m), err ) {
			file_log("load_transpose_matrixf called: ctx (GLIContext : %p)m (const GLfloat* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,mult_transpose_matrixd,(GLIContext ctx, const GLdouble *m), err ) {
			file_log("mult_transpose_matrixd called: ctx (GLIContext : %p)m (const GLdouble* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,mult_transpose_matrixf,(GLIContext ctx, const GLfloat *m), err ) {
			file_log("mult_transpose_matrixf called: ctx (GLIContext : %p)m (const GLfloat* : %p)", ctx, m);
		...
		MACH_OVERRIDE(void,compressed_tex_image3D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_image3D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)border (GLint : %i)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, internalformat, width, height, depth, border, imageSize, data);
		...
		MACH_OVERRIDE(void,compressed_tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)border (GLint : %i)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, internalformat, width, height, border, imageSize, data);
		...
		MACH_OVERRIDE(void,compressed_tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalformat (GLenum : %s)width (GLsizei : %i)border (GLint : %i)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, internalformat, width, border, imageSize, data);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_sub_image3D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)zoffset (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)format (GLenum : %s)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_sub_image2D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, xoffset, yoffset, width, height, format, imageSize, data);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			file_log("compressed_tex_sub_image1D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)width (GLsizei : %i)format (GLenum : %s)imageSize (GLsizei : %i)data (const GLvoid* : %p)", ctx, target, level, xoffset, width, format, imageSize, data);
		...
		MACH_OVERRIDE(void,get_compressed_tex_image,(GLIContext ctx, GLenum target, GLint level, GLvoid *img), err ) {
			file_log("get_compressed_tex_image called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)img (GLvoid* : %p)", ctx, target, level, img);
		...
		MACH_OVERRIDE(void,secondary_color3b,(GLIContext ctx, GLbyte red, GLbyte green, GLbyte blue), err ) {
			file_log("secondary_color3b called: ctx (GLIContext : %p)red (GLbyte : %i)green (GLbyte : %i)blue (GLbyte : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3bv,(GLIContext ctx, const GLbyte *v), err ) {
			file_log("secondary_color3bv called: ctx (GLIContext : %p)v (const GLbyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3d,(GLIContext ctx, GLdouble red, GLdouble green, GLdouble blue), err ) {
			file_log("secondary_color3d called: ctx (GLIContext : %p)red (GLdouble : %f)green (GLdouble : %f)blue (GLdouble : %f)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("secondary_color3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3f,(GLIContext ctx, GLfloat red, GLfloat green, GLfloat blue), err ) {
			file_log("secondary_color3f called: ctx (GLIContext : %p)red (GLfloat : %f)green (GLfloat : %f)blue (GLfloat : %f)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("secondary_color3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3i,(GLIContext ctx, GLint red, GLint green, GLint blue), err ) {
			file_log("secondary_color3i called: ctx (GLIContext : %p)red (GLint : %i)green (GLint : %i)blue (GLint : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("secondary_color3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3s,(GLIContext ctx, GLshort red, GLshort green, GLshort blue), err ) {
			file_log("secondary_color3s called: ctx (GLIContext : %p)red (GLshort : %i)green (GLshort : %i)blue (GLshort : %i)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("secondary_color3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3ub,(GLIContext ctx, GLubyte red, GLubyte green, GLubyte blue), err ) {
			file_log("secondary_color3ub called: ctx (GLIContext : %p)red (GLubyte : %u)green (GLubyte : %u)blue (GLubyte : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3ubv,(GLIContext ctx, const GLubyte *v), err ) {
			file_log("secondary_color3ubv called: ctx (GLIContext : %p)v (const GLubyte* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3ui,(GLIContext ctx, GLuint red, GLuint green, GLuint blue), err ) {
			file_log("secondary_color3ui called: ctx (GLIContext : %p)red (GLuint : %u)green (GLuint : %u)blue (GLuint : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3uiv,(GLIContext ctx, const GLuint *v), err ) {
			file_log("secondary_color3uiv called: ctx (GLIContext : %p)v (const GLuint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color3us,(GLIContext ctx, GLushort red, GLushort green, GLushort blue), err ) {
			file_log("secondary_color3us called: ctx (GLIContext : %p)red (GLushort : %u)green (GLushort : %u)blue (GLushort : %u)", ctx, red, green, blue);
		...
		MACH_OVERRIDE(void,secondary_color3usv,(GLIContext ctx, const GLushort *v), err ) {
			file_log("secondary_color3usv called: ctx (GLIContext : %p)v (const GLushort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,secondary_color_pointer,(GLIContext ctx, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("secondary_color_pointer called: ctx (GLIContext : %p)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,vertex_array_range_EXT,(GLIContext ctx, GLsizei count, const GLvoid *pointer), err ) {
			file_log("vertex_array_range_EXT called: ctx (GLIContext : %p)count (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, count, pointer);
		...
		MACH_OVERRIDE(void,flush_vertex_array_range_EXT,(GLIContext ctx, GLsizei count, const GLvoid *pointer), err ) {
			file_log("flush_vertex_array_range_EXT called: ctx (GLIContext : %p)count (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, count, pointer);
		...
		MACH_OVERRIDE(void,draw_range_elements,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices), err ) {
			file_log("draw_range_elements called: ctx (GLIContext : %p)mode (GLenum : %s)start (GLuint : %u)end (GLuint : %u)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)", ctx, mode, start, end, count, type, indices);
		...
		MACH_OVERRIDE(void,color_table,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *table), err ) {
			file_log("color_table called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)width (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)table (const GLvoid* : %p)", ctx, target, internalformat, width, format, type, table);
		...
		MACH_OVERRIDE(void,color_table_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			file_log("color_table_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,color_table_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			file_log("color_table_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,copy_color_table,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width), err ) {
			file_log("copy_color_table called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)", ctx, target, internalformat, x, y, width);
		...
		MACH_OVERRIDE(void,get_color_table,(GLIContext ctx, GLenum target, GLenum format, GLenum type, GLvoid *table), err ) {
			file_log("get_color_table called: ctx (GLIContext : %p)target (GLenum : %s)format (GLenum : %s)type (GLenum : %s)table (GLvoid* : %p)", ctx, target, format, type, table);
		...
		MACH_OVERRIDE(void,get_color_table_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_color_table_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_color_table_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_color_table_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,color_sub_table,(GLIContext ctx, GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data), err ) {
			file_log("color_sub_table called: ctx (GLIContext : %p)target (GLenum : %s)start (GLsizei : %i)count (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)data (const GLvoid* : %p)", ctx, target, start, count, format, type, data);
		...
		MACH_OVERRIDE(void,copy_color_sub_table,(GLIContext ctx, GLenum target, GLsizei start, GLint x, GLint y, GLsizei width), err ) {
			file_log("copy_color_sub_table called: ctx (GLIContext : %p)target (GLenum : %s)start (GLsizei : %i)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)", ctx, target, start, x, y, width);
		...
		MACH_OVERRIDE(void,convolution_filter1D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image), err ) {
			file_log("convolution_filter1D called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)width (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)image (const GLvoid* : %p)", ctx, target, internalformat, width, format, type, image);
		...
		MACH_OVERRIDE(void,convolution_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image), err ) {
			file_log("convolution_filter2D called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)image (const GLvoid* : %p)", ctx, target, internalformat, width, height, format, type, image);
		...
		MACH_OVERRIDE(void,convolution_parameterf,(GLIContext ctx, GLenum target, GLenum pname, GLfloat params), err ) {
			file_log("convolution_parameterf called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat : %f)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,convolution_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			file_log("convolution_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,convolution_parameteri,(GLIContext ctx, GLenum target, GLenum pname, GLint params), err ) {
			file_log("convolution_parameteri called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint : %i)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,convolution_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			file_log("convolution_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (const GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,copy_convolution_filter1D,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width), err ) {
			file_log("copy_convolution_filter1D called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)", ctx, target, internalformat, x, y, width);
		...
		MACH_OVERRIDE(void,copy_convolution_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			file_log("copy_convolution_filter2D called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, internalformat, x, y, width, height);
		...
		MACH_OVERRIDE(void,get_convolution_filter,(GLIContext ctx, GLenum target, GLenum format, GLenum type, GLvoid *image), err ) {
			file_log("get_convolution_filter called: ctx (GLIContext : %p)target (GLenum : %s)format (GLenum : %s)type (GLenum : %s)image (GLvoid* : %p)", ctx, target, format, type, image);
		...
		MACH_OVERRIDE(void,get_convolution_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_convolution_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_convolution_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_convolution_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_separable_filter,(GLIContext ctx, GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid *column, GLvoid *span), err ) {
			file_log("get_separable_filter called: ctx (GLIContext : %p)target (GLenum : %s)format (GLenum : %s)type (GLenum : %s)row (GLvoid* : %p)column (GLvoid* : %p)span (GLvoid* : %p)", ctx, target, format, type, row, column, span);
		...
		MACH_OVERRIDE(void,separable_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *column), err ) {
			file_log("separable_filter2D called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)row (const GLvoid* : %p)column (const GLvoid* : %p)", ctx, target, internalformat, width, height, format, type, row, column);
		...
		MACH_OVERRIDE(void,get_histogram,(GLIContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values), err ) {
			file_log("get_histogram called: ctx (GLIContext : %p)target (GLenum : %s)reset (GLboolean : %i)format (GLenum : %s)type (GLenum : %s)values (GLvoid* : %p)", ctx, target, reset, format, type, values);
		...
		MACH_OVERRIDE(void,get_histogram_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_histogram_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_histogram_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_histogram_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_minmax,(GLIContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values), err ) {
			file_log("get_minmax called: ctx (GLIContext : %p)target (GLenum : %s)reset (GLboolean : %i)format (GLenum : %s)type (GLenum : %s)values (GLvoid* : %p)", ctx, target, reset, format, type, values);
		...
		MACH_OVERRIDE(void,get_minmax_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			file_log("get_minmax_parameterfv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_minmax_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_minmax_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,histogram,(GLIContext ctx, GLenum target, GLsizei width, GLenum internalformat, GLboolean sink), err ) {
			file_log("histogram called: ctx (GLIContext : %p)target (GLenum : %s)width (GLsizei : %i)internalformat (GLenum : %s)sink (GLboolean : %i)", ctx, target, width, internalformat, sink);
		...
		MACH_OVERRIDE(void,minmax,(GLIContext ctx, GLenum target, GLenum internalformat, GLboolean sink), err ) {
			file_log("minmax called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)sink (GLboolean : %i)", ctx, target, internalformat, sink);
		...
		MACH_OVERRIDE(void,reset_histogram,(GLIContext ctx, GLenum target), err ) {
			file_log("reset_histogram called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,reset_minmax,(GLIContext ctx, GLenum target), err ) {
			file_log("reset_minmax called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,tex_image3D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_image3D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)internalFormat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)border (GLint : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, internalFormat, width, height, depth, border, format, type, pixels);
		...
		MACH_OVERRIDE(void,tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			file_log("tex_sub_image3D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)zoffset (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)format (GLenum : %s)type (GLenum : %s)pixels (const GLvoid* : %p)", ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			file_log("copy_tex_sub_image3D called: ctx (GLIContext : %p)target (GLenum : %s)level (GLint : %i)xoffset (GLint : %i)yoffset (GLint : %i)zoffset (GLint : %i)x (GLint : %i)y (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, level, xoffset, yoffset, zoffset, x, y, width, height);
		...
		MACH_OVERRIDE(void,get_uniform_indices,(GLIContext ctx, GLuint program, GLsizei uniformCount, const GLchar* const *uniformNames, GLuint* uniformIndices), err ) {
			file_log("get_uniform_indices called: ctx (GLIContext : %p)program (GLuint : %u)uniformCount (GLsizei : %i)uniformNames (const GLchar*const* : %p)uniformIndices (GLuint* : %p)", ctx, program, uniformCount, uniformNames, uniformIndices);
		...
		MACH_OVERRIDE(void,get_active_uniformsiv,(GLIContext ctx, GLuint program, GLsizei uniformCount, const GLuint* uniformIndices, GLenum pname, GLint* params), err ) {
			file_log("get_active_uniformsiv called: ctx (GLIContext : %p)program (GLuint : %u)uniformCount (GLsizei : %i)uniformIndices (const GLuint* : %p)pname (GLenum : %s)params (GLint* : %p)", ctx, program, uniformCount, uniformIndices, pname, params);
		...
		MACH_OVERRIDE(void,get_active_uniform_name,(GLIContext ctx, GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei* length, GLchar* uniformName), err ) {
			file_log("get_active_uniform_name called: ctx (GLIContext : %p)program (GLuint : %u)uniformIndex (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)uniformName (GLchar* : %p)", ctx, program, uniformIndex, bufSize, length, uniformName);
		...
		MACH_OVERRIDE(GLuint,get_uniform_block_index,(GLIContext ctx, GLuint program, const GLchar* uniformBlockName), err ) {
			file_log("get_uniform_block_index called: ctx (GLIContext : %p)program (GLuint : %u)uniformBlockName (const GLchar* : %p)", ctx, program, uniformBlockName);
		...
		MACH_OVERRIDE(void,get_active_uniform_blockiv,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params), err ) {
			file_log("get_active_uniform_blockiv called: ctx (GLIContext : %p)program (GLuint : %u)uniformBlockIndex (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, program, uniformBlockIndex, pname, params);
		...
		MACH_OVERRIDE(void,get_active_uniform_block_name,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei* length, GLchar* uniformBlockName), err ) {
			file_log("get_active_uniform_block_name called: ctx (GLIContext : %p)program (GLuint : %u)uniformBlockIndex (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)uniformBlockName (GLchar* : %p)", ctx, program, uniformBlockIndex, bufSize, length, uniformBlockName);
		...
		MACH_OVERRIDE(void,uniform_block_binding,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding), err ) {
			file_log("uniform_block_binding called: ctx (GLIContext : %p)program (GLuint : %u)uniformBlockIndex (GLuint : %u)uniformBlockBinding (GLuint : %u)", ctx, program, uniformBlockIndex, uniformBlockBinding);
		...
		MACH_OVERRIDE(void,get_combiner_input_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLfloat *params), err ) {
			file_log("get_combiner_input_parameterfv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)portion (GLenum : %s)variable (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, stage, portion, variable, pname, params);
		...
		MACH_OVERRIDE(void,get_combiner_input_parameteriv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLint *params), err ) {
			file_log("get_combiner_input_parameteriv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)portion (GLenum : %s)variable (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, stage, portion, variable, pname, params);
		...
		MACH_OVERRIDE(void,get_combiner_output_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLfloat *params), err ) {
			file_log("get_combiner_output_parameterfv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)portion (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, stage, portion, pname, params);
		...
		MACH_OVERRIDE(void,get_combiner_output_parameteriv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLint *params), err ) {
			file_log("get_combiner_output_parameteriv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)portion (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, stage, portion, pname, params);
		...
		MACH_OVERRIDE(void,get_final_combiner_input_parameterfv_NV,(GLIContext ctx, GLenum variable, GLenum pname, GLfloat *params), err ) {
			file_log("get_final_combiner_input_parameterfv_NV called: ctx (GLIContext : %p)variable (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, variable, pname, params);
		...
		MACH_OVERRIDE(void,get_final_combiner_input_parameteriv_NV,(GLIContext ctx, GLenum variable, GLenum pname, GLint *params), err ) {
			file_log("get_final_combiner_input_parameteriv_NV called: ctx (GLIContext : %p)variable (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, variable, pname, params);
		...
		MACH_OVERRIDE(void,combiner_stage_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum pname, const GLfloat *params), err ) {
			file_log("combiner_stage_parameterfv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, stage, pname, params);
		...
		MACH_OVERRIDE(void,get_combiner_stage_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum pname, GLfloat *params), err ) {
			file_log("get_combiner_stage_parameterfv_NV called: ctx (GLIContext : %p)stage (GLenum : %s)pname (GLenum : %s)params (GLfloat* : %p)", ctx, stage, pname, params);
		...
		MACH_OVERRIDE(void,texture_range_APPLE,(GLIContext ctx, GLenum target, GLsizei length, const GLvoid *pointer), err ) {
			file_log("texture_range_APPLE called: ctx (GLIContext : %p)target (GLenum : %s)length (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, target, length, pointer);
		...
		MACH_OVERRIDE(void,get_tex_parameter_pointerv_APPLE,(GLIContext ctx, GLenum target, GLenum pname, GLvoid **params), err ) {
			file_log("get_tex_parameter_pointerv_APPLE called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLvoid** : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,blend_equation_separate_EXT,(GLIContext ctx, GLenum equationRGB, GLenum equationAlpha), err ) {
			file_log("blend_equation_separate_EXT called: ctx (GLIContext : %p)equationRGB (GLenum : %s)equationAlpha (GLenum : %s)", ctx, equationRGB, equationAlpha);
		...
		MACH_OVERRIDE(void,sample_coverage,(GLIContext ctx, GLclampf value, GLboolean invert), err ) {
			file_log("sample_coverage called: ctx (GLIContext : %p)value (GLclampf : %f)invert (GLboolean : %i)", ctx, value, invert);
		...
		MACH_OVERRIDE(void,sample_pass,(GLIContext ctx, GLenum mode), err ) {
			file_log("sample_pass called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,pn_trianglesi_ATI,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("pn_trianglesi_ATI called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,pn_trianglesf_ATI,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("pn_trianglesf_ATI called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,gen_fences_APPLE,(GLIContext ctx, GLsizei n, GLuint *fences), err ) {
			file_log("gen_fences_APPLE called: ctx (GLIContext : %p)n (GLsizei : %i)fences (GLuint* : %p)", ctx, n, fences);
		...
		MACH_OVERRIDE(void,delete_fences_APPLE,(GLIContext ctx, GLsizei n, const GLuint *fences), err ) {
			file_log("delete_fences_APPLE called: ctx (GLIContext : %p)n (GLsizei : %i)fences (const GLuint* : %p)", ctx, n, fences);
		...
		MACH_OVERRIDE(void,set_fence_APPLE,(GLIContext ctx, GLuint fence), err ) {
			file_log("set_fence_APPLE called: ctx (GLIContext : %p)fence (GLuint : %u)", ctx, fence);
		...
		MACH_OVERRIDE(GLboolean,is_fence_APPLE,(GLIContext ctx, GLuint fence), err ) {
			file_log("is_fence_APPLE called: ctx (GLIContext : %p)fence (GLuint : %u)", ctx, fence);
		...
		MACH_OVERRIDE(GLboolean,test_fence_APPLE,(GLIContext ctx, GLuint fence), err ) {
			file_log("test_fence_APPLE called: ctx (GLIContext : %p)fence (GLuint : %u)", ctx, fence);
		...
		MACH_OVERRIDE(void,finish_fence_APPLE,(GLIContext ctx, GLuint fence), err ) {
			file_log("finish_fence_APPLE called: ctx (GLIContext : %p)fence (GLuint : %u)", ctx, fence);
		...
		MACH_OVERRIDE(GLboolean,test_object_APPLE,(GLIContext ctx, GLenum object, GLuint name), err ) {
			file_log("test_object_APPLE called: ctx (GLIContext : %p)object (GLenum : %s)name (GLuint : %u)", ctx, object, name);
		...
		MACH_OVERRIDE(void,finish_object_APPLE,(GLIContext ctx, GLenum object, GLuint name), err ) {
			file_log("finish_object_APPLE called: ctx (GLIContext : %p)object (GLenum : %s)name (GLuint : %u)", ctx, object, name);
		...
		MACH_OVERRIDE(void,bind_program_ARB,(GLIContext ctx, GLenum target, GLuint program), err ) {
			file_log("bind_program_ARB called: ctx (GLIContext : %p)target (GLenum : %s)program (GLuint : %u)", ctx, target, program);
		...
		MACH_OVERRIDE(void,delete_programs_ARB,(GLIContext ctx, GLsizei n, const GLuint *programs), err ) {
			file_log("delete_programs_ARB called: ctx (GLIContext : %p)n (GLsizei : %i)programs (const GLuint* : %p)", ctx, n, programs);
		...
		MACH_OVERRIDE(void,gen_programs_ARB,(GLIContext ctx, GLsizei n, GLuint *programs), err ) {
			file_log("gen_programs_ARB called: ctx (GLIContext : %p)n (GLsizei : %i)programs (GLuint* : %p)", ctx, n, programs);
		...
		MACH_OVERRIDE(GLboolean,is_program_ARB,(GLIContext ctx, GLuint program), err ) {
			file_log("is_program_ARB called: ctx (GLIContext : %p)program (GLuint : %u)", ctx, program);
		...
		MACH_OVERRIDE(void,vertex_attrib1s_ARB,(GLIContext ctx, GLuint index, GLshort x), err ) {
			file_log("vertex_attrib1s_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLshort : %i)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attrib1f_ARB,(GLIContext ctx, GLuint index, GLfloat x), err ) {
			file_log("vertex_attrib1f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLfloat : %f)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attrib1d_ARB,(GLIContext ctx, GLuint index, GLdouble x), err ) {
			file_log("vertex_attrib1d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attrib2s_ARB,(GLIContext ctx, GLuint index, GLshort x, GLshort y), err ) {
			file_log("vertex_attrib2s_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLshort : %i)y (GLshort : %i)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attrib2f_ARB,(GLIContext ctx, GLuint index, GLfloat x, GLfloat y), err ) {
			file_log("vertex_attrib2f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attrib2d_ARB,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y), err ) {
			file_log("vertex_attrib2d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attrib3s_ARB,(GLIContext ctx, GLuint index, GLshort x, GLshort y, GLshort z), err ) {
			file_log("vertex_attrib3s_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attrib3f_ARB,(GLIContext ctx, GLuint index, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("vertex_attrib3f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attrib3d_ARB,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("vertex_attrib3d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attrib4s_ARB,(GLIContext ctx, GLuint index, GLshort x, GLshort y, GLshort z, GLshort w), err ) {
			file_log("vertex_attrib4s_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)w (GLshort : %i)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attrib4f_ARB,(GLIContext ctx, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("vertex_attrib4f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attrib4d_ARB,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("vertex_attrib4d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nub_ARB,(GLIContext ctx, GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w), err ) {
			file_log("vertex_attrib4Nub_ARB called: ctx (GLIContext : %p)index (GLuint : %u)x (GLubyte : %u)y (GLubyte : %u)z (GLubyte : %u)w (GLubyte : %u)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attrib1sv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attrib1sv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib1fv_ARB,(GLIContext ctx, GLuint index, const GLfloat *v), err ) {
			file_log("vertex_attrib1fv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLfloat* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib1dv_ARB,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attrib1dv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib2sv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attrib2sv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib2fv_ARB,(GLIContext ctx, GLuint index, const GLfloat *v), err ) {
			file_log("vertex_attrib2fv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLfloat* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib2dv_ARB,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attrib2dv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib3sv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attrib3sv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib3fv_ARB,(GLIContext ctx, GLuint index, const GLfloat *v), err ) {
			file_log("vertex_attrib3fv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLfloat* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib3dv_ARB,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attrib3dv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4bv_ARB,(GLIContext ctx, GLuint index, const GLbyte *v), err ) {
			file_log("vertex_attrib4bv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLbyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4sv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attrib4sv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4iv_ARB,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attrib4iv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4ubv_ARB,(GLIContext ctx, GLuint index, const GLubyte *v), err ) {
			file_log("vertex_attrib4ubv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLubyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4usv_ARB,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			file_log("vertex_attrib4usv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLushort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4uiv_ARB,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attrib4uiv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4fv_ARB,(GLIContext ctx, GLuint index, const GLfloat *v), err ) {
			file_log("vertex_attrib4fv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLfloat* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4dv_ARB,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attrib4dv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nbv_ARB,(GLIContext ctx, GLuint index, const GLbyte *v), err ) {
			file_log("vertex_attrib4Nbv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLbyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nsv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attrib4Nsv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Niv_ARB,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attrib4Niv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nubv_ARB,(GLIContext ctx, GLuint index, const GLubyte *v), err ) {
			file_log("vertex_attrib4Nubv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLubyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nusv_ARB,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			file_log("vertex_attrib4Nusv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLushort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib4Nuiv_ARB,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attrib4Nuiv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib_pointer_ARB,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("vertex_attrib_pointer_ARB called: ctx (GLIContext : %p)index (GLuint : %u)size (GLint : %i)type (GLenum : %s)normalized (GLboolean : %i)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, index, size, type, normalized, stride, pointer);
		...
		MACH_OVERRIDE(void,enable_vertex_attrib_array_ARB,(GLIContext ctx, GLuint index), err ) {
			file_log("enable_vertex_attrib_array_ARB called: ctx (GLIContext : %p)index (GLuint : %u)", ctx, index);
		...
		MACH_OVERRIDE(void,disable_vertex_attrib_array_ARB,(GLIContext ctx, GLuint index), err ) {
			file_log("disable_vertex_attrib_array_ARB called: ctx (GLIContext : %p)index (GLuint : %u)", ctx, index);
		...
		MACH_OVERRIDE(void,get_vertex_attribdv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLdouble *params), err ) {
			file_log("get_vertex_attribdv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLdouble* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(void,get_vertex_attribfv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLfloat *params), err ) {
			file_log("get_vertex_attribfv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLfloat* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(void,get_vertex_attribiv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLint *params), err ) {
			file_log("get_vertex_attribiv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(void,get_vertex_attrib_pointerv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLvoid **pointer), err ) {
			file_log("get_vertex_attrib_pointerv_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)pointer (GLvoid** : %p)", ctx, index, pname, pointer);
		...
		MACH_OVERRIDE(void,program_env_parameter4d_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("program_env_parameter4d_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, target, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_env_parameter4dv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLdouble *params), err ) {
			file_log("program_env_parameter4dv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (const GLdouble* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,program_env_parameter4f_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("program_env_parameter4f_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, target, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_env_parameter4fv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLfloat *params), err ) {
			file_log("program_env_parameter4fv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (const GLfloat* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,program_local_parameter4d_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("program_local_parameter4d_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, target, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_local_parameter4dv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLdouble *params), err ) {
			file_log("program_local_parameter4dv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (const GLdouble* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,program_local_parameter4f_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("program_local_parameter4f_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, target, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_local_parameter4fv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLfloat *params), err ) {
			file_log("program_local_parameter4fv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (const GLfloat* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,get_program_env_parameterdv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble *params), err ) {
			file_log("get_program_env_parameterdv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (GLdouble* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,get_program_env_parameterfv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat *params), err ) {
			file_log("get_program_env_parameterfv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (GLfloat* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,get_program_local_parameterdv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble *params), err ) {
			file_log("get_program_local_parameterdv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (GLdouble* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,get_program_local_parameterfv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat *params), err ) {
			file_log("get_program_local_parameterfv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)params (GLfloat* : %p)", ctx, target, index, params);
		...
		MACH_OVERRIDE(void,program_string_ARB,(GLIContext ctx, GLenum target, GLenum format, GLsizei len, const GLvoid* string), err ) {
			file_log("program_string_ARB called: ctx (GLIContext : %p)target (GLenum : %s)format (GLenum : %s)len (GLsizei : %i)string (const GLvoid* : %p)", ctx, target, format, len, string);
		...
		MACH_OVERRIDE(void,get_program_string_ARB,(GLIContext ctx, GLenum target, GLenum pname, GLvoid *string), err ) {
			file_log("get_program_string_ARB called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)string (GLvoid* : %p)", ctx, target, pname, string);
		...
		MACH_OVERRIDE(void,get_programiv_ARB,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_programiv_ARB called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,enable_vertex_attrib_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			file_log("enable_vertex_attrib_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)", ctx, index, pname);
		...
		MACH_OVERRIDE(void,disable_vertex_attrib_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			file_log("disable_vertex_attrib_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)", ctx, index, pname);
		...
		MACH_OVERRIDE(GLboolean,is_vertex_attrib_enabled_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			file_log("is_vertex_attrib_enabled_ARB called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)", ctx, index, pname);
		...
		MACH_OVERRIDE(void,map_vertex_attrib1d_ARB,(GLIContext ctx, GLuint index, GLuint size, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), err ) {
			file_log("map_vertex_attrib1d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)size (GLuint : %u)u1 (GLdouble : %f)u2 (GLdouble : %f)stride (GLint : %i)order (GLint : %i)points (const GLdouble* : %p)", ctx, index, size, u1, u2, stride, order, points);
		...
		MACH_OVERRIDE(void,map_vertex_attrib1f_ARB,(GLIContext ctx, GLuint index, GLuint size, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), err ) {
			file_log("map_vertex_attrib1f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)size (GLuint : %u)u1 (GLfloat : %f)u2 (GLfloat : %f)stride (GLint : %i)order (GLint : %i)points (const GLfloat* : %p)", ctx, index, size, u1, u2, stride, order, points);
		...
		MACH_OVERRIDE(void,map_vertex_attrib2d_ARB,(GLIContext ctx, GLuint index, GLuint size, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points), err ) {
			file_log("map_vertex_attrib2d_ARB called: ctx (GLIContext : %p)index (GLuint : %u)size (GLuint : %u)u1 (GLdouble : %f)u2 (GLdouble : %f)ustride (GLint : %i)uorder (GLint : %i)v1 (GLdouble : %f)v2 (GLdouble : %f)vstride (GLint : %i)vorder (GLint : %i)points (const GLdouble* : %p)", ctx, index, size, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		MACH_OVERRIDE(void,map_vertex_attrib2f_ARB,(GLIContext ctx, GLuint index, GLuint size, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points), err ) {
			file_log("map_vertex_attrib2f_ARB called: ctx (GLIContext : %p)index (GLuint : %u)size (GLuint : %u)u1 (GLfloat : %f)u2 (GLfloat : %f)ustride (GLint : %i)uorder (GLint : %i)v1 (GLfloat : %f)v2 (GLfloat : %f)vstride (GLint : %i)vorder (GLint : %i)points (const GLfloat* : %p)", ctx, index, size, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		MACH_OVERRIDE(void,point_parameterf,(GLIContext ctx, GLenum pname, GLfloat param), err ) {
			file_log("point_parameterf called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLfloat : %f)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,point_parameterfv,(GLIContext ctx, GLenum pname, const GLfloat *params), err ) {
			file_log("point_parameterfv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLfloat* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,point_parameteri,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("point_parameteri called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,point_parameteriv,(GLIContext ctx, GLenum pname, const GLint *params), err ) {
			file_log("point_parameteriv called: ctx (GLIContext : %p)pname (GLenum : %s)params (const GLint* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,fog_coordf,(GLIContext ctx, GLfloat coord), err ) {
			file_log("fog_coordf called: ctx (GLIContext : %p)coord (GLfloat : %f)", ctx, coord);
		...
		MACH_OVERRIDE(void,fog_coordfv,(GLIContext ctx, const GLfloat *coord), err ) {
			file_log("fog_coordfv called: ctx (GLIContext : %p)coord (const GLfloat* : %p)", ctx, coord);
		...
		MACH_OVERRIDE(void,fog_coordd,(GLIContext ctx, GLdouble coord), err ) {
			file_log("fog_coordd called: ctx (GLIContext : %p)coord (GLdouble : %f)", ctx, coord);
		...
		MACH_OVERRIDE(void,fog_coorddv,(GLIContext ctx, const GLdouble *coord), err ) {
			file_log("fog_coorddv called: ctx (GLIContext : %p)coord (const GLdouble* : %p)", ctx, coord);
		...
		MACH_OVERRIDE(void,fog_coord_pointer,(GLIContext ctx, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("fog_coord_pointer called: ctx (GLIContext : %p)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, type, stride, pointer);
		...
		MACH_OVERRIDE(void,vertex_array_parameteri_EXT,(GLIContext ctx, GLenum pname, GLint param), err ) {
			file_log("vertex_array_parameteri_EXT called: ctx (GLIContext : %p)pname (GLenum : %s)param (GLint : %i)", ctx, pname, param);
		...
		MACH_OVERRIDE(void,bind_vertex_array_EXT,(GLIContext ctx, GLuint id), err ) {
			file_log("bind_vertex_array_EXT called: ctx (GLIContext : %p)id (GLuint : %u)", ctx, id);
		...
		MACH_OVERRIDE(void,delete_vertex_arrays_EXT,(GLIContext ctx, GLsizei n, const GLuint *ids), err ) {
			file_log("delete_vertex_arrays_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)ids (const GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(void,gen_vertex_arrays_EXT,(GLIContext ctx, GLsizei n, GLuint *ids), err ) {
			file_log("gen_vertex_arrays_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)ids (GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(GLboolean,is_vertex_array_EXT,(GLIContext ctx, GLuint id), err ) {
			file_log("is_vertex_array_EXT called: ctx (GLIContext : %p)id (GLuint : %u)", ctx, id);
		...
		MACH_OVERRIDE(void,element_pointer_APPLE,(GLIContext ctx, GLenum type, const GLvoid *pointer), err ) {
			file_log("element_pointer_APPLE called: ctx (GLIContext : %p)type (GLenum : %s)pointer (const GLvoid* : %p)", ctx, type, pointer);
		...
		MACH_OVERRIDE(void,draw_element_array_APPLE,(GLIContext ctx, GLenum mode, GLint first, GLsizei count), err ) {
			file_log("draw_element_array_APPLE called: ctx (GLIContext : %p)mode (GLenum : %s)first (GLint : %i)count (GLsizei : %i)", ctx, mode, first, count);
		...
		MACH_OVERRIDE(void,draw_range_element_array_APPLE,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLint first, GLsizei count), err ) {
			file_log("draw_range_element_array_APPLE called: ctx (GLIContext : %p)mode (GLenum : %s)start (GLuint : %u)end (GLuint : %u)first (GLint : %i)count (GLsizei : %i)", ctx, mode, start, end, first, count);
		...
		MACH_OVERRIDE(void,weightbv_ARB,(GLIContext ctx, GLint size, const GLbyte *weights), err ) {
			file_log("weightbv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLbyte* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightsv_ARB,(GLIContext ctx, GLint size, const GLshort *weights), err ) {
			file_log("weightsv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLshort* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightiv_ARB,(GLIContext ctx, GLint size, const GLint *weights), err ) {
			file_log("weightiv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLint* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightfv_ARB,(GLIContext ctx, GLint size, const GLfloat *weights), err ) {
			file_log("weightfv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLfloat* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightdv_ARB,(GLIContext ctx, GLint size, const GLdouble *weights), err ) {
			file_log("weightdv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLdouble* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightubv_ARB,(GLIContext ctx, GLint size, const GLubyte *weights), err ) {
			file_log("weightubv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLubyte* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightusv_ARB,(GLIContext ctx, GLint size, const GLushort *weights), err ) {
			file_log("weightusv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLushort* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weightuiv_ARB,(GLIContext ctx, GLint size, const GLuint *weights), err ) {
			file_log("weightuiv_ARB called: ctx (GLIContext : %p)size (GLint : %i)weights (const GLuint* : %p)", ctx, size, weights);
		...
		MACH_OVERRIDE(void,weight_pointer_ARB,(GLIContext ctx, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("weight_pointer_ARB called: ctx (GLIContext : %p)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,vertex_blend_ARB,(GLIContext ctx, GLint count), err ) {
			file_log("vertex_blend_ARB called: ctx (GLIContext : %p)count (GLint : %i)", ctx, count);
		...
		MACH_OVERRIDE(void,multi_draw_arrays,(GLIContext ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount), err ) {
			file_log("multi_draw_arrays called: ctx (GLIContext : %p)mode (GLenum : %s)first (const GLint* : %p)count (const GLsizei* : %p)drawcount (GLsizei : %i)", ctx, mode, first, count, drawcount);
		...
		MACH_OVERRIDE(void,multi_draw_elements,(GLIContext ctx, GLenum mode, const GLsizei *count, GLenum type, const GLvoid* const *indices, GLsizei drawcount), err ) {
			file_log("multi_draw_elements called: ctx (GLIContext : %p)mode (GLenum : %s)count (const GLsizei* : %p)type (GLenum : %s)indices (const GLvoid*const* : %p)drawcount (GLsizei : %i)", ctx, mode, count, type, indices, drawcount);
		...
		MACH_OVERRIDE(void,window_pos2d,(GLIContext ctx, GLdouble x, GLdouble y), err ) {
			file_log("window_pos2d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,window_pos2dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("window_pos2dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos2f,(GLIContext ctx, GLfloat x, GLfloat y), err ) {
			file_log("window_pos2f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)", ctx, x, y);
		...
		MACH_OVERRIDE(void,window_pos2fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("window_pos2fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos2i,(GLIContext ctx, GLint x, GLint y), err ) {
			file_log("window_pos2i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,window_pos2iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("window_pos2iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos2s,(GLIContext ctx, GLshort x, GLshort y), err ) {
			file_log("window_pos2s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)", ctx, x, y);
		...
		MACH_OVERRIDE(void,window_pos2sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("window_pos2sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos3d,(GLIContext ctx, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("window_pos3d called: ctx (GLIContext : %p)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,window_pos3dv,(GLIContext ctx, const GLdouble *v), err ) {
			file_log("window_pos3dv called: ctx (GLIContext : %p)v (const GLdouble* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos3f,(GLIContext ctx, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("window_pos3f called: ctx (GLIContext : %p)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,window_pos3fv,(GLIContext ctx, const GLfloat *v), err ) {
			file_log("window_pos3fv called: ctx (GLIContext : %p)v (const GLfloat* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos3i,(GLIContext ctx, GLint x, GLint y, GLint z), err ) {
			file_log("window_pos3i called: ctx (GLIContext : %p)x (GLint : %i)y (GLint : %i)z (GLint : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,window_pos3iv,(GLIContext ctx, const GLint *v), err ) {
			file_log("window_pos3iv called: ctx (GLIContext : %p)v (const GLint* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,window_pos3s,(GLIContext ctx, GLshort x, GLshort y, GLshort z), err ) {
			file_log("window_pos3s called: ctx (GLIContext : %p)x (GLshort : %i)y (GLshort : %i)z (GLshort : %i)", ctx, x, y, z);
		...
		MACH_OVERRIDE(void,window_pos3sv,(GLIContext ctx, const GLshort *v), err ) {
			file_log("window_pos3sv called: ctx (GLIContext : %p)v (const GLshort* : %p)", ctx, v);
		...
		MACH_OVERRIDE(void,active_stencil_face_EXT,(GLIContext ctx, GLenum face), err ) {
			file_log("active_stencil_face_EXT called: ctx (GLIContext : %p)face (GLenum : %s)", ctx, face);
		...
		MACH_OVERRIDE(void,stencil_op_separate_ATI,(GLIContext ctx, GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass), err ) {
			file_log("stencil_op_separate_ATI called: ctx (GLIContext : %p)face (GLenum : %s)sfail (GLenum : %s)dpfail (GLenum : %s)dppass (GLenum : %s)", ctx, face, sfail, dpfail, dppass);
		...
		MACH_OVERRIDE(void,stencil_func_separate_ATI,(GLIContext ctx, GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask), err ) {
			file_log("stencil_func_separate_ATI called: ctx (GLIContext : %p)frontfunc (GLenum : %s)backfunc (GLenum : %s)ref (GLint : %i)mask (GLuint : %u)", ctx, frontfunc, backfunc, ref, mask);
		...
		MACH_OVERRIDE(void,flush_render_APPLE,(GLIContext ctx), err ) {
			file_log("flush_render_APPLE called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,finish_render_APPLE,(GLIContext ctx), err ) {
			file_log("finish_render_APPLE called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,swap_APPLE,(GLIContext ctx), err ) {
			file_log("swap_APPLE called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,delete_object_ARB,(GLIContext ctx, GLhandleARB obj), err ) {
			file_log("delete_object_ARB called: ctx (GLIContext : %p)obj (GLhandleARB : %p)", ctx, obj);
		...
		MACH_OVERRIDE(GLhandleARB,get_handle_ARB,(GLIContext ctx, GLenum pname), err ) {
			file_log("get_handle_ARB called: ctx (GLIContext : %p)pname (GLenum : %s)", ctx, pname);
		...
		MACH_OVERRIDE(void,detach_object_ARB,(GLIContext ctx, GLhandleARB containerObj, GLhandleARB attachedObj), err ) {
			file_log("detach_object_ARB called: ctx (GLIContext : %p)containerObj (GLhandleARB : %p)attachedObj (GLhandleARB : %p)", ctx, containerObj, attachedObj);
		...
		MACH_OVERRIDE(GLhandleARB,create_shader_object_ARB,(GLIContext ctx, GLenum shaderType), err ) {
			file_log("create_shader_object_ARB called: ctx (GLIContext : %p)shaderType (GLenum : %s)", ctx, shaderType);
		...
		MACH_OVERRIDE(void,shader_source_ARB,(GLIContext ctx, GLhandleARB shaderObj, GLsizei count, const GLcharARB* const *string, const GLint *length), err ) {
			file_log("shader_source_ARB called: ctx (GLIContext : %p)shaderObj (GLhandleARB : %p)count (GLsizei : %i)string (const GLcharARB*const* : %p)length (const GLint* : %p)", ctx, shaderObj, count, string, length);
		...
		MACH_OVERRIDE(void,compile_shader_ARB,(GLIContext ctx, GLhandleARB shaderObj), err ) {
			file_log("compile_shader_ARB called: ctx (GLIContext : %p)shaderObj (GLhandleARB : %p)", ctx, shaderObj);
		...
		MACH_OVERRIDE(GLhandleARB,create_program_object_ARB,(GLIContext ctx), err ) {
			file_log("create_program_object_ARB called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,attach_object_ARB,(GLIContext ctx, GLhandleARB containerObj, GLhandleARB obj), err ) {
			file_log("attach_object_ARB called: ctx (GLIContext : %p)containerObj (GLhandleARB : %p)obj (GLhandleARB : %p)", ctx, containerObj, obj);
		...
		MACH_OVERRIDE(void,link_program_ARB,(GLIContext ctx, GLhandleARB programObj), err ) {
			file_log("link_program_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)", ctx, programObj);
		...
		MACH_OVERRIDE(void,use_program_object_ARB,(GLIContext ctx, GLhandleARB programObj), err ) {
			file_log("use_program_object_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)", ctx, programObj);
		...
		MACH_OVERRIDE(void,validate_program_ARB,(GLIContext ctx, GLhandleARB programObj), err ) {
			file_log("validate_program_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)", ctx, programObj);
		...
		MACH_OVERRIDE(void,uniform1f_ARB,(GLIContext ctx, GLint location, GLfloat v0), err ) {
			file_log("uniform1f_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLfloat : %f)", ctx, location, v0);
		...
		MACH_OVERRIDE(void,uniform2f_ARB,(GLIContext ctx, GLint location, GLfloat v0, GLfloat v1), err ) {
			file_log("uniform2f_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLfloat : %f)v1 (GLfloat : %f)", ctx, location, v0, v1);
		...
		MACH_OVERRIDE(void,uniform3f_ARB,(GLIContext ctx, GLint location, GLfloat v0, GLfloat v1, GLfloat v2), err ) {
			file_log("uniform3f_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLfloat : %f)v1 (GLfloat : %f)v2 (GLfloat : %f)", ctx, location, v0, v1, v2);
		...
		MACH_OVERRIDE(void,uniform4f_ARB,(GLIContext ctx, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3), err ) {
			file_log("uniform4f_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLfloat : %f)v1 (GLfloat : %f)v2 (GLfloat : %f)v3 (GLfloat : %f)", ctx, location, v0, v1, v2, v3);
		...
		MACH_OVERRIDE(void,uniform1i_ARB,(GLIContext ctx, GLint location, GLint v0), err ) {
			file_log("uniform1i_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLint : %i)", ctx, location, v0);
		...
		MACH_OVERRIDE(void,uniform2i_ARB,(GLIContext ctx, GLint location, GLint v0, GLint v1), err ) {
			file_log("uniform2i_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLint : %i)v1 (GLint : %i)", ctx, location, v0, v1);
		...
		MACH_OVERRIDE(void,uniform3i_ARB,(GLIContext ctx, GLint location, GLint v0, GLint v1, GLint v2), err ) {
			file_log("uniform3i_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLint : %i)v1 (GLint : %i)v2 (GLint : %i)", ctx, location, v0, v1, v2);
		...
		MACH_OVERRIDE(void,uniform4i_ARB,(GLIContext ctx, GLint location, GLint v0, GLint v1, GLint v2, GLint v3), err ) {
			file_log("uniform4i_ARB called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLint : %i)v1 (GLint : %i)v2 (GLint : %i)v3 (GLint : %i)", ctx, location, v0, v1, v2, v3);
		...
		MACH_OVERRIDE(void,uniform1fv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("uniform1fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform2fv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("uniform2fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform3fv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("uniform3fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform4fv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("uniform4fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform1iv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("uniform1iv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform2iv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("uniform2iv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform3iv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("uniform3iv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform4iv_ARB,(GLIContext ctx, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("uniform4iv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix2fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix3fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix4fv_ARB called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,get_object_parameterfv_ARB,(GLIContext ctx, GLhandleARB obj, GLenum pname, GLfloat *params), err ) {
			file_log("get_object_parameterfv_ARB called: ctx (GLIContext : %p)obj (GLhandleARB : %p)pname (GLenum : %s)params (GLfloat* : %p)", ctx, obj, pname, params);
		...
		MACH_OVERRIDE(void,get_object_parameteriv_ARB,(GLIContext ctx, GLhandleARB obj, GLenum pname, GLint *params), err ) {
			file_log("get_object_parameteriv_ARB called: ctx (GLIContext : %p)obj (GLhandleARB : %p)pname (GLenum : %s)params (GLint* : %p)", ctx, obj, pname, params);
		...
		MACH_OVERRIDE(void,get_info_log_ARB,(GLIContext ctx, GLhandleARB obj, GLsizei maxLength, GLsizei *length, GLcharARB *infoLog), err ) {
			file_log("get_info_log_ARB called: ctx (GLIContext : %p)obj (GLhandleARB : %p)maxLength (GLsizei : %i)length (GLsizei* : %p)infoLog (GLcharARB* : %p)", ctx, obj, maxLength, length, infoLog);
		...
		MACH_OVERRIDE(void,get_attached_objects_ARB,(GLIContext ctx, GLhandleARB containerObj, GLsizei maxCount, GLsizei *count, GLhandleARB *obj), err ) {
			file_log("get_attached_objects_ARB called: ctx (GLIContext : %p)containerObj (GLhandleARB : %p)maxCount (GLsizei : %i)count (GLsizei* : %p)obj (GLhandleARB* : %p)", ctx, containerObj, maxCount, count, obj);
		...
		MACH_OVERRIDE(GLint,get_uniform_location_ARB,(GLIContext ctx, GLhandleARB programObj, const GLcharARB *name), err ) {
			file_log("get_uniform_location_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)name (const GLcharARB* : %p)", ctx, programObj, name);
		...
		MACH_OVERRIDE(void,get_active_uniform_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei *length, GLint *size, GLenum *type, GLcharARB *name), err ) {
			file_log("get_active_uniform_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)index (GLuint : %u)maxLength (GLsizei : %i)length (GLsizei* : %p)size (GLint* : %p)type (GLenum* : %p)name (GLcharARB* : %p)", ctx, programObj, index, maxLength, length, size, type, name);
		...
		MACH_OVERRIDE(void,get_uniformfv_ARB,(GLIContext ctx, GLhandleARB programObj, GLint location, GLfloat *params), err ) {
			file_log("get_uniformfv_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)location (GLint : %i)params (GLfloat* : %p)", ctx, programObj, location, params);
		...
		MACH_OVERRIDE(void,get_uniformiv_ARB,(GLIContext ctx, GLhandleARB programObj, GLint location, GLint *params), err ) {
			file_log("get_uniformiv_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)location (GLint : %i)params (GLint* : %p)", ctx, programObj, location, params);
		...
		MACH_OVERRIDE(void,get_shader_source_ARB,(GLIContext ctx, GLhandleARB obj, GLsizei maxLength, GLsizei *length, GLcharARB *source), err ) {
			file_log("get_shader_source_ARB called: ctx (GLIContext : %p)obj (GLhandleARB : %p)maxLength (GLsizei : %i)length (GLsizei* : %p)source (GLcharARB* : %p)", ctx, obj, maxLength, length, source);
		...
		MACH_OVERRIDE(void,bind_attrib_location_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, const GLcharARB *name), err ) {
			file_log("bind_attrib_location_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)index (GLuint : %u)name (const GLcharARB* : %p)", ctx, programObj, index, name);
		...
		MACH_OVERRIDE(void,get_active_attrib_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei *length, GLint *size, GLenum *type, GLcharARB *name), err ) {
			file_log("get_active_attrib_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)index (GLuint : %u)maxLength (GLsizei : %i)length (GLsizei* : %p)size (GLint* : %p)type (GLenum* : %p)name (GLcharARB* : %p)", ctx, programObj, index, maxLength, length, size, type, name);
		...
		MACH_OVERRIDE(GLint,get_attrib_location_ARB,(GLIContext ctx, GLhandleARB programObj, const GLcharARB *name), err ) {
			file_log("get_attrib_location_ARB called: ctx (GLIContext : %p)programObj (GLhandleARB : %p)name (const GLcharARB* : %p)", ctx, programObj, name);
		...
		MACH_OVERRIDE(void,clamp_color_ARB,(GLIContext ctx, GLenum target, GLenum clamp), err ) {
			file_log("clamp_color_ARB called: ctx (GLIContext : %p)target (GLenum : %s)clamp (GLenum : %s)", ctx, target, clamp);
		...
		MACH_OVERRIDE(void,gen_queries,(GLIContext ctx, GLsizei n, GLuint *ids), err ) {
			file_log("gen_queries called: ctx (GLIContext : %p)n (GLsizei : %i)ids (GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(void,delete_queries,(GLIContext ctx, GLsizei n, const GLuint *ids), err ) {
			file_log("delete_queries called: ctx (GLIContext : %p)n (GLsizei : %i)ids (const GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(GLboolean,is_query,(GLIContext ctx, GLuint id), err ) {
			file_log("is_query called: ctx (GLIContext : %p)id (GLuint : %u)", ctx, id);
		...
		MACH_OVERRIDE(void,begin_query,(GLIContext ctx, GLenum target, GLuint id), err ) {
			file_log("begin_query called: ctx (GLIContext : %p)target (GLenum : %s)id (GLuint : %u)", ctx, target, id);
		...
		MACH_OVERRIDE(void,end_query,(GLIContext ctx, GLenum target), err ) {
			file_log("end_query called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,get_queryiv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_queryiv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_query_objectiv,(GLIContext ctx, GLuint id, GLenum pname, GLint *params), err ) {
			file_log("get_query_objectiv called: ctx (GLIContext : %p)id (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, id, pname, params);
		...
		MACH_OVERRIDE(void,get_query_objectuiv,(GLIContext ctx, GLuint id, GLenum pname, GLuint *params), err ) {
			file_log("get_query_objectuiv called: ctx (GLIContext : %p)id (GLuint : %u)pname (GLenum : %s)params (GLuint* : %p)", ctx, id, pname, params);
		...
		MACH_OVERRIDE(void,bind_buffer,(GLIContext ctx, GLenum target, GLuint buffer), err ) {
			file_log("bind_buffer called: ctx (GLIContext : %p)target (GLenum : %s)buffer (GLuint : %u)", ctx, target, buffer);
		...
		MACH_OVERRIDE(void,delete_buffers,(GLIContext ctx, GLsizei n, const GLuint *buffers), err ) {
			file_log("delete_buffers called: ctx (GLIContext : %p)n (GLsizei : %i)buffers (const GLuint* : %p)", ctx, n, buffers);
		...
		MACH_OVERRIDE(void,gen_buffers,(GLIContext ctx, GLsizei n, GLuint *buffers), err ) {
			file_log("gen_buffers called: ctx (GLIContext : %p)n (GLsizei : %i)buffers (GLuint* : %p)", ctx, n, buffers);
		...
		MACH_OVERRIDE(GLboolean,is_buffer,(GLIContext ctx, GLuint buffer), err ) {
			file_log("is_buffer called: ctx (GLIContext : %p)buffer (GLuint : %u)", ctx, buffer);
		...
		MACH_OVERRIDE(void,buffer_data,(GLIContext ctx, GLenum target, GLsizeiptrARB size, const GLvoid *data, GLenum usage), err ) {
			file_log("buffer_data called: ctx (GLIContext : %p)target (GLenum : %s)size (GLsizeiptrARB : %p)data (const GLvoid* : %p)usage (GLenum : %s)", ctx, target, size, data, usage);
		...
		MACH_OVERRIDE(void,buffer_sub_data,(GLIContext ctx, GLenum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid *data), err ) {
			file_log("buffer_sub_data called: ctx (GLIContext : %p)target (GLenum : %s)offset (GLintptrARB : %p)size (GLsizeiptrARB : %p)data (const GLvoid* : %p)", ctx, target, offset, size, data);
		...
		MACH_OVERRIDE(void,get_buffer_sub_data,(GLIContext ctx, GLenum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid *data), err ) {
			file_log("get_buffer_sub_data called: ctx (GLIContext : %p)target (GLenum : %s)offset (GLintptrARB : %p)size (GLsizeiptrARB : %p)data (GLvoid* : %p)", ctx, target, offset, size, data);
		...
		MACH_OVERRIDE(GLvoid,map_buffer,(GLIContext ctx, GLenum target, GLenum access), err ) {
			file_log("map_buffer called: ctx (GLIContext : %p)target (GLenum : %s)access (GLenum : %s)", ctx, target, access);
		...
		MACH_OVERRIDE(GLboolean,unmap_buffer,(GLIContext ctx, GLenum target), err ) {
			file_log("unmap_buffer called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,get_buffer_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_buffer_parameteriv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_buffer_pointerv,(GLIContext ctx, GLenum target, GLenum pname, GLvoid **params), err ) {
			file_log("get_buffer_pointerv called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLvoid** : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,depth_bounds_EXT,(GLIContext ctx, GLclampd zmin, GLclampd zmax), err ) {
			file_log("depth_bounds_EXT called: ctx (GLIContext : %p)zmin (GLclampd : %f)zmax (GLclampd : %f)", ctx, zmin, zmax);
		...
		MACH_OVERRIDE(void,draw_buffers_ARB,(GLIContext ctx, GLsizei n, const GLenum *bufs), err ) {
			file_log("draw_buffers_ARB called: ctx (GLIContext : %p)n (GLsizei : %i)bufs (const GLenum* : %p)", ctx, n, bufs);
		...
		MACH_OVERRIDE(GLboolean,is_shader,(GLIContext ctx, GLuint shader), err ) {
			file_log("is_shader called: ctx (GLIContext : %p)shader (GLuint : %u)", ctx, shader);
		...
		MACH_OVERRIDE(GLboolean,is_program,(GLIContext ctx, GLuint program), err ) {
			file_log("is_program called: ctx (GLIContext : %p)program (GLuint : %u)", ctx, program);
		...
		MACH_OVERRIDE(void,get_shaderiv,(GLIContext ctx, GLuint shader, GLenum pname, GLint *params), err ) {
			file_log("get_shaderiv called: ctx (GLIContext : %p)shader (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, shader, pname, params);
		...
		MACH_OVERRIDE(void,get_programiv,(GLIContext ctx, GLuint program, GLenum pname, GLint *params), err ) {
			file_log("get_programiv called: ctx (GLIContext : %p)program (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, program, pname, params);
		...
		MACH_OVERRIDE(void,get_shader_info_log,(GLIContext ctx, GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog), err ) {
			file_log("get_shader_info_log called: ctx (GLIContext : %p)shader (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)infoLog (GLchar* : %p)", ctx, shader, bufSize, length, infoLog);
		...
		MACH_OVERRIDE(void,get_program_info_log,(GLIContext ctx, GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog), err ) {
			file_log("get_program_info_log called: ctx (GLIContext : %p)program (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)infoLog (GLchar* : %p)", ctx, program, bufSize, length, infoLog);
		...
		MACH_OVERRIDE(void,stencil_func_separate,(GLIContext ctx, GLenum face, GLenum func, GLint ref, GLuint mask), err ) {
			file_log("stencil_func_separate called: ctx (GLIContext : %p)face (GLenum : %s)func (GLenum : %s)ref (GLint : %i)mask (GLuint : %u)", ctx, face, func, ref, mask);
		...
		MACH_OVERRIDE(void,stencil_mask_separate,(GLIContext ctx, GLenum face, GLuint mask), err ) {
			file_log("stencil_mask_separate called: ctx (GLIContext : %p)face (GLenum : %s)mask (GLuint : %u)", ctx, face, mask);
		...
		MACH_OVERRIDE(void,multi_draw_element_array_APPLE,(GLIContext ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount), err ) {
			file_log("multi_draw_element_array_APPLE called: ctx (GLIContext : %p)mode (GLenum : %s)first (const GLint* : %p)count (const GLsizei* : %p)primcount (GLsizei : %i)", ctx, mode, first, count, primcount);
		...
		MACH_OVERRIDE(void,multi_draw_range_element_array_APPLE,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, const GLint *first, const GLsizei *count, GLsizei primcount), err ) {
			file_log("multi_draw_range_element_array_APPLE called: ctx (GLIContext : %p)mode (GLenum : %s)start (GLuint : %u)end (GLuint : %u)first (const GLint* : %p)count (const GLsizei* : %p)primcount (GLsizei : %i)", ctx, mode, start, end, first, count, primcount);
		...
		MACH_OVERRIDE(GLboolean,is_renderbuffer_EXT,(GLIContext ctx, GLuint renderbuffer), err ) {
			file_log("is_renderbuffer_EXT called: ctx (GLIContext : %p)renderbuffer (GLuint : %u)", ctx, renderbuffer);
		...
		MACH_OVERRIDE(void,bind_renderbuffer_EXT,(GLIContext ctx, GLenum target, GLuint renderbuffer), err ) {
			file_log("bind_renderbuffer_EXT called: ctx (GLIContext : %p)target (GLenum : %s)renderbuffer (GLuint : %u)", ctx, target, renderbuffer);
		...
		MACH_OVERRIDE(void,delete_renderbuffers_EXT,(GLIContext ctx, GLsizei n, const GLuint *renderbuffers), err ) {
			file_log("delete_renderbuffers_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)renderbuffers (const GLuint* : %p)", ctx, n, renderbuffers);
		...
		MACH_OVERRIDE(void,gen_renderbuffers_EXT,(GLIContext ctx, GLsizei n, GLuint *renderbuffers), err ) {
			file_log("gen_renderbuffers_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)renderbuffers (GLuint* : %p)", ctx, n, renderbuffers);
		...
		MACH_OVERRIDE(void,renderbuffer_storage_EXT,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			file_log("renderbuffer_storage_EXT called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, internalformat, width, height);
		...
		MACH_OVERRIDE(void,get_renderbuffer_parameteriv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_renderbuffer_parameteriv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(GLboolean,is_framebuffer_EXT,(GLIContext ctx, GLuint framebuffer), err ) {
			file_log("is_framebuffer_EXT called: ctx (GLIContext : %p)framebuffer (GLuint : %u)", ctx, framebuffer);
		...
		MACH_OVERRIDE(void,bind_framebuffer_EXT,(GLIContext ctx, GLenum target, GLuint framebuffer), err ) {
			file_log("bind_framebuffer_EXT called: ctx (GLIContext : %p)target (GLenum : %s)framebuffer (GLuint : %u)", ctx, target, framebuffer);
		...
		MACH_OVERRIDE(void,delete_framebuffers_EXT,(GLIContext ctx, GLsizei n, const GLuint *framebuffers), err ) {
			file_log("delete_framebuffers_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)framebuffers (const GLuint* : %p)", ctx, n, framebuffers);
		...
		MACH_OVERRIDE(void,gen_framebuffers_EXT,(GLIContext ctx, GLsizei n, GLuint *framebuffers), err ) {
			file_log("gen_framebuffers_EXT called: ctx (GLIContext : %p)n (GLsizei : %i)framebuffers (GLuint* : %p)", ctx, n, framebuffers);
		...
		MACH_OVERRIDE(GLenum,check_framebuffer_status_EXT,(GLIContext ctx, GLenum target), err ) {
			file_log("check_framebuffer_status_EXT called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,framebuffer_texture1D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level), err ) {
			file_log("framebuffer_texture1D_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)textarget (GLenum : %s)texture (GLuint : %u)level (GLint : %i)", ctx, target, attachment, textarget, texture, level);
		...
		MACH_OVERRIDE(void,framebuffer_texture2D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level), err ) {
			file_log("framebuffer_texture2D_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)textarget (GLenum : %s)texture (GLuint : %u)level (GLint : %i)", ctx, target, attachment, textarget, texture, level);
		...
		MACH_OVERRIDE(void,framebuffer_texture3D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset), err ) {
			file_log("framebuffer_texture3D_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)textarget (GLenum : %s)texture (GLuint : %u)level (GLint : %i)zoffset (GLint : %i)", ctx, target, attachment, textarget, texture, level, zoffset);
		...
		MACH_OVERRIDE(void,framebuffer_renderbuffer_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer), err ) {
			file_log("framebuffer_renderbuffer_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)renderbuffertarget (GLenum : %s)renderbuffer (GLuint : %u)", ctx, target, attachment, renderbuffertarget, renderbuffer);
		...
		MACH_OVERRIDE(void,get_framebuffer_attachment_parameteriv_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum pname, GLint *params), err ) {
			file_log("get_framebuffer_attachment_parameteriv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, attachment, pname, params);
		...
		MACH_OVERRIDE(void,generate_mipmap_EXT,(GLIContext ctx, GLenum target), err ) {
			file_log("generate_mipmap_EXT called: ctx (GLIContext : %p)target (GLenum : %s)", ctx, target);
		...
		MACH_OVERRIDE(void,buffer_parameteri_APPLE,(GLIContext ctx, GLenum target, GLenum pname, GLint param), err ) {
			file_log("buffer_parameteri_APPLE called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)param (GLint : %i)", ctx, target, pname, param);
		...
		MACH_OVERRIDE(void,flush_mapped_buffer_range_APPLE,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr size), err ) {
			file_log("flush_mapped_buffer_range_APPLE called: ctx (GLIContext : %p)target (GLenum : %s)offset (GLintptr : %p)size (GLsizeiptr : %p)", ctx, target, offset, size);
		...
		MACH_OVERRIDE(void,program_env_parameters4fv_EXT,(GLIContext ctx, GLenum target, GLuint index, GLsizei count, const GLfloat *params), err ) {
			file_log("program_env_parameters4fv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)count (GLsizei : %i)params (const GLfloat* : %p)", ctx, target, index, count, params);
		...
		MACH_OVERRIDE(void,program_local_parameters4fv_EXT,(GLIContext ctx, GLenum target, GLuint index, GLsizei count, const GLfloat *params), err ) {
			file_log("program_local_parameters4fv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)count (GLsizei : %i)params (const GLfloat* : %p)", ctx, target, index, count, params);
		...
		MACH_OVERRIDE(GLenum,object_purgeable_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum option), err ) {
			file_log("object_purgeable_APPLE called: ctx (GLIContext : %p)objectType (GLenum : %s)name (GLuint : %u)option (GLenum : %s)", ctx, objectType, name, option);
		...
		MACH_OVERRIDE(GLenum,object_unpurgeable_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum option), err ) {
			file_log("object_unpurgeable_APPLE called: ctx (GLIContext : %p)objectType (GLenum : %s)name (GLuint : %u)option (GLenum : %s)", ctx, objectType, name, option);
		...
		MACH_OVERRIDE(void,get_object_parameteriv_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum pname, GLint* params), err ) {
			file_log("get_object_parameteriv_APPLE called: ctx (GLIContext : %p)objectType (GLenum : %s)name (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, objectType, name, pname, params);
		...
		MACH_OVERRIDE(void,program_parameteri_EXT,(GLIContext ctx, GLuint program_name, GLenum pname, GLint value), err ) {
			file_log("program_parameteri_EXT called: ctx (GLIContext : %p)program_name (GLuint : %u)pname (GLenum : %s)value (GLint : %i)", ctx, program_name, pname, value);
		...
		MACH_OVERRIDE(void,framebuffer_texture_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level), err ) {
			file_log("framebuffer_texture_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)texture (GLuint : %u)level (GLint : %i)", ctx, target, attachment, texture, level);
		...
		MACH_OVERRIDE(void,framebuffer_texture_layer_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer), err ) {
			file_log("framebuffer_texture_layer_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)texture (GLuint : %u)level (GLint : %i)layer (GLint : %i)", ctx, target, attachment, texture, level, layer);
		...
		MACH_OVERRIDE(void,framebuffer_texture_face_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLenum face), err ) {
			file_log("framebuffer_texture_face_EXT called: ctx (GLIContext : %p)target (GLenum : %s)attachment (GLenum : %s)texture (GLuint : %u)level (GLint : %i)face (GLenum : %s)", ctx, target, attachment, texture, level, face);
		...
		MACH_OVERRIDE(void,bind_buffer_range_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size), err ) {
			file_log("bind_buffer_range_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)buffer (GLuint : %u)offset (GLintptr : %p)size (GLsizeiptr : %p)", ctx, target, index, buffer, offset, size);
		...
		MACH_OVERRIDE(void,bind_buffer_offset_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer, GLintptr offset), err ) {
			file_log("bind_buffer_offset_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)buffer (GLuint : %u)offset (GLintptr : %p)", ctx, target, index, buffer, offset);
		...
		MACH_OVERRIDE(void,bind_buffer_base_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer), err ) {
			file_log("bind_buffer_base_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)buffer (GLuint : %u)", ctx, target, index, buffer);
		...
		MACH_OVERRIDE(void,begin_transform_feedback_EXT,(GLIContext ctx, GLenum primitiveMode), err ) {
			file_log("begin_transform_feedback_EXT called: ctx (GLIContext : %p)primitiveMode (GLenum : %s)", ctx, primitiveMode);
		...
		MACH_OVERRIDE(void,end_transform_feedback_EXT,(GLIContext ctx), err ) {
			file_log("end_transform_feedback_EXT called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,transform_feedback_varyings_EXT,(GLIContext ctx, GLuint program, GLsizei count, const GLchar* const *varyings, GLenum bufferMode), err ) {
			file_log("transform_feedback_varyings_EXT called: ctx (GLIContext : %p)program (GLuint : %u)count (GLsizei : %i)varyings (const GLchar*const* : %p)bufferMode (GLenum : %s)", ctx, program, count, varyings, bufferMode);
		...
		MACH_OVERRIDE(void,get_transform_feedback_varying_EXT,(GLIContext ctx, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLsizei *size, GLenum *type, GLchar *name), err ) {
			file_log("get_transform_feedback_varying_EXT called: ctx (GLIContext : %p)program (GLuint : %u)index (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)size (GLsizei* : %p)type (GLenum* : %p)name (GLchar* : %p)", ctx, program, index, bufSize, length, size, type, name);
		...
		MACH_OVERRIDE(void,get_integer_indexedv_EXT,(GLIContext ctx, GLenum param, GLuint index, GLint *values), err ) {
			file_log("get_integer_indexedv_EXT called: ctx (GLIContext : %p)param (GLenum : %s)index (GLuint : %u)values (GLint* : %p)", ctx, param, index, values);
		...
		MACH_OVERRIDE(void,get_boolean_indexedv_EXT,(GLIContext ctx, GLenum param, GLuint index, GLboolean *values), err ) {
			file_log("get_boolean_indexedv_EXT called: ctx (GLIContext : %p)param (GLenum : %s)index (GLuint : %u)values (GLboolean* : %p)", ctx, param, index, values);
		...
		MACH_OVERRIDE(void,uniform_buffer_EXT,(GLIContext ctx, GLuint program, GLint location, GLuint buffer), err ) {
			file_log("uniform_buffer_EXT called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)buffer (GLuint : %u)", ctx, program, location, buffer);
		...
		MACH_OVERRIDE(GLint,get_uniform_buffer_size_EXT,(GLIContext ctx, GLuint program, GLint location), err ) {
			file_log("get_uniform_buffer_size_EXT called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)", ctx, program, location);
		...
		MACH_OVERRIDE(GLintptr,get_uniform_buffer_offset_EXT,(GLIContext ctx, GLuint program, GLint location), err ) {
			file_log("get_uniform_buffer_offset_EXT called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)", ctx, program, location);
		...
		MACH_OVERRIDE(void,clear_colorIi_EXT,(GLIContext ctx, GLint r, GLint g, GLint b, GLint a ), err ) {
			file_log("clear_colorIi_EXT called: ctx (GLIContext : %p)r (GLint : %i)g (GLint : %i)b (GLint : %i)a (GLint : %i)", ctx, r, g, b, a);
		...
		MACH_OVERRIDE(void,clear_colorIui_EXT,(GLIContext ctx, GLuint r, GLuint g, GLuint b, GLuint a ), err ) {
			file_log("clear_colorIui_EXT called: ctx (GLIContext : %p)r (GLuint : %u)g (GLuint : %u)b (GLuint : %u)a (GLuint : %u)", ctx, r, g, b, a);
		...
		MACH_OVERRIDE(void,tex_parameterIiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params ), err ) {
			file_log("tex_parameterIiv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,tex_parameterIuiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLuint *params ), err ) {
			file_log("tex_parameterIuiv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLuint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_parameterIiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			file_log("get_tex_parameterIiv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,get_tex_parameterIuiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLuint *params), err ) {
			file_log("get_tex_parameterIuiv_EXT called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLuint* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,vertex_attribI1i_EXT,(GLIContext ctx, GLuint index, GLint x), err ) {
			file_log("vertex_attribI1i_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLint : %i)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attribI2i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y), err ) {
			file_log("vertex_attribI2i_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLint : %i)y (GLint : %i)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attribI3i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y, GLint z), err ) {
			file_log("vertex_attribI3i_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLint : %i)y (GLint : %i)z (GLint : %i)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attribI4i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y, GLint z, GLint w), err ) {
			file_log("vertex_attribI4i_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLint : %i)y (GLint : %i)z (GLint : %i)w (GLint : %i)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attribI1ui_EXT,(GLIContext ctx, GLuint index, GLuint x), err ) {
			file_log("vertex_attribI1ui_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLuint : %u)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attribI2ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y), err ) {
			file_log("vertex_attribI2ui_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLuint : %u)y (GLuint : %u)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attribI3ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y, GLuint z), err ) {
			file_log("vertex_attribI3ui_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLuint : %u)y (GLuint : %u)z (GLuint : %u)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attribI4ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w), err ) {
			file_log("vertex_attribI4ui_EXT called: ctx (GLIContext : %p)index (GLuint : %u)x (GLuint : %u)y (GLuint : %u)z (GLuint : %u)w (GLuint : %u)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attribI1iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attribI1iv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI2iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attribI2iv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI3iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attribI3iv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			file_log("vertex_attribI4iv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI1uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attribI1uiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI2uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attribI2uiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI3uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attribI3uiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			file_log("vertex_attribI4uiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLuint* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4bv_EXT,(GLIContext ctx, GLuint index, const GLbyte *v), err ) {
			file_log("vertex_attribI4bv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLbyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4sv_EXT,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			file_log("vertex_attribI4sv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLshort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4ubv_EXT,(GLIContext ctx, GLuint index, const GLubyte *v), err ) {
			file_log("vertex_attribI4ubv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLubyte* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI4usv_EXT,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			file_log("vertex_attribI4usv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLushort* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribI_pointer_EXT,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("vertex_attribI_pointer_EXT called: ctx (GLIContext : %p)index (GLuint : %u)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, index, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,get_vertex_attribIiv_EXT,(GLIContext ctx, GLuint index, GLenum pname, GLint *params), err ) {
			file_log("get_vertex_attribIiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(void,get_vertex_attribIuiv_EXT,(GLIContext ctx, GLuint index, GLenum pname, GLuint *params), err ) {
			file_log("get_vertex_attribIuiv_EXT called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLuint* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(void,uniform1ui_EXT,(GLIContext ctx, GLint location, GLuint v0), err ) {
			file_log("uniform1ui_EXT called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLuint : %u)", ctx, location, v0);
		...
		MACH_OVERRIDE(void,uniform2ui_EXT,(GLIContext ctx, GLint location, GLuint v0, GLuint v1), err ) {
			file_log("uniform2ui_EXT called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLuint : %u)v1 (GLuint : %u)", ctx, location, v0, v1);
		...
		MACH_OVERRIDE(void,uniform3ui_EXT,(GLIContext ctx, GLint location, GLuint v0, GLuint v1, GLuint v2), err ) {
			file_log("uniform3ui_EXT called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLuint : %u)v1 (GLuint : %u)v2 (GLuint : %u)", ctx, location, v0, v1, v2);
		...
		MACH_OVERRIDE(void,uniform4ui_EXT,(GLIContext ctx, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3), err ) {
			file_log("uniform4ui_EXT called: ctx (GLIContext : %p)location (GLint : %i)v0 (GLuint : %u)v1 (GLuint : %u)v2 (GLuint : %u)v3 (GLuint : %u)", ctx, location, v0, v1, v2, v3);
		...
		MACH_OVERRIDE(void,uniform1uiv_EXT,(GLIContext ctx, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("uniform1uiv_EXT called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform2uiv_EXT,(GLIContext ctx, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("uniform2uiv_EXT called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform3uiv_EXT,(GLIContext ctx, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("uniform3uiv_EXT called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform4uiv_EXT,(GLIContext ctx, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("uniform4uiv_EXT called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,get_uniformuiv_EXT,(GLIContext ctx, GLuint program, GLint location, GLuint *params), err ) {
			file_log("get_uniformuiv_EXT called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)params (GLuint* : %p)", ctx, program, location, params);
		...
		MACH_OVERRIDE(void,bind_frag_data_location_EXT,(GLIContext ctx, GLuint program, GLuint colorNumber, const GLchar *name), err ) {
			file_log("bind_frag_data_location_EXT called: ctx (GLIContext : %p)program (GLuint : %u)colorNumber (GLuint : %u)name (const GLchar* : %p)", ctx, program, colorNumber, name);
		...
		MACH_OVERRIDE(GLint,get_frag_data_location_EXT,(GLIContext ctx, GLuint program, const GLchar *name), err ) {
			file_log("get_frag_data_location_EXT called: ctx (GLIContext : %p)program (GLuint : %u)name (const GLchar* : %p)", ctx, program, name);
		...
		MACH_OVERRIDE(void,color_mask_indexed_EXT,(GLIContext ctx, GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a), err ) {
			file_log("color_mask_indexed_EXT called: ctx (GLIContext : %p)index (GLuint : %u)r (GLboolean : %i)g (GLboolean : %i)b (GLboolean : %i)a (GLboolean : %i)", ctx, index, r, g, b, a);
		...
		MACH_OVERRIDE(void,enable_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			file_log("enable_indexed_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)", ctx, target, index);
		...
		MACH_OVERRIDE(void,disable_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			file_log("disable_indexed_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)", ctx, target, index);
		...
		MACH_OVERRIDE(GLboolean,is_enabled_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			file_log("is_enabled_indexed_EXT called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)", ctx, target, index);
		...
		MACH_OVERRIDE(void,uniform_matrix2x3fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix2x3fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3x2fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix3x2fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2x4fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix2x4fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4x2fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix4x2fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3x4fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix3x4fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4x3fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("uniform_matrix4x3fv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,blit_framebuffer_EXT,(GLIContext ctx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter), err ) {
			file_log("blit_framebuffer_EXT called: ctx (GLIContext : %p)srcX0 (GLint : %i)srcY0 (GLint : %i)srcX1 (GLint : %i)srcY1 (GLint : %i)dstX0 (GLint : %i)dstY0 (GLint : %i)dstX1 (GLint : %i)dstY1 (GLint : %i)mask (GLbitfield : %u)filter (GLenum : %s)", ctx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
		...
		MACH_OVERRIDE(void,renderbuffer_storage_multisample_EXT,(GLIContext ctx, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			file_log("renderbuffer_storage_multisample_EXT called: ctx (GLIContext : %p)target (GLenum : %s)samples (GLsizei : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, samples, internalformat, width, height);
		...
		MACH_OVERRIDE(void,begin_conditional_render_NV,(GLIContext ctx, GLuint id, GLenum mode), err ) {
			file_log("begin_conditional_render_NV called: ctx (GLIContext : %p)id (GLuint : %u)mode (GLenum : %s)", ctx, id, mode);
		...
		MACH_OVERRIDE(void,end_conditional_render_NV,(GLIContext ctx), err ) {
			file_log("end_conditional_render_NV called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,get_attached_shaders,(GLIContext ctx, GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders), err ) {
			file_log("get_attached_shaders called: ctx (GLIContext : %p)program (GLuint : %u)maxCount (GLsizei : %i)count (GLsizei* : %p)shaders (GLuint* : %p)", ctx, program, maxCount, count, shaders);
		...
		MACH_OVERRIDE(void,provoking_vertex_EXT,(GLIContext ctx, GLenum mode), err ) {
			file_log("provoking_vertex_EXT called: ctx (GLIContext : %p)mode (GLenum : %s)", ctx, mode);
		...
		MACH_OVERRIDE(void,vertex_attrib_divisor,(GLIContext ctx, GLuint index, GLuint divisor), err ) {
			file_log("vertex_attrib_divisor called: ctx (GLIContext : %p)index (GLuint : %u)divisor (GLuint : %u)", ctx, index, divisor);
		...
		MACH_OVERRIDE(void,draw_arrays_instanced,(GLIContext ctx, GLenum mode, GLint first, GLsizei count, GLsizei instancecount), err ) {
			file_log("draw_arrays_instanced called: ctx (GLIContext : %p)mode (GLenum : %s)first (GLint : %i)count (GLsizei : %i)instancecount (GLsizei : %i)", ctx, mode, first, count, instancecount);
		...
		MACH_OVERRIDE(void,draw_elements_instanced,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount), err ) {
			file_log("draw_elements_instanced called: ctx (GLIContext : %p)mode (GLenum : %s)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)instancecount (GLsizei : %i)", ctx, mode, count, type, indices, instancecount);
		...
		MACH_OVERRIDE(void,draw_elements_base_vertex,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint base_vertex), err ) {
			file_log("draw_elements_base_vertex called: ctx (GLIContext : %p)mode (GLenum : %s)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)base_vertex (GLint : %i)", ctx, mode, count, type, indices, base_vertex);
		...
		MACH_OVERRIDE(void,draw_range_elements_base_vertex,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint base_vertex), err ) {
			file_log("draw_range_elements_base_vertex called: ctx (GLIContext : %p)mode (GLenum : %s)start (GLuint : %u)end (GLuint : %u)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)base_vertex (GLint : %i)", ctx, mode, start, end, count, type, indices, base_vertex);
		...
		MACH_OVERRIDE(void,draw_elements_instanced_base_vertex,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount, GLint base_vertex), err ) {
			file_log("draw_elements_instanced_base_vertex called: ctx (GLIContext : %p)mode (GLenum : %s)count (GLsizei : %i)type (GLenum : %s)indices (const GLvoid* : %p)instancecount (GLsizei : %i)base_vertex (GLint : %i)", ctx, mode, count, type, indices, instancecount, base_vertex);
		...
		MACH_OVERRIDE(void,multi_draw_elements_base_vertex,(GLIContext ctx, GLenum mode, const GLsizei *count, GLenum type, const GLvoid* const *indices, GLsizei drawcount, const GLint *base_vertex), err ) {
			file_log("multi_draw_elements_base_vertex called: ctx (GLIContext : %p)mode (GLenum : %s)count (const GLsizei* : %p)type (GLenum : %s)indices (const GLvoid*const* : %p)drawcount (GLsizei : %i)base_vertex (const GLint* : %p)", ctx, mode, count, type, indices, drawcount, base_vertex);
		...
		MACH_OVERRIDE(void,bind_vertex_array_ARB,(GLIContext ctx, GLuint array), err ) {
			file_log("bind_vertex_array_ARB called: ctx (GLIContext : %p)array (GLuint : %u)", ctx, array);
		...
		MACH_OVERRIDE(void,delete_vertex_arrays_ARB,(GLIContext ctx, GLsizei n, const GLuint *arrays), err ) {
			file_log("delete_vertex_arrays_ARB called: ctx (GLIContext : %p)n (GLsizei : %i)arrays (const GLuint* : %p)", ctx, n, arrays);
		...
		MACH_OVERRIDE(void,gen_vertex_arrays_ARB,(GLIContext ctx, GLsizei n, GLuint *arrays), err ) {
			file_log("gen_vertex_arrays_ARB called: ctx (GLIContext : %p)n (GLsizei : %i)arrays (GLuint* : %p)", ctx, n, arrays);
		...
		MACH_OVERRIDE(GLboolean,is_vertex_array_ARB,(GLIContext ctx, GLuint array), err ) {
			file_log("is_vertex_array_ARB called: ctx (GLIContext : %p)array (GLuint : %u)", ctx, array);
		...
		MACH_OVERRIDE(void,point_size_pointer,(GLIContext ctx, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			file_log("point_size_pointer called: ctx (GLIContext : %p)type (GLenum : %s)stride (GLsizei : %i)pointer (const GLvoid* : %p)", ctx, type, stride, pointer);
		...
		MACH_OVERRIDE(void,vertex_point_sizef_APPLE,(GLIContext ctx, GLfloat size), err ) {
			file_log("vertex_point_sizef_APPLE called: ctx (GLIContext : %p)size (GLfloat : %f)", ctx, size);
		...
		MACH_OVERRIDE(void,clear_bufferiv,(GLIContext ctx, GLenum buffer, GLint drawbuffer, const GLint *value), err ) {
			file_log("clear_bufferiv called: ctx (GLIContext : %p)buffer (GLenum : %s)drawbuffer (GLint : %i)value (const GLint* : %p)", ctx, buffer, drawbuffer, value);
		...
		MACH_OVERRIDE(void,clear_bufferuiv,(GLIContext ctx, GLenum buffer, GLint drawbuffer, const GLuint *value), err ) {
			file_log("clear_bufferuiv called: ctx (GLIContext : %p)buffer (GLenum : %s)drawbuffer (GLint : %i)value (const GLuint* : %p)", ctx, buffer, drawbuffer, value);
		...
		MACH_OVERRIDE(void,clear_bufferfv,(GLIContext ctx, GLenum buffer, GLint drawbuffer, const GLfloat *value), err ) {
			file_log("clear_bufferfv called: ctx (GLIContext : %p)buffer (GLenum : %s)drawbuffer (GLint : %i)value (const GLfloat* : %p)", ctx, buffer, drawbuffer, value);
		...
		MACH_OVERRIDE(void,clear_bufferfi,(GLIContext ctx, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil), err ) {
			file_log("clear_bufferfi called: ctx (GLIContext : %p)buffer (GLenum : %s)drawbuffer (GLint : %i)depth (GLfloat : %f)stencil (GLint : %i)", ctx, buffer, drawbuffer, depth, stencil);
		...
		MACH_OVERRIDE(GLsync,fence_sync,(GLIContext ctx, GLenum condition, GLbitfield flags), err ) {
			file_log("fence_sync called: ctx (GLIContext : %p)condition (GLenum : %s)flags (GLbitfield : %u)", ctx, condition, flags);
		...
		MACH_OVERRIDE(GLboolean,is_sync,(GLIContext ctx, GLsync sync), err ) {
			file_log("is_sync called: ctx (GLIContext : %p)sync (GLsync : %p)", ctx, sync);
		...
		MACH_OVERRIDE(void,delete_sync,(GLIContext ctx, GLsync sync), err ) {
			file_log("delete_sync called: ctx (GLIContext : %p)sync (GLsync : %p)", ctx, sync);
		...
		MACH_OVERRIDE(GLenum,client_wait_sync,(GLIContext ctx, GLsync sync, GLbitfield flags, GLuint64 timeout), err ) {
			file_log("client_wait_sync called: ctx (GLIContext : %p)sync (GLsync : %p)flags (GLbitfield : %u)timeout (GLuint64 : %u)", ctx, sync, flags, timeout);
		...
		MACH_OVERRIDE(void,wait_sync,(GLIContext ctx, GLsync sync, GLbitfield flags, GLuint64 timeout), err ) {
			file_log("wait_sync called: ctx (GLIContext : %p)sync (GLsync : %p)flags (GLbitfield : %u)timeout (GLuint64 : %u)", ctx, sync, flags, timeout);
		...
		MACH_OVERRIDE(void,get_integer64v_sync,(GLIContext ctx, GLenum pname, GLint64 *params), err ) {
			file_log("get_integer64v_sync called: ctx (GLIContext : %p)pname (GLenum : %s)params (GLint64* : %p)", ctx, pname, params);
		...
		MACH_OVERRIDE(void,get_synciv,(GLIContext ctx, GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values), err ) {
			file_log("get_synciv called: ctx (GLIContext : %p)sync (GLsync : %p)pname (GLenum : %s)bufSize (GLsizei : %i)length (GLsizei* : %p)values (GLint* : %p)", ctx, sync, pname, bufSize, length, values);
		...
		MACH_OVERRIDE(void,tex_image2D_multisample,(GLIContext ctx, GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations), err ) {
			file_log("tex_image2D_multisample called: ctx (GLIContext : %p)target (GLenum : %s)samples (GLsizei : %i)internalformat (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)fixedsamplelocations (GLboolean : %i)", ctx, target, samples, internalformat, width, height, fixedsamplelocations);
		...
		MACH_OVERRIDE(void,tex_image3D_multisample,(GLIContext ctx, GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations), err ) {
			file_log("tex_image3D_multisample called: ctx (GLIContext : %p)target (GLenum : %s)samples (GLsizei : %i)internalformat (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)fixedsamplelocations (GLboolean : %i)", ctx, target, samples, internalformat, width, height, depth, fixedsamplelocations);
		...
		MACH_OVERRIDE(void,get_multisamplefv,(GLIContext ctx, GLenum pname, GLuint index, GLfloat *val), err ) {
			file_log("get_multisamplefv called: ctx (GLIContext : %p)pname (GLenum : %s)index (GLuint : %u)val (GLfloat* : %p)", ctx, pname, index, val);
		...
		MACH_OVERRIDE(void,sample_maski,(GLIContext ctx, GLuint index, GLbitfield mask), err ) {
			file_log("sample_maski called: ctx (GLIContext : %p)index (GLuint : %u)mask (GLbitfield : %u)", ctx, index, mask);
		...
		MACH_OVERRIDE(void,tex_buffer,(GLIContext ctx, GLenum target, GLenum internalformat, GLuint buffer), err ) {
			file_log("tex_buffer called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)buffer (GLuint : %u)", ctx, target, internalformat, buffer);
		...
		MACH_OVERRIDE(void,copy_buffer_sub_data,(GLIContext ctx, GLenum readtarget, GLenum writetarget, GLintptr readoffset, GLintptr writeoffset, GLsizeiptr size), err ) {
			file_log("copy_buffer_sub_data called: ctx (GLIContext : %p)readtarget (GLenum : %s)writetarget (GLenum : %s)readoffset (GLintptr : %p)writeoffset (GLintptr : %p)size (GLsizeiptr : %p)", ctx, readtarget, writetarget, readoffset, writeoffset, size);
		...
		MACH_OVERRIDE(void,primitive_restart_index,(GLIContext ctx, GLuint index), err ) {
			file_log("primitive_restart_index called: ctx (GLIContext : %p)index (GLuint : %u)", ctx, index);
		...
		MACH_OVERRIDE(void,get_query_objecti64v,(GLIContext ctx, GLuint id, GLenum pname, GLint64EXT *params), err ) {
			file_log("get_query_objecti64v called: ctx (GLIContext : %p)id (GLuint : %u)pname (GLenum : %s)params (GLint64EXT* : %p)", ctx, id, pname, params);
		...
		MACH_OVERRIDE(void,get_query_objectui64v,(GLIContext ctx, GLuint id, GLenum pname, GLuint64EXT *params), err ) {
			file_log("get_query_objectui64v called: ctx (GLIContext : %p)id (GLuint : %u)pname (GLenum : %s)params (GLuint64EXT* : %p)", ctx, id, pname, params);
		...
		MACH_OVERRIDE(GLvoid,map_buffer_range,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr length, GLenum access), err ) {
			file_log("map_buffer_range called: ctx (GLIContext : %p)target (GLenum : %s)offset (GLintptr : %p)length (GLsizeiptr : %p)access (GLenum : %s)", ctx, target, offset, length, access);
		...
		MACH_OVERRIDE(void,flush_mapped_buffer_range,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr length), err ) {
			file_log("flush_mapped_buffer_range called: ctx (GLIContext : %p)target (GLenum : %s)offset (GLintptr : %p)length (GLsizeiptr : %p)", ctx, target, offset, length);
		...
		MACH_OVERRIDE(void,query_counter,(GLIContext ctx, GLuint id, GLenum target), err ) {
			file_log("query_counter called: ctx (GLIContext : %p)id (GLuint : %u)target (GLenum : %s)", ctx, id, target);
		...
		MACH_OVERRIDE(void,get_integer64i_v,(GLIContext ctx, GLenum target, GLuint index, GLint64 *data), err ) {
			file_log("get_integer64i_v called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)data (GLint64* : %p)", ctx, target, index, data);
		...
		MACH_OVERRIDE(void,get_buffer_parameteri64v,(GLIContext ctx, GLenum target, GLenum pname, GLint64 *params), err ) {
			file_log("get_buffer_parameteri64v called: ctx (GLIContext : %p)target (GLenum : %s)pname (GLenum : %s)params (GLint64* : %p)", ctx, target, pname, params);
		...
		MACH_OVERRIDE(void,gen_samplers,(GLIContext ctx, GLsizei count, GLuint *samplers), err ) {
			file_log("gen_samplers called: ctx (GLIContext : %p)count (GLsizei : %i)samplers (GLuint* : %p)", ctx, count, samplers);
		...
		MACH_OVERRIDE(void,delete_samplers,(GLIContext ctx, GLsizei count, const GLuint *samplers), err ) {
			file_log("delete_samplers called: ctx (GLIContext : %p)count (GLsizei : %i)samplers (const GLuint* : %p)", ctx, count, samplers);
		...
		MACH_OVERRIDE(GLboolean,is_sampler,(GLIContext ctx, GLuint sampler), err ) {
			file_log("is_sampler called: ctx (GLIContext : %p)sampler (GLuint : %u)", ctx, sampler);
		...
		MACH_OVERRIDE(void,bind_sampler,(GLIContext ctx, GLuint unit, GLuint sampler), err ) {
			file_log("bind_sampler called: ctx (GLIContext : %p)unit (GLuint : %u)sampler (GLuint : %u)", ctx, unit, sampler);
		...
		MACH_OVERRIDE(void,sampler_parameteri,(GLIContext ctx, GLuint sampler, GLenum pname, GLint param), err ) {
			file_log("sampler_parameteri called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (GLint : %i)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,sampler_parameteriv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLint *param), err ) {
			file_log("sampler_parameteriv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (const GLint* : %p)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,sampler_parameterf,(GLIContext ctx, GLuint sampler, GLenum pname, GLfloat param), err ) {
			file_log("sampler_parameterf called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (GLfloat : %f)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,sampler_parameterfv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLfloat *param), err ) {
			file_log("sampler_parameterfv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (const GLfloat* : %p)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,sampler_parameterIiv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLint *param), err ) {
			file_log("sampler_parameterIiv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (const GLint* : %p)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,sampler_parameterIuiv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLuint *param), err ) {
			file_log("sampler_parameterIuiv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)param (const GLuint* : %p)", ctx, sampler, pname, param);
		...
		MACH_OVERRIDE(void,get_sampler_parameteriv,(GLIContext ctx, GLuint sampler, GLenum pname, GLint *params), err ) {
			file_log("get_sampler_parameteriv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, sampler, pname, params);
		...
		MACH_OVERRIDE(void,get_sampler_parameterfv,(GLIContext ctx, GLuint sampler, GLenum pname, GLfloat *params), err ) {
			file_log("get_sampler_parameterfv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)params (GLfloat* : %p)", ctx, sampler, pname, params);
		...
		MACH_OVERRIDE(void,get_sampler_parameterIiv,(GLIContext ctx, GLuint sampler, GLenum pname, GLint *params), err ) {
			file_log("get_sampler_parameterIiv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, sampler, pname, params);
		...
		MACH_OVERRIDE(void,get_sampler_parameterIuiv,(GLIContext ctx, GLuint sampler, GLenum pname, GLuint *params), err ) {
			file_log("get_sampler_parameterIuiv called: ctx (GLIContext : %p)sampler (GLuint : %u)pname (GLenum : %s)params (GLuint* : %p)", ctx, sampler, pname, params);
		...
		MACH_OVERRIDE(void,label_object_EXT,(GLIContext ctx, GLenum type, GLuint object, GLsizei length, const GLchar *label), err ) {
			file_log("label_object_EXT called: ctx (GLIContext : %p)type (GLenum : %s)object (GLuint : %u)length (GLsizei : %i)label (const GLchar* : %p)", ctx, type, object, length, label);
		...
		MACH_OVERRIDE(void,get_object_label_EXT,(GLIContext ctx, GLenum type, GLuint object, GLsizei bufSize, GLsizei *length, GLchar *label), err ) {
			file_log("get_object_label_EXT called: ctx (GLIContext : %p)type (GLenum : %s)object (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)label (GLchar* : %p)", ctx, type, object, bufSize, length, label);
		...
		MACH_OVERRIDE(void,insert_event_marker_EXT,(GLIContext ctx, GLsizei length, const GLchar *marker), err ) {
			file_log("insert_event_marker_EXT called: ctx (GLIContext : %p)length (GLsizei : %i)marker (const GLchar* : %p)", ctx, length, marker);
		...
		MACH_OVERRIDE(void,push_group_marker_EXT,(GLIContext ctx, GLsizei length, const GLchar *marker), err ) {
			file_log("push_group_marker_EXT called: ctx (GLIContext : %p)length (GLsizei : %i)marker (const GLchar* : %p)", ctx, length, marker);
		...
		MACH_OVERRIDE(void,pop_group_marker_EXT,(GLIContext ctx), err ) {
			file_log("pop_group_marker_EXT called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,use_program_stages,(GLIContext ctx, GLuint pipeline, GLbitfield stages, GLuint program), err ) {
			file_log("use_program_stages called: ctx (GLIContext : %p)pipeline (GLuint : %u)stages (GLbitfield : %u)program (GLuint : %u)", ctx, pipeline, stages, program);
		...
		MACH_OVERRIDE(void,active_shader_program,(GLIContext ctx, GLuint pipeline, GLuint program), err ) {
			file_log("active_shader_program called: ctx (GLIContext : %p)pipeline (GLuint : %u)program (GLuint : %u)", ctx, pipeline, program);
		...
		MACH_OVERRIDE(GLuint,create_shader_programv,(GLIContext ctx, GLenum type, GLsizei count, const GLchar* const *strings), err ) {
			file_log("create_shader_programv called: ctx (GLIContext : %p)type (GLenum : %s)count (GLsizei : %i)strings (const GLchar*const* : %p)", ctx, type, count, strings);
		...
		MACH_OVERRIDE(void,bind_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			file_log("bind_program_pipeline called: ctx (GLIContext : %p)pipeline (GLuint : %u)", ctx, pipeline);
		...
		MACH_OVERRIDE(void,delete_program_pipelines,(GLIContext ctx, GLsizei n, const GLuint *pipelines), err ) {
			file_log("delete_program_pipelines called: ctx (GLIContext : %p)n (GLsizei : %i)pipelines (const GLuint* : %p)", ctx, n, pipelines);
		...
		MACH_OVERRIDE(void,gen_program_pipelines,(GLIContext ctx, GLsizei n, GLuint *pipelines), err ) {
			file_log("gen_program_pipelines called: ctx (GLIContext : %p)n (GLsizei : %i)pipelines (GLuint* : %p)", ctx, n, pipelines);
		...
		MACH_OVERRIDE(GLboolean,is_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			file_log("is_program_pipeline called: ctx (GLIContext : %p)pipeline (GLuint : %u)", ctx, pipeline);
		...
		MACH_OVERRIDE(void,get_program_pipelineiv,(GLIContext ctx, GLuint pipeline, GLenum pname, GLint *params), err ) {
			file_log("get_program_pipelineiv called: ctx (GLIContext : %p)pipeline (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, pipeline, pname, params);
		...
		MACH_OVERRIDE(void,validate_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			file_log("validate_program_pipeline called: ctx (GLIContext : %p)pipeline (GLuint : %u)", ctx, pipeline);
		...
		MACH_OVERRIDE(void,get_program_pipeline_info_log,(GLIContext ctx, GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog), err ) {
			file_log("get_program_pipeline_info_log called: ctx (GLIContext : %p)pipeline (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)infoLog (GLchar* : %p)", ctx, pipeline, bufSize, length, infoLog);
		...
		MACH_OVERRIDE(void,program_uniform1i,(GLIContext ctx, GLuint program, GLint location, GLint x), err ) {
			file_log("program_uniform1i called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLint : %i)", ctx, program, location, x);
		...
		MACH_OVERRIDE(void,program_uniform2i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y), err ) {
			file_log("program_uniform2i called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLint : %i)y (GLint : %i)", ctx, program, location, x, y);
		...
		MACH_OVERRIDE(void,program_uniform3i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y, GLint z), err ) {
			file_log("program_uniform3i called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLint : %i)y (GLint : %i)z (GLint : %i)", ctx, program, location, x, y, z);
		...
		MACH_OVERRIDE(void,program_uniform4i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y, GLint z, GLint w), err ) {
			file_log("program_uniform4i called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLint : %i)y (GLint : %i)z (GLint : %i)w (GLint : %i)", ctx, program, location, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_uniform1f,(GLIContext ctx, GLuint program, GLint location, GLfloat x), err ) {
			file_log("program_uniform1f called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLfloat : %f)", ctx, program, location, x);
		...
		MACH_OVERRIDE(void,program_uniform2f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y), err ) {
			file_log("program_uniform2f called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLfloat : %f)y (GLfloat : %f)", ctx, program, location, x, y);
		...
		MACH_OVERRIDE(void,program_uniform3f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z), err ) {
			file_log("program_uniform3f called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)", ctx, program, location, x, y, z);
		...
		MACH_OVERRIDE(void,program_uniform4f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			file_log("program_uniform4f called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLfloat : %f)y (GLfloat : %f)z (GLfloat : %f)w (GLfloat : %f)", ctx, program, location, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_uniform1iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("program_uniform1iv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform2iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("program_uniform2iv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform3iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("program_uniform3iv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform4iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			file_log("program_uniform4iv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform1fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("program_uniform1fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("program_uniform2fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("program_uniform3fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			file_log("program_uniform4fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLfloat* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix2fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix3fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix4fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform1ui,(GLIContext ctx, GLuint program, GLint location, GLuint x), err ) {
			file_log("program_uniform1ui called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLuint : %u)", ctx, program, location, x);
		...
		MACH_OVERRIDE(void,program_uniform2ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y), err ) {
			file_log("program_uniform2ui called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLuint : %u)y (GLuint : %u)", ctx, program, location, x, y);
		...
		MACH_OVERRIDE(void,program_uniform3ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y, GLuint z), err ) {
			file_log("program_uniform3ui called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLuint : %u)y (GLuint : %u)z (GLuint : %u)", ctx, program, location, x, y, z);
		...
		MACH_OVERRIDE(void,program_uniform4ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y, GLuint z, GLuint w), err ) {
			file_log("program_uniform4ui called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLuint : %u)y (GLuint : %u)z (GLuint : %u)w (GLuint : %u)", ctx, program, location, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_uniform1uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("program_uniform1uiv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform2uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("program_uniform2uiv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform3uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("program_uniform3uiv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform4uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			file_log("program_uniform4uiv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLuint* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix2x3fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix3x2fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix2x4fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix4x2fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix3x4fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			file_log("program_uniform_matrix4x3fv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLfloat* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,bind_frag_data_location_indexed,(GLIContext ctx, GLuint program, GLuint colorNumber, GLuint index, const GLchar *name), err ) {
			file_log("bind_frag_data_location_indexed called: ctx (GLIContext : %p)program (GLuint : %u)colorNumber (GLuint : %u)index (GLuint : %u)name (const GLchar* : %p)", ctx, program, colorNumber, index, name);
		...
		MACH_OVERRIDE(GLint,get_frag_data_index,(GLIContext ctx, GLuint program, const GLchar *name), err ) {
			file_log("get_frag_data_index called: ctx (GLIContext : %p)program (GLuint : %u)name (const GLchar* : %p)", ctx, program, name);
		...
		MACH_OVERRIDE(void,blend_func_i,(GLIContext ctx, GLuint buf, GLenum src, GLenum dst), err ) {
			file_log("blend_func_i called: ctx (GLIContext : %p)buf (GLuint : %u)src (GLenum : %s)dst (GLenum : %s)", ctx, buf, src, dst);
		...
		MACH_OVERRIDE(void,blend_func_separate_i,(GLIContext ctx, GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha), err ) {
			file_log("blend_func_separate_i called: ctx (GLIContext : %p)buf (GLuint : %u)srcRGB (GLenum : %s)dstRGB (GLenum : %s)srcAlpha (GLenum : %s)dstAlpha (GLenum : %s)", ctx, buf, srcRGB, dstRGB, srcAlpha, dstAlpha);
		...
		MACH_OVERRIDE(void,blend_equation_i,(GLIContext ctx, GLuint buf, GLenum mode), err ) {
			file_log("blend_equation_i called: ctx (GLIContext : %p)buf (GLuint : %u)mode (GLenum : %s)", ctx, buf, mode);
		...
		MACH_OVERRIDE(void,blend_equation_separate_i,(GLIContext ctx, GLuint buf, GLenum modeRGB, GLenum modeAlpha), err ) {
			file_log("blend_equation_separate_i called: ctx (GLIContext : %p)buf (GLuint : %u)modeRGB (GLenum : %s)modeAlpha (GLenum : %s)", ctx, buf, modeRGB, modeAlpha);
		...
		MACH_OVERRIDE(void,named_string_ARB,(GLIContext ctx, GLenum type, GLint namelen, const GLchar *name, GLint stringlen, const GLchar *string), err ) {
			file_log("named_string_ARB called: ctx (GLIContext : %p)type (GLenum : %s)namelen (GLint : %i)name (const GLchar* : %p)stringlen (GLint : %i)string (const GLchar* : %p)", ctx, type, namelen, name, stringlen, string);
		...
		MACH_OVERRIDE(void,delete_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name), err ) {
			file_log("delete_named_string_ARB called: ctx (GLIContext : %p)namelen (GLint : %i)name (const GLchar* : %p)", ctx, namelen, name);
		...
		MACH_OVERRIDE(void,compile_shader_include_ARB,(GLIContext ctx, GLuint shader, GLsizei count, const GLchar* const *path, const GLint *length), err ) {
			file_log("compile_shader_include_ARB called: ctx (GLIContext : %p)shader (GLuint : %u)count (GLsizei : %i)path (const GLchar*const* : %p)length (const GLint* : %p)", ctx, shader, count, path, length);
		...
		MACH_OVERRIDE(GLboolean,is_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name), err ) {
			file_log("is_named_string_ARB called: ctx (GLIContext : %p)namelen (GLint : %i)name (const GLchar* : %p)", ctx, namelen, name);
		...
		MACH_OVERRIDE(void,get_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name, GLsizei bufSize, GLint *stringlen, GLchar *string), err ) {
			file_log("get_named_string_ARB called: ctx (GLIContext : %p)namelen (GLint : %i)name (const GLchar* : %p)bufSize (GLsizei : %i)stringlen (GLint* : %p)string (GLchar* : %p)", ctx, namelen, name, bufSize, stringlen, string);
		...
		MACH_OVERRIDE(void,get_named_string_iv_ARB,(GLIContext ctx, GLint namelen, const GLchar *name, GLenum pname, GLint *params), err ) {
			file_log("get_named_string_iv_ARB called: ctx (GLIContext : %p)namelen (GLint : %i)name (const GLchar* : %p)pname (GLenum : %s)params (GLint* : %p)", ctx, namelen, name, pname, params);
		...
		MACH_OVERRIDE(void,release_shader_compiler,(GLIContext ctx), err ) {
			file_log("release_shader_compiler called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,shader_binary,(GLIContext ctx, GLint n, GLuint *shaders, GLenum binaryformat, const GLvoid *binary, GLint length), err ) {
			file_log("shader_binary called: ctx (GLIContext : %p)n (GLint : %i)shaders (GLuint* : %p)binaryformat (GLenum : %s)binary (const GLvoid* : %p)length (GLint : %i)", ctx, n, shaders, binaryformat, binary, length);
		...
		MACH_OVERRIDE(void,get_shader_precision_format,(GLIContext ctx, GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision), err ) {
			file_log("get_shader_precision_format called: ctx (GLIContext : %p)shadertype (GLenum : %s)precisiontype (GLenum : %s)range (GLint* : %p)precision (GLint* : %p)", ctx, shadertype, precisiontype, range, precision);
		...
		MACH_OVERRIDE(void,depth_rangef,(GLIContext ctx, GLclampf zNear, GLclampf zFar), err ) {
			file_log("depth_rangef called: ctx (GLIContext : %p)zNear (GLclampf : %f)zFar (GLclampf : %f)", ctx, zNear, zFar);
		...
		MACH_OVERRIDE(void,clear_depthf,(GLIContext ctx, GLclampf depth), err ) {
			file_log("clear_depthf called: ctx (GLIContext : %p)depth (GLclampf : %f)", ctx, depth);
		...
		MACH_OVERRIDE(void,vertex_attribP1ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			file_log("vertex_attribP1ui called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (GLuint : %u)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP2ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			file_log("vertex_attribP2ui called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (GLuint : %u)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP3ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			file_log("vertex_attribP3ui called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (GLuint : %u)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP4ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			file_log("vertex_attribP4ui called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (GLuint : %u)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP1uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			file_log("vertex_attribP1uiv called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (const GLuint* : %p)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP2uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			file_log("vertex_attribP2uiv called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (const GLuint* : %p)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP3uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			file_log("vertex_attribP3uiv called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (const GLuint* : %p)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,vertex_attribP4uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			file_log("vertex_attribP4uiv called: ctx (GLIContext : %p)index (GLuint : %u)type (GLenum : %s)normalized (GLboolean : %i)value (const GLuint* : %p)", ctx, index, type, normalized, value);
		...
		MACH_OVERRIDE(void,get_program_binary,(GLIContext ctx, GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary), err ) {
			file_log("get_program_binary called: ctx (GLIContext : %p)program (GLuint : %u)bufSize (GLsizei : %i)length (GLsizei* : %p)binaryFormat (GLenum* : %p)binary (GLvoid* : %p)", ctx, program, bufSize, length, binaryFormat, binary);
		...
		MACH_OVERRIDE(void,program_binary,(GLIContext ctx, GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length), err ) {
			file_log("program_binary called: ctx (GLIContext : %p)program (GLuint : %u)binaryFormat (GLenum : %s)binary (const GLvoid* : %p)length (GLsizei : %i)", ctx, program, binaryFormat, binary, length);
		...
		MACH_OVERRIDE(void,min_sample_shading,(GLIContext ctx, GLclampf value), err ) {
			file_log("min_sample_shading called: ctx (GLIContext : %p)value (GLclampf : %f)", ctx, value);
		...
		MACH_OVERRIDE(void,viewport_arrayv,(GLIContext ctx, GLuint first, GLsizei count, const GLfloat * v), err ) {
			file_log("viewport_arrayv called: ctx (GLIContext : %p)first (GLuint : %u)count (GLsizei : %i)v (const GLfloat * : %p)", ctx, first, count, v);
		...
		MACH_OVERRIDE(void,viewport_indexedf,(GLIContext ctx, GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h), err ) {
			file_log("viewport_indexedf called: ctx (GLIContext : %p)index (GLuint : %u)x (GLfloat : %f)y (GLfloat : %f)w (GLfloat : %f)h (GLfloat : %f)", ctx, index, x, y, w, h);
		...
		MACH_OVERRIDE(void,viewport_indexedfv,(GLIContext ctx, GLuint index, const GLfloat * v), err ) {
			file_log("viewport_indexedfv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLfloat * : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,scissor_arrayv,(GLIContext ctx, GLuint first, GLsizei count, const GLint * v), err ) {
			file_log("scissor_arrayv called: ctx (GLIContext : %p)first (GLuint : %u)count (GLsizei : %i)v (const GLint * : %p)", ctx, first, count, v);
		...
		MACH_OVERRIDE(void,scissor_indexed,(GLIContext ctx, GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height), err ) {
			file_log("scissor_indexed called: ctx (GLIContext : %p)index (GLuint : %u)left (GLint : %i)bottom (GLint : %i)width (GLsizei : %i)height (GLsizei : %i)", ctx, index, left, bottom, width, height);
		...
		MACH_OVERRIDE(void,scissor_indexedv,(GLIContext ctx, GLuint index, const GLint * v), err ) {
			file_log("scissor_indexedv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLint * : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,depth_range_arrayv,(GLIContext ctx, GLuint first, GLsizei count, const GLclampd * v), err ) {
			file_log("depth_range_arrayv called: ctx (GLIContext : %p)first (GLuint : %u)count (GLsizei : %i)v (const GLclampd * : %p)", ctx, first, count, v);
		...
		MACH_OVERRIDE(void,depth_range_indexed,(GLIContext ctx, GLuint index, GLclampd n, GLclampd f), err ) {
			file_log("depth_range_indexed called: ctx (GLIContext : %p)index (GLuint : %u)n (GLclampd : %f)f (GLclampd : %f)", ctx, index, n, f);
		...
		MACH_OVERRIDE(void,get_floati_v,(GLIContext ctx, GLenum target, GLuint index, GLfloat *data), err ) {
			file_log("get_floati_v called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)data (GLfloat* : %p)", ctx, target, index, data);
		...
		MACH_OVERRIDE(void,get_doublei_v,(GLIContext ctx, GLenum target, GLuint index, GLdouble *data), err ) {
			file_log("get_doublei_v called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)data (GLdouble* : %p)", ctx, target, index, data);
		...
		MACH_OVERRIDE(void,draw_arrays_indirect,(GLIContext ctx, GLenum mode, const GLvoid *indirect), err ) {
			file_log("draw_arrays_indirect called: ctx (GLIContext : %p)mode (GLenum : %s)indirect (const GLvoid* : %p)", ctx, mode, indirect);
		...
		MACH_OVERRIDE(void,draw_elements_indirect,(GLIContext ctx, GLenum mode, GLenum type, const GLvoid *indirect), err ) {
			file_log("draw_elements_indirect called: ctx (GLIContext : %p)mode (GLenum : %s)type (GLenum : %s)indirect (const GLvoid* : %p)", ctx, mode, type, indirect);
		...
		MACH_OVERRIDE(void,patch_parameteri,(GLIContext ctx, GLenum pname, GLint value), err ) {
			file_log("patch_parameteri called: ctx (GLIContext : %p)pname (GLenum : %s)value (GLint : %i)", ctx, pname, value);
		...
		MACH_OVERRIDE(void,patch_parameterfv,(GLIContext ctx, GLenum pname, const GLfloat* values), err ) {
			file_log("patch_parameterfv called: ctx (GLIContext : %p)pname (GLenum : %s)values (const GLfloat* : %p)", ctx, pname, values);
		...
		MACH_OVERRIDE(void,bind_transform_feedback,(GLIContext ctx, GLenum target, GLuint name), err ) {
			file_log("bind_transform_feedback called: ctx (GLIContext : %p)target (GLenum : %s)name (GLuint : %u)", ctx, target, name);
		...
		MACH_OVERRIDE(void,gen_transform_feedbacks,(GLIContext ctx, GLsizei n, GLuint* ids), err ) {
			file_log("gen_transform_feedbacks called: ctx (GLIContext : %p)n (GLsizei : %i)ids (GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(void,delete_transform_feedbacks,(GLIContext ctx, GLsizei n, const GLuint* ids), err ) {
			file_log("delete_transform_feedbacks called: ctx (GLIContext : %p)n (GLsizei : %i)ids (const GLuint* : %p)", ctx, n, ids);
		...
		MACH_OVERRIDE(void,pause_transform_feedback,(GLIContext ctx), err ) {
			file_log("pause_transform_feedback called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(void,resume_transform_feedback,(GLIContext ctx), err ) {
			file_log("resume_transform_feedback called: ctx (GLIContext : %p)", ctx);
		...
		MACH_OVERRIDE(GLboolean,is_transform_feedback,(GLIContext ctx, GLuint name), err ) {
			file_log("is_transform_feedback called: ctx (GLIContext : %p)name (GLuint : %u)", ctx, name);
		...
		MACH_OVERRIDE(void,draw_transform_feedback,(GLIContext ctx, GLenum mode, GLuint name), err ) {
			file_log("draw_transform_feedback called: ctx (GLIContext : %p)mode (GLenum : %s)name (GLuint : %u)", ctx, mode, name);
		...
		MACH_OVERRIDE(void,begin_query_indexed,(GLIContext ctx, GLenum target, GLuint index, GLuint id), err ) {
			file_log("begin_query_indexed called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)id (GLuint : %u)", ctx, target, index, id);
		...
		MACH_OVERRIDE(void,end_query_indexed,(GLIContext ctx, GLenum target, GLuint index), err ) {
			file_log("end_query_indexed called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)", ctx, target, index);
		...
		MACH_OVERRIDE(void,get_query_indexediv,(GLIContext ctx, GLenum target, GLuint index, GLenum pname, GLint *params), err ) {
			file_log("get_query_indexediv called: ctx (GLIContext : %p)target (GLenum : %s)index (GLuint : %u)pname (GLenum : %s)params (GLint* : %p)", ctx, target, index, pname, params);
		...
		MACH_OVERRIDE(void,draw_transform_feedback_stream,(GLIContext ctx, GLenum mode, GLuint name, GLuint stream), err ) {
			file_log("draw_transform_feedback_stream called: ctx (GLIContext : %p)mode (GLenum : %s)name (GLuint : %u)stream (GLuint : %u)", ctx, mode, name, stream);
		...
		MACH_OVERRIDE(void,program_uniform1d,(GLIContext ctx, GLuint program, GLint location, GLdouble x), err ) {
			file_log("program_uniform1d called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLdouble : %f)", ctx, program, location, x);
		...
		MACH_OVERRIDE(void,program_uniform2d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y), err ) {
			file_log("program_uniform2d called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)", ctx, program, location, x, y);
		...
		MACH_OVERRIDE(void,program_uniform3d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("program_uniform3d called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, program, location, x, y, z);
		...
		MACH_OVERRIDE(void,program_uniform4d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("program_uniform4d called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, program, location, x, y, z, w);
		...
		MACH_OVERRIDE(void,program_uniform1dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("program_uniform1dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("program_uniform2dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("program_uniform3dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("program_uniform4dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, program, location, count, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix2dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix3dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix4dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix2x3dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix3x2dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix2x4dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix4x2dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix3x4dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("program_uniform_matrix4x3dv called: ctx (GLIContext : %p)program (GLuint : %u)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform1d,(GLIContext ctx, GLint location, GLdouble x), err ) {
			file_log("uniform1d called: ctx (GLIContext : %p)location (GLint : %i)x (GLdouble : %f)", ctx, location, x);
		...
		MACH_OVERRIDE(void,uniform2d,(GLIContext ctx, GLint location, GLdouble x, GLdouble y), err ) {
			file_log("uniform2d called: ctx (GLIContext : %p)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)", ctx, location, x, y);
		...
		MACH_OVERRIDE(void,uniform3d,(GLIContext ctx, GLint location, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("uniform3d called: ctx (GLIContext : %p)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, location, x, y, z);
		...
		MACH_OVERRIDE(void,uniform4d,(GLIContext ctx, GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("uniform4d called: ctx (GLIContext : %p)location (GLint : %i)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, location, x, y, z, w);
		...
		MACH_OVERRIDE(void,uniform1dv,(GLIContext ctx, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("uniform1dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform2dv,(GLIContext ctx, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("uniform2dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform3dv,(GLIContext ctx, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("uniform3dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform4dv,(GLIContext ctx, GLint location, GLsizei count, const GLdouble *value), err ) {
			file_log("uniform4dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)value (const GLdouble* : %p)", ctx, location, count, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix2dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix3dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix4dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2x3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix2x3dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3x2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix3x2dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2x4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix2x4dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4x2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix4x2dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix3x4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix3x4dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix4x3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			file_log("uniform_matrix4x3dv called: ctx (GLIContext : %p)location (GLint : %i)count (GLsizei : %i)transpose (GLboolean : %i)value (const GLdouble* : %p)", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,get_uniformdv,(GLIContext ctx, GLuint program_obj, GLint location, GLdouble *params), err ) {
			file_log("get_uniformdv called: ctx (GLIContext : %p)program_obj (GLuint : %u)location (GLint : %i)params (GLdouble* : %p)", ctx, program_obj, location, params);
		...
		MACH_OVERRIDE(void,vertex_attribl1d,(GLIContext ctx, GLuint index, GLdouble x), err ) {
			file_log("vertex_attribl1d called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)", ctx, index, x);
		...
		MACH_OVERRIDE(void,vertex_attribl2d,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y), err ) {
			file_log("vertex_attribl2d called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)", ctx, index, x, y);
		...
		MACH_OVERRIDE(void,vertex_attribl3d,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y, GLdouble z), err ) {
			file_log("vertex_attribl3d called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)", ctx, index, x, y, z);
		...
		MACH_OVERRIDE(void,vertex_attribl4d,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			file_log("vertex_attribl4d called: ctx (GLIContext : %p)index (GLuint : %u)x (GLdouble : %f)y (GLdouble : %f)z (GLdouble : %f)w (GLdouble : %f)", ctx, index, x, y, z, w);
		...
		MACH_OVERRIDE(void,vertex_attribl1dv,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attribl1dv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribl2dv,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attribl2dv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribl3dv,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attribl3dv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attribl4dv,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			file_log("vertex_attribl4dv called: ctx (GLIContext : %p)index (GLuint : %u)v (const GLdouble* : %p)", ctx, index, v);
		...
		MACH_OVERRIDE(void,vertex_attrib_lpointer,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride, const void *pointer), err ) {
			file_log("vertex_attrib_lpointer called: ctx (GLIContext : %p)index (GLuint : %u)size (GLint : %i)type (GLenum : %s)stride (GLsizei : %i)pointer (const void* : %p)", ctx, index, size, type, stride, pointer);
		...
		MACH_OVERRIDE(void,get_vertex_attrib_ldv,(GLIContext ctx, GLuint index, GLenum pname, GLdouble *params), err ) {
			file_log("get_vertex_attrib_ldv called: ctx (GLIContext : %p)index (GLuint : %u)pname (GLenum : %s)params (GLdouble* : %p)", ctx, index, pname, params);
		...
		MACH_OVERRIDE(GLint,get_subroutine_uniform_location,(GLIContext ctx, GLuint program, GLenum shadertype, const GLchar *name), err ) {
			file_log("get_subroutine_uniform_location called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)name (const GLchar* : %p)", ctx, program, shadertype, name);
		...
		MACH_OVERRIDE(GLuint,get_subroutine_index,(GLIContext ctx, GLuint program, GLenum shadertype, const GLchar *name), err ) {
			file_log("get_subroutine_index called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)name (const GLchar* : %p)", ctx, program, shadertype, name);
		...
		MACH_OVERRIDE(void,get_active_subroutine_uniformiv,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLenum pname, GLint *values), err ) {
			file_log("get_active_subroutine_uniformiv called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)index (GLuint : %u)pname (GLenum : %s)values (GLint* : %p)", ctx, program, shadertype, index, pname, values);
		...
		MACH_OVERRIDE(void,get_active_subroutine_uniform_name,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name), err ) {
			file_log("get_active_subroutine_uniform_name called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)index (GLuint : %u)bufsize (GLsizei : %i)length (GLsizei* : %p)name (GLchar* : %p)", ctx, program, shadertype, index, bufsize, length, name);
		...
		MACH_OVERRIDE(void,get_active_subroutine_name,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name), err ) {
			file_log("get_active_subroutine_name called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)index (GLuint : %u)bufsize (GLsizei : %i)length (GLsizei* : %p)name (GLchar* : %p)", ctx, program, shadertype, index, bufsize, length, name);
		...
		MACH_OVERRIDE(void,uniform_subroutinesuiv,(GLIContext ctx, GLenum shadertype, GLsizei count, const GLuint *indices), err ) {
			file_log("uniform_subroutinesuiv called: ctx (GLIContext : %p)shadertype (GLenum : %s)count (GLsizei : %i)indices (const GLuint* : %p)", ctx, shadertype, count, indices);
		...
		MACH_OVERRIDE(void,get_uniform_subroutineuiv,(GLIContext ctx, GLenum shadertype, GLint location, GLuint *params), err ) {
			file_log("get_uniform_subroutineuiv called: ctx (GLIContext : %p)shadertype (GLenum : %s)location (GLint : %i)params (GLuint* : %p)", ctx, shadertype, location, params);
		...
		MACH_OVERRIDE(void,get_program_stageiv,(GLIContext ctx, GLuint program, GLenum shadertype, GLenum pname, GLint *values), err ) {
			file_log("get_program_stageiv called: ctx (GLIContext : %p)program (GLuint : %u)shadertype (GLenum : %s)pname (GLenum : %s)values (GLint* : %p)", ctx, program, shadertype, pname, values);
		...
		MACH_OVERRIDE(void,get_internal_formativ,(GLIContext ctx, GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint* params), err ) {
			file_log("get_internal_formativ called: ctx (GLIContext : %p)target (GLenum : %s)internalformat (GLenum : %s)pname (GLenum : %s)bufSize (GLsizei : %i)params (GLint* : %p)", ctx, target, internalformat, pname, bufSize, params);
		...
		MACH_OVERRIDE(void,tex_storage1D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width), err ) {
			file_log("tex_storage1D called: ctx (GLIContext : %p)target (GLenum : %s)levels (GLsizei : %i)internalformat (GLenum : %s)width (GLsizei : %i)", ctx, target, levels, internalformat, width);
		...
		MACH_OVERRIDE(void,tex_storage2D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			file_log("tex_storage2D called: ctx (GLIContext : %p)target (GLenum : %s)levels (GLsizei : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)", ctx, target, levels, internalformat, width, height);
		...
		MACH_OVERRIDE(void,tex_storage3D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth), err ) {
			file_log("tex_storage3D called: ctx (GLIContext : %p)target (GLenum : %s)levels (GLsizei : %i)internalformat (GLenum : %s)width (GLsizei : %i)height (GLsizei : %i)depth (GLsizei : %i)", ctx, target, levels, internalformat, width, height, depth);
		...
		MACH_OVERRIDE(void,label_object_with_responsible_process_APPLE,(GLIContext ctx, GLenum type, GLuint name, GLint pid), err ) {
			file_log("label_object_with_responsible_process_APPLE called: ctx (GLIContext : %p)type (GLenum : %s)name (GLuint : %u)pid (GLint : %i)", ctx, type, name, pid);
		...
		MACH_OVERRIDE(void,texture_barrier_NV,(GLIContext ctx), err ) {
			file_log("texture_barrier_NV called: ctx (GLIContext : %p)", ctx);
