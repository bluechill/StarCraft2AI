...
static void HandleCGLGetCurrentContext(CGLContextObj obj)
{
	...
	if (obj && overriden_ctx.find(obj->rend) == overriden_ctx.end())
	{
		...
		if (err)
			SC2::Utilities::console_log("Failed to override are_textures_resident: %i", err);
		
		MACH_OVERRIDE(void,array_element,(GLIContext ctx, GLint i), err ) {
			SC2::Utilities::file_log("array_element called: ctx (GLIContext : %p) i (GLint : %i)\n", ctx, i);
			return array_element_reenter(ctx, i);
		} END_MACH_OVERRIDE_PTR(array_element, obj->disp.array_element);
		
		if (err)
			SC2::Utilities::console_log("Failed to override array_element: %i", err);
		
		MACH_OVERRIDE(void,begin,(GLIContext ctx, GLenum mode), err ) {
			SC2::Utilities::file_log("begin called: ctx (GLIContext : %p) mode (GLenum : %s)\n", ctx, GLenumToString(mode).c_str());
			return begin_reenter(ctx, mode);
		} END_MACH_OVERRIDE_PTR(begin, obj->disp.begin);
		
		if (err)
			SC2::Utilities::console_log("Failed to override begin: %i", err);
		
		MACH_OVERRIDE(void,bind_texture,(GLIContext ctx, GLenum target, GLuint texture), err ) {
			SC2::Utilities::file_log("bind_texture called: ctx (GLIContext : %p) target (GLenum : %s) texture (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), texture);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_texture(ctx, target, texture);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_texture: %i", err);
		...
		MACH_OVERRIDE(void,copy_tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border), err ) {
			SC2::Utilities::file_log("copy_tex_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalFormat (GLenum : %s) x (GLint : %i) y (GLint : %i) width (GLsizei : %i) border (GLint : %i)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalFormat).c_str(), x, y, width, border);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_tex_image1D: %i", err);
		...
		MACH_OVERRIDE(void,copy_tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border), err ) {
			SC2::Utilities::file_log("copy_tex_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalFormat (GLenum : %s) x (GLint : %i) y (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) border (GLint : %i)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalFormat).c_str(), x, y, width, height, border);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_tex_image2D: %i", err);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width), err ) {
			SC2::Utilities::file_log("copy_tex_sub_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) x (GLint : %i) y (GLint : %i) width (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), level, xoffset, x, y, width);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_tex_sub_image1D: %i", err);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("copy_tex_sub_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) x (GLint : %i) y (GLint : %i) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, x, y, width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_arrays: %i", err);
		
		MACH_OVERRIDE(void,draw_buffer,(GLIContext ctx, GLenum mode), err ) {
			SC2::Utilities::file_log("draw_buffer called: ctx (GLIContext : %p) mode (GLenum : %s)\n", ctx, GLenumToString(mode).c_str());
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_buffer(ctx, mode);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_buffer: %i", err);
		
		MACH_OVERRIDE(void,draw_elements,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices), err ) {
			SC2::Utilities::file_log("draw_elements called: ctx (GLIContext : %p) mode (GLenum : %s) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_elements(ctx, mode, count, type, indices);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_elements: %i", err);
		...
		MACH_OVERRIDE(void,draw_pixels,(GLIContext ctx, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("draw_pixels called: ctx (GLIContext : %p) width (GLsizei : %i) height (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, width, height, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_pixels(ctx, width, height, format, type, pixels);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_image: %i", err);
		
		MACH_OVERRIDE(void,get_tex_level_parameterfv,(GLIContext ctx, GLenum target, GLint level, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_tex_level_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_level_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_tex_level_parameteriv,(GLIContext ctx, GLenum target, GLint level, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_tex_level_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_level_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,get_tex_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_tex_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_tex_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_tex_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		MACH_OVERRIDE(void,map1d,(GLIContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), err ) {
			SC2::Utilities::file_log("map1d called: ctx (GLIContext : %p) target (GLenum : %s) u1 (GLdouble : %f) u2 (GLdouble : %f) stride (GLint : %i) order (GLint : %i) points (const GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), u1, u2, stride, order, points);
			return map1d_reenter(ctx, target, u1, u2, stride, order, points);
		} END_MACH_OVERRIDE_PTR(map1d, obj->disp.map1d);
		
		if (err)
			SC2::Utilities::console_log("Failed to override map1d: %i", err);
		...
		MACH_OVERRIDE(void,map1f,(GLIContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), err ) {
			SC2::Utilities::file_log("map1f called: ctx (GLIContext : %p) target (GLenum : %s) u1 (GLfloat : %f) u2 (GLfloat : %f) stride (GLint : %i) order (GLint : %i) points (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), u1, u2, stride, order, points);
			return map1f_reenter(ctx, target, u1, u2, stride, order, points);
		} END_MACH_OVERRIDE_PTR(map1f, obj->disp.map1f);
		
		if (err)
			SC2::Utilities::console_log("Failed to override map1f: %i", err);
		...
		MACH_OVERRIDE(void,map2d,(GLIContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points), err ) {
			SC2::Utilities::file_log("map2d called: ctx (GLIContext : %p) target (GLenum : %s) u1 (GLdouble : %f) u2 (GLdouble : %f) ustride (GLint : %i) uorder (GLint : %i) v1 (GLdouble : %f) v2 (GLdouble : %f) vstride (GLint : %i) vorder (GLint : %i) points (const GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override map2d: %i", err);
		...
		MACH_OVERRIDE(void,map2f,(GLIContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points), err ) {
			SC2::Utilities::file_log("map2f called: ctx (GLIContext : %p) target (GLenum : %s) u1 (GLfloat : %f) u2 (GLfloat : %f) ustride (GLint : %i) uorder (GLint : %i) v1 (GLfloat : %f) v2 (GLfloat : %f) vstride (GLint : %i) vorder (GLint : %i) points (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		MACH_OVERRIDE(void,tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalformat (GLenum : %s) width (GLsizei : %i) border (GLint : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalformat).c_str(), width, border, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_image1D: %i", err);
		...
		MACH_OVERRIDE(void,tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) border (GLint : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalformat).c_str(), width, height, border, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		MACH_OVERRIDE(void,tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_sub_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) width (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, width, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_sub_image1D: %i", err);
		...
		MACH_OVERRIDE(void,tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_sub_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, width, height, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		MACH_OVERRIDE(void,blend_func_separate,(GLIContext ctx, GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha), err ) {
			SC2::Utilities::file_log("blend_func_separate called: ctx (GLIContext : %p) sfactorRGB (GLenum : %s) dfactorRGB (GLenum : %s) sfactorAlpha (GLenum : %s) dfactorAlpha (GLenum : %s)\n", ctx, GLenumToString(sfactorRGB).c_str(), GLenumToString(dfactorRGB).c_str(), GLenumToString(sfactorAlpha).c_str(), GLenumToString(dfactorAlpha).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override client_active_texture: %i", err);
		
		MACH_OVERRIDE(void,active_texture,(GLIContext ctx, GLenum target), err ) {
			SC2::Utilities::file_log("active_texture called: ctx (GLIContext : %p) target (GLenum : %s)\n", ctx, GLenumToString(target).c_str());
			opengl_api_mutex.lock();
			OpenGL::Shared->active_texture(ctx, target);
			opengl_api_mutex.unlock();
		...
		MACH_OVERRIDE(void,compressed_tex_image3D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_image3D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i) border (GLint : %i) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalformat).c_str(), width, height, depth, border, imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_image3D: %i", err);
		...
		MACH_OVERRIDE(void,compressed_tex_image2D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) border (GLint : %i) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalformat).c_str(), width, height, border, imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_image2D: %i", err);
		...
		MACH_OVERRIDE(void,compressed_tex_image1D,(GLIContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalformat (GLenum : %s) width (GLsizei : %i) border (GLint : %i) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalformat).c_str(), width, border, imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_image1D: %i", err);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_sub_image3D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) zoffset (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i) format (GLenum : %s) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, zoffset, width, height, depth, GLenumToString(format).c_str(), imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_sub_image3D: %i", err);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image2D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_sub_image2D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) format (GLenum : %s) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, width, height, GLenumToString(format).c_str(), imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_sub_image2D: %i", err);
		...
		MACH_OVERRIDE(void,compressed_tex_sub_image1D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data), err ) {
			SC2::Utilities::file_log("compressed_tex_sub_image1D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) width (GLsizei : %i) format (GLenum : %s) imageSize (GLsizei : %i) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, width, GLenumToString(format).c_str(), imageSize, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compressed_tex_sub_image1D: %i", err);
		
		MACH_OVERRIDE(void,get_compressed_tex_image,(GLIContext ctx, GLenum target, GLint level, GLvoid *img), err ) {
			SC2::Utilities::file_log("get_compressed_tex_image called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) img (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, img);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override secondary_color_pointer: %i", err);
		
		MACH_OVERRIDE(void,vertex_array_range_EXT,(GLIContext ctx, GLsizei count, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("vertex_array_range_EXT called: ctx (GLIContext : %p) count (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, count, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_array_range_EXT: %i", err);
		
		MACH_OVERRIDE(void,flush_vertex_array_range_EXT,(GLIContext ctx, GLsizei count, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("flush_vertex_array_range_EXT called: ctx (GLIContext : %p) count (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, count, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override flush_vertex_array_range_EXT: %i", err);
		...
		MACH_OVERRIDE(void,draw_range_elements,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices), err ) {
			SC2::Utilities::file_log("draw_range_elements called: ctx (GLIContext : %p) mode (GLenum : %s) start (GLuint : %u) end (GLuint : %u) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p)\n", ctx, GLenumToString(mode).c_str(), start, end, count, GLenumToString(type).c_str(), indices);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_range_elements(ctx, mode, start, end, count, type, indices);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_range_elements: %i", err);
		...
		MACH_OVERRIDE(void,color_table,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *table), err ) {
			SC2::Utilities::file_log("color_table called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) width (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) table (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), width, GLenumToString(format).c_str(), GLenumToString(type).c_str(), table);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override color_table: %i", err);
		
		MACH_OVERRIDE(void,color_table_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			SC2::Utilities::file_log("color_table_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override color_table_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,color_table_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			SC2::Utilities::file_log("color_table_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (const GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override color_table_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,copy_color_table,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width), err ) {
			SC2::Utilities::file_log("copy_color_table called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) x (GLint : %i) y (GLint : %i) width (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), x, y, width);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_color_table: %i", err);
		
		MACH_OVERRIDE(void,get_color_table_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_color_table_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_color_table_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_color_table_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_color_table_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_color_table_parameteriv: %i", err);
		...
		MACH_OVERRIDE(void,color_sub_table,(GLIContext ctx, GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data), err ) {
			SC2::Utilities::file_log("color_sub_table called: ctx (GLIContext : %p) target (GLenum : %s) start (GLsizei : %i) count (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), start, count, GLenumToString(format).c_str(), GLenumToString(type).c_str(), data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override color_sub_table: %i", err);
		
		MACH_OVERRIDE(void,copy_color_sub_table,(GLIContext ctx, GLenum target, GLsizei start, GLint x, GLint y, GLsizei width), err ) {
			SC2::Utilities::file_log("copy_color_sub_table called: ctx (GLIContext : %p) target (GLenum : %s) start (GLsizei : %i) x (GLint : %i) y (GLint : %i) width (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), start, x, y, width);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_color_sub_table: %i", err);
		...
		MACH_OVERRIDE(void,convolution_filter1D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image), err ) {
			SC2::Utilities::file_log("convolution_filter1D called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) width (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) image (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), width, GLenumToString(format).c_str(), GLenumToString(type).c_str(), image);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_filter1D: %i", err);
		...
		MACH_OVERRIDE(void,convolution_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image), err ) {
			SC2::Utilities::file_log("convolution_filter2D called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) image (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), width, height, GLenumToString(format).c_str(), GLenumToString(type).c_str(), image);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_filter2D: %i", err);
		
		MACH_OVERRIDE(void,convolution_parameterf,(GLIContext ctx, GLenum target, GLenum pname, GLfloat params), err ) {
			SC2::Utilities::file_log("convolution_parameterf called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat : %f)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_parameterf: %i", err);
		
		MACH_OVERRIDE(void,convolution_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, const GLfloat *params), err ) {
			SC2::Utilities::file_log("convolution_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,convolution_parameteri,(GLIContext ctx, GLenum target, GLenum pname, GLint params), err ) {
			SC2::Utilities::file_log("convolution_parameteri called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_parameteri: %i", err);
		
		MACH_OVERRIDE(void,convolution_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, const GLint *params), err ) {
			SC2::Utilities::file_log("convolution_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (const GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override convolution_parameteriv: %i", err);
		...
		MACH_OVERRIDE(void,copy_convolution_filter1D,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width), err ) {
			SC2::Utilities::file_log("copy_convolution_filter1D called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) x (GLint : %i) y (GLint : %i) width (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), x, y, width);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_convolution_filter1D: %i", err);
		...
		MACH_OVERRIDE(void,copy_convolution_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("copy_convolution_filter2D called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) x (GLint : %i) y (GLint : %i) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), x, y, width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_convolution_filter2D: %i", err);
		
		MACH_OVERRIDE(void,get_convolution_filter,(GLIContext ctx, GLenum target, GLenum format, GLenum type, GLvoid *image), err ) {
			SC2::Utilities::file_log("get_convolution_filter called: ctx (GLIContext : %p) target (GLenum : %s) format (GLenum : %s) type (GLenum : %s) image (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(format).c_str(), GLenumToString(type).c_str(), image);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_convolution_filter: %i", err);
		
		MACH_OVERRIDE(void,get_convolution_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_convolution_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_convolution_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_convolution_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_convolution_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_convolution_parameteriv: %i", err);
		...
		MACH_OVERRIDE(void,get_separable_filter,(GLIContext ctx, GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid *column, GLvoid *span), err ) {
			SC2::Utilities::file_log("get_separable_filter called: ctx (GLIContext : %p) target (GLenum : %s) format (GLenum : %s) type (GLenum : %s) row (GLvoid* : %p) column (GLvoid* : %p) span (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(format).c_str(), GLenumToString(type).c_str(), row, column, span);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_separable_filter: %i", err);
		...
		MACH_OVERRIDE(void,separable_filter2D,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *column), err ) {
			SC2::Utilities::file_log("separable_filter2D called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) row (const GLvoid* : %p) column (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), width, height, GLenumToString(format).c_str(), GLenumToString(type).c_str(), row, column);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override separable_filter2D: %i", err);
		...
		MACH_OVERRIDE(void,get_histogram,(GLIContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values), err ) {
			SC2::Utilities::file_log("get_histogram called: ctx (GLIContext : %p) target (GLenum : %s) reset (GLboolean : %i) format (GLenum : %s) type (GLenum : %s) values (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), reset, GLenumToString(format).c_str(), GLenumToString(type).c_str(), values);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_histogram: %i", err);
		
		MACH_OVERRIDE(void,get_histogram_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_histogram_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_histogram_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_histogram_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_histogram_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_histogram_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,get_minmax,(GLIContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values), err ) {
			SC2::Utilities::file_log("get_minmax called: ctx (GLIContext : %p) target (GLenum : %s) reset (GLboolean : %i) format (GLenum : %s) type (GLenum : %s) values (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), reset, GLenumToString(format).c_str(), GLenumToString(type).c_str(), values);
			return get_minmax_reenter(ctx, target, reset, format, type, values);
		} END_MACH_OVERRIDE_PTR(get_minmax, obj->disp.get_minmax);
		
		if (err)
			SC2::Utilities::console_log("Failed to override get_minmax: %i", err);
		
		MACH_OVERRIDE(void,get_minmax_parameterfv,(GLIContext ctx, GLenum target, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_minmax_parameterfv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_minmax_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_minmax_parameteriv,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_minmax_parameteriv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		MACH_OVERRIDE(void,tex_image3D,(GLIContext ctx, GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_image3D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) internalFormat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i) border (GLint : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, GLenumToString(internalFormat).c_str(), width, height, depth, border, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_image3D: %i", err);
		...
		MACH_OVERRIDE(void,tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels), err ) {
			SC2::Utilities::file_log("tex_sub_image3D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) zoffset (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i) format (GLenum : %s) type (GLenum : %s) pixels (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, zoffset, width, height, depth, GLenumToString(format).c_str(), GLenumToString(type).c_str(), pixels);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_sub_image3D: %i", err);
		...
		MACH_OVERRIDE(void,copy_tex_sub_image3D,(GLIContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("copy_tex_sub_image3D called: ctx (GLIContext : %p) target (GLenum : %s) level (GLint : %i) xoffset (GLint : %i) yoffset (GLint : %i) zoffset (GLint : %i) x (GLint : %i) y (GLint : %i) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), level, xoffset, yoffset, zoffset, x, y, width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_tex_sub_image3D: %i", err);
		...
		MACH_OVERRIDE(void,get_uniform_indices,(GLIContext ctx, GLuint program, GLsizei uniformCount, const GLchar* const *uniformNames, GLuint* uniformIndices), err ) {
			SC2::Utilities::file_log("get_uniform_indices called: ctx (GLIContext : %p) program (GLuint : %u) uniformCount (GLsizei : %i) uniformNames (const GLchar*const* : %p) uniformIndices (GLuint* : %p)\n", ctx, program, uniformCount, uniformNames, uniformIndices);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_indices: %i", err);
		...
		MACH_OVERRIDE(void,get_active_uniformsiv,(GLIContext ctx, GLuint program, GLsizei uniformCount, const GLuint* uniformIndices, GLenum pname, GLint* params), err ) {
			SC2::Utilities::file_log("get_active_uniformsiv called: ctx (GLIContext : %p) program (GLuint : %u) uniformCount (GLsizei : %i) uniformIndices (const GLuint* : %p) pname (GLenum : %s) params (GLint* : %p)\n", ctx, program, uniformCount, uniformIndices, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_uniformsiv: %i", err);
		...
		MACH_OVERRIDE(void,get_active_uniform_name,(GLIContext ctx, GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei* length, GLchar* uniformName), err ) {
			SC2::Utilities::file_log("get_active_uniform_name called: ctx (GLIContext : %p) program (GLuint : %u) uniformIndex (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) uniformName (GLchar* : %p)\n", ctx, program, uniformIndex, bufSize, length, uniformName);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_uniform_name: %i", err);
		
		MACH_OVERRIDE(GLuint,get_uniform_block_index,(GLIContext ctx, GLuint program, const GLchar* uniformBlockName), err ) {
			SC2::Utilities::file_log("get_uniform_block_index called: ctx (GLIContext : %p) program (GLuint : %u) uniformBlockName (const GLchar* : %p)\n", ctx, program, uniformBlockName);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_block_index: %i", err);
		...
		MACH_OVERRIDE(void,get_active_uniform_blockiv,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params), err ) {
			SC2::Utilities::file_log("get_active_uniform_blockiv called: ctx (GLIContext : %p) program (GLuint : %u) uniformBlockIndex (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, program, uniformBlockIndex, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_uniform_blockiv: %i", err);
		...
		MACH_OVERRIDE(void,get_active_uniform_block_name,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei* length, GLchar* uniformBlockName), err ) {
			SC2::Utilities::file_log("get_active_uniform_block_name called: ctx (GLIContext : %p) program (GLuint : %u) uniformBlockIndex (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) uniformBlockName (GLchar* : %p)\n", ctx, program, uniformBlockIndex, bufSize, length, uniformBlockName);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_uniform_block_name: %i", err);
		...
		MACH_OVERRIDE(void,uniform_block_binding,(GLIContext ctx, GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding), err ) {
			SC2::Utilities::file_log("uniform_block_binding called: ctx (GLIContext : %p) program (GLuint : %u) uniformBlockIndex (GLuint : %u) uniformBlockBinding (GLuint : %u)\n", ctx, program, uniformBlockIndex, uniformBlockBinding);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_block_binding: %i", err);
		...
		MACH_OVERRIDE(void,get_combiner_input_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_combiner_input_parameterfv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) portion (GLenum : %s) variable (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(portion).c_str(), GLenumToString(variable).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_combiner_input_parameterfv_NV: %i", err);
		...
		MACH_OVERRIDE(void,get_combiner_input_parameteriv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_combiner_input_parameteriv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) portion (GLenum : %s) variable (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(portion).c_str(), GLenumToString(variable).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_combiner_input_parameteriv_NV: %i", err);
		...
		MACH_OVERRIDE(void,get_combiner_output_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_combiner_output_parameterfv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) portion (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(portion).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_combiner_output_parameterfv_NV: %i", err);
		...
		MACH_OVERRIDE(void,get_combiner_output_parameteriv_NV,(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_combiner_output_parameteriv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) portion (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(portion).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_combiner_output_parameteriv_NV: %i", err);
		...
		MACH_OVERRIDE(void,get_final_combiner_input_parameterfv_NV,(GLIContext ctx, GLenum variable, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_final_combiner_input_parameterfv_NV called: ctx (GLIContext : %p) variable (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(variable).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_final_combiner_input_parameterfv_NV: %i", err);
		
		MACH_OVERRIDE(void,get_final_combiner_input_parameteriv_NV,(GLIContext ctx, GLenum variable, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_final_combiner_input_parameteriv_NV called: ctx (GLIContext : %p) variable (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(variable).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_final_combiner_input_parameteriv_NV: %i", err);
		
		MACH_OVERRIDE(void,combiner_stage_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum pname, const GLfloat *params), err ) {
			SC2::Utilities::file_log("combiner_stage_parameterfv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) pname (GLenum : %s) params (const GLfloat* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override combiner_stage_parameterfv_NV: %i", err);
		
		MACH_OVERRIDE(void,get_combiner_stage_parameterfv_NV,(GLIContext ctx, GLenum stage, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_combiner_stage_parameterfv_NV called: ctx (GLIContext : %p) stage (GLenum : %s) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, GLenumToString(stage).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_combiner_stage_parameterfv_NV: %i", err);
		
		MACH_OVERRIDE(void,texture_range_APPLE,(GLIContext ctx, GLenum target, GLsizei length, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("texture_range_APPLE called: ctx (GLIContext : %p) target (GLenum : %s) length (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), length, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override texture_range_APPLE: %i", err);
		
		MACH_OVERRIDE(void,get_tex_parameter_pointerv_APPLE,(GLIContext ctx, GLenum target, GLenum pname, GLvoid **params), err ) {
			SC2::Utilities::file_log("get_tex_parameter_pointerv_APPLE called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLvoid** : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_parameter_pointerv_APPLE: %i", err);
		
		MACH_OVERRIDE(void,blend_equation_separate_EXT,(GLIContext ctx, GLenum equationRGB, GLenum equationAlpha), err ) {
			SC2::Utilities::file_log("blend_equation_separate_EXT called: ctx (GLIContext : %p) equationRGB (GLenum : %s) equationAlpha (GLenum : %s)\n", ctx, GLenumToString(equationRGB).c_str(), GLenumToString(equationAlpha).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override test_object_APPLE: %i", err);
		
		MACH_OVERRIDE(void,finish_object_APPLE,(GLIContext ctx, GLenum object, GLuint name), err ) {
			SC2::Utilities::file_log("finish_object_APPLE called: ctx (GLIContext : %p) object (GLenum : %s) name (GLuint : %u)\n", ctx, GLenumToString(object).c_str(), name);
			return finish_object_APPLE_reenter(ctx, object, name);
		} END_MACH_OVERRIDE_PTR(finish_object_APPLE, obj->disp.finish_object_APPLE);
		
		if (err)
			SC2::Utilities::console_log("Failed to override finish_object_APPLE: %i", err);
		
		MACH_OVERRIDE(void,bind_program_ARB,(GLIContext ctx, GLenum target, GLuint program), err ) {
			SC2::Utilities::file_log("bind_program_ARB called: ctx (GLIContext : %p) target (GLenum : %s) program (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), program);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_program_ARB(ctx, target, program);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4s_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4f_ARB,(GLIContext ctx, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			SC2::Utilities::file_log("vertex_attrib4f_ARB called: ctx (GLIContext : %p) index (GLuint : %u) x (GLfloat : %f) y (GLfloat : %f) z (GLfloat : %f) w (GLfloat : %f)\n", ctx, index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4f_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4d_ARB,(GLIContext ctx, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			SC2::Utilities::file_log("vertex_attrib4d_ARB called: ctx (GLIContext : %p) index (GLuint : %u) x (GLdouble : %f) y (GLdouble : %f) z (GLdouble : %f) w (GLdouble : %f)\n", ctx, index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4d_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nub_ARB,(GLIContext ctx, GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nub_ARB called: ctx (GLIContext : %p) index (GLuint : %u) x (GLubyte : %u) y (GLubyte : %u) z (GLubyte : %u) w (GLubyte : %u)\n", ctx, index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4ubv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4usv_ARB,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4usv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLushort* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4usv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4uiv_ARB,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4uiv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4uiv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4fv_ARB,(GLIContext ctx, GLuint index, const GLfloat *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4fv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLfloat* : %p)\n", ctx, index, v);
			return vertex_attrib4fv_ARB_reenter(ctx, index, v);
		} END_MACH_OVERRIDE_PTR(vertex_attrib4fv_ARB, obj->disp.vertex_attrib4fv_ARB);
		
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4fv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4dv_ARB,(GLIContext ctx, GLuint index, const GLdouble *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4dv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLdouble* : %p)\n", ctx, index, v);
			return vertex_attrib4dv_ARB_reenter(ctx, index, v);
		} END_MACH_OVERRIDE_PTR(vertex_attrib4dv_ARB, obj->disp.vertex_attrib4dv_ARB);
		
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4dv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nbv_ARB,(GLIContext ctx, GLuint index, const GLbyte *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nbv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLbyte* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Nbv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nsv_ARB,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nsv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLshort* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Nsv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Niv_ARB,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Niv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Niv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nubv_ARB,(GLIContext ctx, GLuint index, const GLubyte *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nubv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLubyte* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Nubv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nusv_ARB,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nusv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLushort* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Nusv_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib4Nuiv_ARB,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attrib4Nuiv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib4Nuiv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attrib_pointer_ARB,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("vertex_attrib_pointer_ARB called: ctx (GLIContext : %p) index (GLuint : %u) size (GLint : %i) type (GLenum : %s) normalized (GLboolean : %i) stride (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, index, size, GLenumToString(type).c_str(), normalized, stride, pointer);
			OpenGL::Shared->vertex_attrib_pointer_ARB(ctx, index, size, type, normalized, stride, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib_pointer_ARB: %i", err);
		
		MACH_OVERRIDE(void,enable_vertex_attrib_array_ARB,(GLIContext ctx, GLuint index), err ) {
			SC2::Utilities::file_log("enable_vertex_attrib_array_ARB called: ctx (GLIContext : %p) index (GLuint : %u)\n", ctx, index);
			OpenGL::Shared->enable_vertex_attrib_array_ARB(ctx, index);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override enable_vertex_attrib_array_ARB: %i", err);
		
		MACH_OVERRIDE(void,disable_vertex_attrib_array_ARB,(GLIContext ctx, GLuint index), err ) {
			SC2::Utilities::file_log("disable_vertex_attrib_array_ARB called: ctx (GLIContext : %p) index (GLuint : %u)\n", ctx, index);
			OpenGL::Shared->disable_vertex_attrib_array_ARB(ctx, index);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override disable_vertex_attrib_array_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attribdv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLdouble *params), err ) {
			SC2::Utilities::file_log("get_vertex_attribdv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLdouble* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attribdv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attribfv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_vertex_attribfv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attribfv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attribiv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_vertex_attribiv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attribiv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attrib_pointerv_ARB,(GLIContext ctx, GLuint index, GLenum pname, GLvoid **pointer), err ) {
			SC2::Utilities::file_log("get_vertex_attrib_pointerv_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) pointer (GLvoid** : %p)\n", ctx, index, GLenumToString(pname).c_str(), pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attrib_pointerv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,program_env_parameter4d_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			SC2::Utilities::file_log("program_env_parameter4d_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) x (GLdouble : %f) y (GLdouble : %f) z (GLdouble : %f) w (GLdouble : %f)\n", ctx, GLenumToString(target).c_str(), index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_env_parameter4d_ARB: %i", err);
		
		MACH_OVERRIDE(void,program_env_parameter4dv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLdouble *params), err ) {
			SC2::Utilities::file_log("program_env_parameter4dv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (const GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_env_parameter4dv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,program_env_parameter4f_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			SC2::Utilities::file_log("program_env_parameter4f_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) x (GLfloat : %f) y (GLfloat : %f) z (GLfloat : %f) w (GLfloat : %f)\n", ctx, GLenumToString(target).c_str(), index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_env_parameter4f_ARB: %i", err);
		
		MACH_OVERRIDE(void,program_env_parameter4fv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLfloat *params), err ) {
			SC2::Utilities::file_log("program_env_parameter4fv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_env_parameter4fv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,program_local_parameter4d_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			SC2::Utilities::file_log("program_local_parameter4d_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) x (GLdouble : %f) y (GLdouble : %f) z (GLdouble : %f) w (GLdouble : %f)\n", ctx, GLenumToString(target).c_str(), index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_local_parameter4d_ARB: %i", err);
		
		MACH_OVERRIDE(void,program_local_parameter4dv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLdouble *params), err ) {
			SC2::Utilities::file_log("program_local_parameter4dv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (const GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_local_parameter4dv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,program_local_parameter4f_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			SC2::Utilities::file_log("program_local_parameter4f_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) x (GLfloat : %f) y (GLfloat : %f) z (GLfloat : %f) w (GLfloat : %f)\n", ctx, GLenumToString(target).c_str(), index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_local_parameter4f_ARB: %i", err);
		
		MACH_OVERRIDE(void,program_local_parameter4fv_ARB,(GLIContext ctx, GLenum target, GLuint index, const GLfloat *params), err ) {
			SC2::Utilities::file_log("program_local_parameter4fv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_local_parameter4fv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_program_env_parameterdv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble *params), err ) {
			SC2::Utilities::file_log("get_program_env_parameterdv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_env_parameterdv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_program_env_parameterfv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_program_env_parameterfv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_env_parameterfv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_program_local_parameterdv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLdouble *params), err ) {
			SC2::Utilities::file_log("get_program_local_parameterdv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (GLdouble* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_local_parameterdv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_program_local_parameterfv_ARB,(GLIContext ctx, GLenum target, GLuint index, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_program_local_parameterfv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) params (GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), index, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_local_parameterfv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,program_string_ARB,(GLIContext ctx, GLenum target, GLenum format, GLsizei len, const GLvoid* string), err ) {
			...
			opengl_api_mutex.lock();
			OpenGL::Shared->program_string_ARB(ctx, target, format, len, string);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_string_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_program_string_ARB,(GLIContext ctx, GLenum target, GLenum pname, GLvoid *string), err ) {
			SC2::Utilities::file_log("get_program_string_ARB called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) string (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), string);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_string_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_programiv_ARB,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_programiv_ARB called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_programiv_ARB: %i", err);
		
		MACH_OVERRIDE(void,enable_vertex_attrib_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			SC2::Utilities::file_log("enable_vertex_attrib_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s)\n", ctx, index, GLenumToString(pname).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override enable_vertex_attrib_ARB: %i", err);
		
		MACH_OVERRIDE(void,disable_vertex_attrib_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			SC2::Utilities::file_log("disable_vertex_attrib_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s)\n", ctx, index, GLenumToString(pname).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override disable_vertex_attrib_ARB: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_vertex_attrib_enabled_ARB,(GLIContext ctx, GLuint index, GLenum pname), err ) {
			SC2::Utilities::file_log("is_vertex_attrib_enabled_ARB called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s)\n", ctx, index, GLenumToString(pname).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_vertex_attrib_enabled_ARB: %i", err);
		...
		MACH_OVERRIDE(void,map_vertex_attrib1d_ARB,(GLIContext ctx, GLuint index, GLuint size, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points), err ) {
			SC2::Utilities::file_log("map_vertex_attrib1d_ARB called: ctx (GLIContext : %p) index (GLuint : %u) size (GLuint : %u) u1 (GLdouble : %f) u2 (GLdouble : %f) stride (GLint : %i) order (GLint : %i) points (const GLdouble* : %p)\n", ctx, index, size, u1, u2, stride, order, points);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override map_vertex_attrib1d_ARB: %i", err);
		...
		MACH_OVERRIDE(void,map_vertex_attrib1f_ARB,(GLIContext ctx, GLuint index, GLuint size, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points), err ) {
			SC2::Utilities::file_log("map_vertex_attrib1f_ARB called: ctx (GLIContext : %p) index (GLuint : %u) size (GLuint : %u) u1 (GLfloat : %f) u2 (GLfloat : %f) stride (GLint : %i) order (GLint : %i) points (const GLfloat* : %p)\n", ctx, index, size, u1, u2, stride, order, points);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override map_vertex_attrib1f_ARB: %i", err);
		...
		MACH_OVERRIDE(void,map_vertex_attrib2d_ARB,(GLIContext ctx, GLuint index, GLuint size, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points), err ) {
			SC2::Utilities::file_log("map_vertex_attrib2d_ARB called: ctx (GLIContext : %p) index (GLuint : %u) size (GLuint : %u) u1 (GLdouble : %f) u2 (GLdouble : %f) ustride (GLint : %i) uorder (GLint : %i) v1 (GLdouble : %f) v2 (GLdouble : %f) vstride (GLint : %i) vorder (GLint : %i) points (const GLdouble* : %p)\n", ctx, index, size, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override map_vertex_attrib2d_ARB: %i", err);
		...
		MACH_OVERRIDE(void,map_vertex_attrib2f_ARB,(GLIContext ctx, GLuint index, GLuint size, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points), err ) {
			SC2::Utilities::file_log("map_vertex_attrib2f_ARB called: ctx (GLIContext : %p) index (GLuint : %u) size (GLuint : %u) u1 (GLfloat : %f) u2 (GLfloat : %f) ustride (GLint : %i) uorder (GLint : %i) v1 (GLfloat : %f) v2 (GLfloat : %f) vstride (GLint : %i) vorder (GLint : %i) points (const GLfloat* : %p)\n", ctx, index, size, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override fog_coord_pointer: %i", err);
		
		MACH_OVERRIDE(void,vertex_array_parameteri_EXT,(GLIContext ctx, GLenum pname, GLint param), err ) {
			SC2::Utilities::file_log("vertex_array_parameteri_EXT called: ctx (GLIContext : %p) pname (GLenum : %s) param (GLint : %i)\n", ctx, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_array_parameteri_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_vertex_array_EXT,(GLIContext ctx, GLuint id), err ) {
			SC2::Utilities::file_log("bind_vertex_array_EXT called: ctx (GLIContext : %p) id (GLuint : %u)\n", ctx, id);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_vertex_array_EXT(ctx, id);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_vertex_array_EXT: %i", err);
		
		MACH_OVERRIDE(void,delete_vertex_arrays_EXT,(GLIContext ctx, GLsizei n, const GLuint *ids), err ) {
			SC2::Utilities::file_log("delete_vertex_arrays_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) ids (const GLuint* : %p)\n", ctx, n, ids);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_vertex_arrays_EXT: %i", err);
		
		MACH_OVERRIDE(void,gen_vertex_arrays_EXT,(GLIContext ctx, GLsizei n, GLuint *ids), err ) {
			SC2::Utilities::file_log("gen_vertex_arrays_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) ids (GLuint* : %p)\n", ctx, n, ids);
			return gen_vertex_arrays_EXT_reenter(ctx, n, ids);
		} END_MACH_OVERRIDE_PTR(gen_vertex_arrays_EXT, obj->disp.gen_vertex_arrays_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override gen_vertex_arrays_EXT: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_vertex_array_EXT,(GLIContext ctx, GLuint id), err ) {
			SC2::Utilities::file_log("is_vertex_array_EXT called: ctx (GLIContext : %p) id (GLuint : %u)\n", ctx, id);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_vertex_array_EXT: %i", err);
		
		MACH_OVERRIDE(void,element_pointer_APPLE,(GLIContext ctx, GLenum type, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("element_pointer_APPLE called: ctx (GLIContext : %p) type (GLenum : %s) pointer (const GLvoid* : %p)\n", ctx, GLenumToString(type).c_str(), pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override element_pointer_APPLE: %i", err);
		
		MACH_OVERRIDE(void,draw_element_array_APPLE,(GLIContext ctx, GLenum mode, GLint first, GLsizei count), err ) {
			SC2::Utilities::file_log("draw_element_array_APPLE called: ctx (GLIContext : %p) mode (GLenum : %s) first (GLint : %i) count (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), first, count);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_element_array_APPLE(ctx, mode, first, count);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_element_array_APPLE: %i", err);
		...
		MACH_OVERRIDE(void,draw_range_element_array_APPLE,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLint first, GLsizei count), err ) {
			SC2::Utilities::file_log("draw_range_element_array_APPLE called: ctx (GLIContext : %p) mode (GLenum : %s) start (GLuint : %u) end (GLuint : %u) first (GLint : %i) count (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), start, end, first, count);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_range_element_array_APPLE(ctx, mode, start, end, first, count);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override weight_pointer_ARB: %i", err);
		
		MACH_OVERRIDE(void,vertex_blend_ARB,(GLIContext ctx, GLint count), err ) {
			SC2::Utilities::file_log("vertex_blend_ARB called: ctx (GLIContext : %p) count (GLint : %i)\n", ctx, count);
			return vertex_blend_ARB_reenter(ctx, count);
		} END_MACH_OVERRIDE_PTR(vertex_blend_ARB, obj->disp.vertex_blend_ARB);
		
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_blend_ARB: %i", err);
		...
		MACH_OVERRIDE(void,multi_draw_arrays,(GLIContext ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount), err ) {
			SC2::Utilities::file_log("multi_draw_arrays called: ctx (GLIContext : %p) mode (GLenum : %s) first (const GLint* : %p) count (const GLsizei* : %p) drawcount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), first, count, drawcount);
			opengl_api_mutex.lock();
			OpenGL::Shared->multi_draw_arrays(ctx, mode, first, count, drawcount);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override multi_draw_arrays: %i", err);
		...
		MACH_OVERRIDE(void,multi_draw_elements,(GLIContext ctx, GLenum mode, const GLsizei *count, GLenum type, const GLvoid* const *indices, GLsizei drawcount), err ) {
			SC2::Utilities::file_log("multi_draw_elements called: ctx (GLIContext : %p) mode (GLenum : %s) count (const GLsizei* : %p) type (GLenum : %s) indices (const GLvoid*const* : %p) drawcount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices, drawcount);
			opengl_api_mutex.lock();
			OpenGL::Shared->multi_draw_elements(ctx, mode, count, type, indices, drawcount);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override stencil_op_separate_ATI: %i", err);
		
		MACH_OVERRIDE(void,stencil_func_separate_ATI,(GLIContext ctx, GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask), err ) {
			SC2::Utilities::file_log("stencil_func_separate_ATI called: ctx (GLIContext : %p) frontfunc (GLenum : %s) backfunc (GLenum : %s) ref (GLint : %i) mask (GLuint : %u)\n", ctx, GLenumToString(frontfunc).c_str(), GLenumToString(backfunc).c_str(), ref, mask);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override stencil_func_separate_ATI: %i", err);
		
		MACH_OVERRIDE(void,flush_render_APPLE,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("flush_render_APPLE called: ctx (GLIContext : %p)\n", ctx);
			return flush_render_APPLE_reenter(ctx);
		} END_MACH_OVERRIDE_PTR(flush_render_APPLE, obj->disp.flush_render_APPLE);
		
		if (err)
			SC2::Utilities::console_log("Failed to override flush_render_APPLE: %i", err);
		
		MACH_OVERRIDE(void,finish_render_APPLE,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("finish_render_APPLE called: ctx (GLIContext : %p)\n", ctx);
			return finish_render_APPLE_reenter(ctx);
		} END_MACH_OVERRIDE_PTR(finish_render_APPLE, obj->disp.finish_render_APPLE);
		
		if (err)
			SC2::Utilities::console_log("Failed to override finish_render_APPLE: %i", err);
		
		MACH_OVERRIDE(void,swap_APPLE,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("swap_APPLE called: ctx (GLIContext : %p)\n", ctx);
			opengl_api_mutex.lock();
			OpenGL::Shared->swap_APPLE(ctx);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override detach_object_ARB: %i", err);
		
		MACH_OVERRIDE(GLhandleARB,create_shader_object_ARB,(GLIContext ctx, GLenum shaderType), err ) {
			SC2::Utilities::file_log("create_shader_object_ARB called: ctx (GLIContext : %p) shaderType (GLenum : %s)\n", ctx, GLenumToString(shaderType).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override create_shader_object_ARB: %i", err);
		...
		MACH_OVERRIDE(void,shader_source_ARB,(GLIContext ctx, GLhandleARB shaderObj, GLsizei count, const GLcharARB* const *string, const GLint *length), err ) {
			SC2::Utilities::file_log("shader_source_ARB called: ctx (GLIContext : %p) shaderObj (GLhandleARB : %p) count (GLsizei : %i) string (const GLcharARB*const* : %p) length (const GLint* : %p)\n", ctx, shaderObj, count, string, length);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override shader_source_ARB: %i", err);
		
		MACH_OVERRIDE(void,compile_shader_ARB,(GLIContext ctx, GLhandleARB shaderObj), err ) {
			SC2::Utilities::file_log("compile_shader_ARB called: ctx (GLIContext : %p) shaderObj (GLhandleARB : %p)\n", ctx, shaderObj);
			return compile_shader_ARB_reenter(ctx, shaderObj);
		} END_MACH_OVERRIDE_PTR(compile_shader_ARB, obj->disp.compile_shader_ARB);
		
		if (err)
			SC2::Utilities::console_log("Failed to override compile_shader_ARB: %i", err);
		
		MACH_OVERRIDE(GLhandleARB,create_program_object_ARB,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("create_program_object_ARB called: ctx (GLIContext : %p)\n", ctx);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override use_program_object_ARB: %i", err);
		
		MACH_OVERRIDE(void,validate_program_ARB,(GLIContext ctx, GLhandleARB programObj), err ) {
			SC2::Utilities::file_log("validate_program_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p)\n", ctx, programObj);
		...
		MACH_OVERRIDE(void,uniform_matrix2fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2fv_ARB called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2fv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3fv_ARB called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3fv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4fv_ARB,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4fv_ARB called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix4fv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_object_parameterfv_ARB,(GLIContext ctx, GLhandleARB obj, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_object_parameterfv_ARB called: ctx (GLIContext : %p) obj (GLhandleARB : %p) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, obj, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_object_parameterfv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_object_parameteriv_ARB,(GLIContext ctx, GLhandleARB obj, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_object_parameteriv_ARB called: ctx (GLIContext : %p) obj (GLhandleARB : %p) pname (GLenum : %s) params (GLint* : %p)\n", ctx, obj, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_object_parameteriv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_info_log_ARB,(GLIContext ctx, GLhandleARB obj, GLsizei maxLength, GLsizei *length, GLcharARB *infoLog), err ) {
			SC2::Utilities::file_log("get_info_log_ARB called: ctx (GLIContext : %p) obj (GLhandleARB : %p) maxLength (GLsizei : %i) length (GLsizei* : %p) infoLog (GLcharARB* : %p)\n", ctx, obj, maxLength, length, infoLog);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_info_log_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_attached_objects_ARB,(GLIContext ctx, GLhandleARB containerObj, GLsizei maxCount, GLsizei *count, GLhandleARB *obj), err ) {
			SC2::Utilities::file_log("get_attached_objects_ARB called: ctx (GLIContext : %p) containerObj (GLhandleARB : %p) maxCount (GLsizei : %i) count (GLsizei* : %p) obj (GLhandleARB* : %p)\n", ctx, containerObj, maxCount, count, obj);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_attached_objects_ARB: %i", err);
		
		MACH_OVERRIDE(GLint,get_uniform_location_ARB,(GLIContext ctx, GLhandleARB programObj, const GLcharARB *name), err ) {
			SC2::Utilities::file_log("get_uniform_location_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) name (const GLcharARB* : %p)\n", ctx, programObj, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_location_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_active_uniform_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei *length, GLint *size, GLenum *type, GLcharARB *name), err ) {
			SC2::Utilities::file_log("get_active_uniform_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) index (GLuint : %u) maxLength (GLsizei : %i) length (GLsizei* : %p) size (GLint* : %p) type (GLenum* : %p) name (GLcharARB* : %p)\n", ctx, programObj, index, maxLength, length, size, type, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_uniform_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_uniformfv_ARB,(GLIContext ctx, GLhandleARB programObj, GLint location, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_uniformfv_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) location (GLint : %i) params (GLfloat* : %p)\n", ctx, programObj, location, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniformfv_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_uniformiv_ARB,(GLIContext ctx, GLhandleARB programObj, GLint location, GLint *params), err ) {
			SC2::Utilities::file_log("get_uniformiv_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) location (GLint : %i) params (GLint* : %p)\n", ctx, programObj, location, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniformiv_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_shader_source_ARB,(GLIContext ctx, GLhandleARB obj, GLsizei maxLength, GLsizei *length, GLcharARB *source), err ) {
			SC2::Utilities::file_log("get_shader_source_ARB called: ctx (GLIContext : %p) obj (GLhandleARB : %p) maxLength (GLsizei : %i) length (GLsizei* : %p) source (GLcharARB* : %p)\n", ctx, obj, maxLength, length, source);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_shader_source_ARB: %i", err);
		
		MACH_OVERRIDE(void,bind_attrib_location_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, const GLcharARB *name), err ) {
			SC2::Utilities::file_log("bind_attrib_location_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) index (GLuint : %u) name (const GLcharARB* : %p)\n", ctx, programObj, index, name);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_attrib_location_ARB(ctx, programObj, index, name);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_attrib_location_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_active_attrib_ARB,(GLIContext ctx, GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei *length, GLint *size, GLenum *type, GLcharARB *name), err ) {
			SC2::Utilities::file_log("get_active_attrib_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) index (GLuint : %u) maxLength (GLsizei : %i) length (GLsizei* : %p) size (GLint* : %p) type (GLenum* : %p) name (GLcharARB* : %p)\n", ctx, programObj, index, maxLength, length, size, type, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_attrib_ARB: %i", err);
		
		MACH_OVERRIDE(GLint,get_attrib_location_ARB,(GLIContext ctx, GLhandleARB programObj, const GLcharARB *name), err ) {
			SC2::Utilities::file_log("get_attrib_location_ARB called: ctx (GLIContext : %p) programObj (GLhandleARB : %p) name (const GLcharARB* : %p)\n", ctx, programObj, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_query_objectiv: %i", err);
		
		MACH_OVERRIDE(void,get_query_objectuiv,(GLIContext ctx, GLuint id, GLenum pname, GLuint *params), err ) {
			SC2::Utilities::file_log("get_query_objectuiv called: ctx (GLIContext : %p) id (GLuint : %u) pname (GLenum : %s) params (GLuint* : %p)\n", ctx, id, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_query_objectuiv: %i", err);
		
		MACH_OVERRIDE(void,bind_buffer,(GLIContext ctx, GLenum target, GLuint buffer), err ) {
			SC2::Utilities::file_log("bind_buffer called: ctx (GLIContext : %p) target (GLenum : %s) buffer (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), buffer);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_buffer(ctx, target, buffer);
			opengl_api_mutex.unlock();
		...
		MACH_OVERRIDE(void,buffer_sub_data,(GLIContext ctx, GLenum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid *data), err ) {
			SC2::Utilities::file_log("buffer_sub_data called: ctx (GLIContext : %p) target (GLenum : %s) offset (GLintptrARB : %p) size (GLsizeiptrARB : %p) data (const GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), offset, size, data);
			return buffer_sub_data_reenter(ctx, target, offset, size, data);
		} END_MACH_OVERRIDE_PTR(buffer_sub_data, obj->disp.buffer_sub_data);
		
		if (err)
			SC2::Utilities::console_log("Failed to override buffer_sub_data: %i", err);
		...
		MACH_OVERRIDE(void,get_buffer_sub_data,(GLIContext ctx, GLenum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid *data), err ) {
			SC2::Utilities::file_log("get_buffer_sub_data called: ctx (GLIContext : %p) target (GLenum : %s) offset (GLintptrARB : %p) size (GLsizeiptrARB : %p) data (GLvoid* : %p)\n", ctx, GLenumToString(target).c_str(), offset, size, data);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_buffer_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,get_buffer_pointerv,(GLIContext ctx, GLenum target, GLenum pname, GLvoid **params), err ) {
			SC2::Utilities::file_log("get_buffer_pointerv called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLvoid** : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_buffer_pointerv: %i", err);
		
		MACH_OVERRIDE(void,depth_bounds_EXT,(GLIContext ctx, GLclampd zmin, GLclampd zmax), err ) {
			SC2::Utilities::file_log("depth_bounds_EXT called: ctx (GLIContext : %p) zmin (GLclampd : %f) zmax (GLclampd : %f)\n", ctx, zmin, zmax);
			return depth_bounds_EXT_reenter(ctx, zmin, zmax);
		} END_MACH_OVERRIDE_PTR(depth_bounds_EXT, obj->disp.depth_bounds_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override depth_bounds_EXT: %i", err);
		
		MACH_OVERRIDE(void,draw_buffers_ARB,(GLIContext ctx, GLsizei n, const GLenum *bufs), err ) {
			SC2::Utilities::file_log("draw_buffers_ARB called: ctx (GLIContext : %p) n (GLsizei : %i) bufs (const GLenum* : %p)\n", ctx, n, bufs);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_buffers_ARB(ctx, n, bufs);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_shader_info_log: %i", err);
		
		MACH_OVERRIDE(void,get_program_info_log,(GLIContext ctx, GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog), err ) {
			SC2::Utilities::file_log("get_program_info_log called: ctx (GLIContext : %p) program (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) infoLog (GLchar* : %p)\n", ctx, program, bufSize, length, infoLog);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_info_log: %i", err);
		
		MACH_OVERRIDE(void,stencil_func_separate,(GLIContext ctx, GLenum face, GLenum func, GLint ref, GLuint mask), err ) {
			SC2::Utilities::file_log("stencil_func_separate called: ctx (GLIContext : %p) face (GLenum : %s) func (GLenum : %s) ref (GLint : %i) mask (GLuint : %u)\n", ctx, GLenumToString(face).c_str(), GLenumToString(func).c_str(), ref, mask);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override stencil_func_separate: %i", err);
		
		MACH_OVERRIDE(void,stencil_mask_separate,(GLIContext ctx, GLenum face, GLuint mask), err ) {
			SC2::Utilities::file_log("stencil_mask_separate called: ctx (GLIContext : %p) face (GLenum : %s) mask (GLuint : %u)\n", ctx, GLenumToString(face).c_str(), mask);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override stencil_mask_separate: %i", err);
		...
		MACH_OVERRIDE(void,multi_draw_element_array_APPLE,(GLIContext ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount), err ) {
			SC2::Utilities::file_log("multi_draw_element_array_APPLE called: ctx (GLIContext : %p) mode (GLenum : %s) first (const GLint* : %p) count (const GLsizei* : %p) primcount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), first, count, primcount);
			opengl_api_mutex.lock();
			OpenGL::Shared->multi_draw_element_array_APPLE(ctx, mode, first, count, primcount);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override multi_draw_element_array_APPLE: %i", err);
		...
		MACH_OVERRIDE(void,multi_draw_range_element_array_APPLE,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, const GLint *first, const GLsizei *count, GLsizei primcount), err ) {
			SC2::Utilities::file_log("multi_draw_range_element_array_APPLE called: ctx (GLIContext : %p) mode (GLenum : %s) start (GLuint : %u) end (GLuint : %u) first (const GLint* : %p) count (const GLsizei* : %p) primcount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), start, end, first, count, primcount);
			opengl_api_mutex.lock();
			OpenGL::Shared->multi_draw_range_element_array_APPLE(ctx, mode, start, end, first, count, primcount);			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override multi_draw_range_element_array_APPLE: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_renderbuffer_EXT,(GLIContext ctx, GLuint renderbuffer), err ) {
			SC2::Utilities::file_log("is_renderbuffer_EXT called: ctx (GLIContext : %p) renderbuffer (GLuint : %u)\n", ctx, renderbuffer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_renderbuffer_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_renderbuffer_EXT,(GLIContext ctx, GLenum target, GLuint renderbuffer), err ) {
			SC2::Utilities::file_log("bind_renderbuffer_EXT called: ctx (GLIContext : %p) target (GLenum : %s) renderbuffer (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), renderbuffer);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_renderbuffer_EXT(ctx, target, renderbuffer);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_renderbuffer_EXT: %i", err);
		
		MACH_OVERRIDE(void,delete_renderbuffers_EXT,(GLIContext ctx, GLsizei n, const GLuint *renderbuffers), err ) {
			SC2::Utilities::file_log("delete_renderbuffers_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) renderbuffers (const GLuint* : %p)\n", ctx, n, renderbuffers);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_renderbuffers_EXT: %i", err);
		
		MACH_OVERRIDE(void,gen_renderbuffers_EXT,(GLIContext ctx, GLsizei n, GLuint *renderbuffers), err ) {
			SC2::Utilities::file_log("gen_renderbuffers_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) renderbuffers (GLuint* : %p)\n", ctx, n, renderbuffers);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override gen_renderbuffers_EXT: %i", err);
		...
		MACH_OVERRIDE(void,renderbuffer_storage_EXT,(GLIContext ctx, GLenum target, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("renderbuffer_storage_EXT called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override renderbuffer_storage_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_renderbuffer_parameteriv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_renderbuffer_parameteriv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_renderbuffer_parameteriv_EXT: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_framebuffer_EXT,(GLIContext ctx, GLuint framebuffer), err ) {
			SC2::Utilities::file_log("is_framebuffer_EXT called: ctx (GLIContext : %p) framebuffer (GLuint : %u)\n", ctx, framebuffer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_framebuffer_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_framebuffer_EXT,(GLIContext ctx, GLenum target, GLuint framebuffer), err ) {
			SC2::Utilities::file_log("bind_framebuffer_EXT called: ctx (GLIContext : %p) target (GLenum : %s) framebuffer (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), framebuffer);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_framebuffer_EXT(ctx, target, framebuffer);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_framebuffer_EXT: %i", err);
		
		MACH_OVERRIDE(void,delete_framebuffers_EXT,(GLIContext ctx, GLsizei n, const GLuint *framebuffers), err ) {
			SC2::Utilities::file_log("delete_framebuffers_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) framebuffers (const GLuint* : %p)\n", ctx, n, framebuffers);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_framebuffers_EXT: %i", err);
		
		MACH_OVERRIDE(void,gen_framebuffers_EXT,(GLIContext ctx, GLsizei n, GLuint *framebuffers), err ) {
			SC2::Utilities::file_log("gen_framebuffers_EXT called: ctx (GLIContext : %p) n (GLsizei : %i) framebuffers (GLuint* : %p)\n", ctx, n, framebuffers);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override gen_framebuffers_EXT: %i", err);
		
		MACH_OVERRIDE(GLenum,check_framebuffer_status_EXT,(GLIContext ctx, GLenum target), err ) {
			SC2::Utilities::file_log("check_framebuffer_status_EXT called: ctx (GLIContext : %p) target (GLenum : %s)\n", ctx, GLenumToString(target).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override check_framebuffer_status_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_texture1D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level), err ) {
			SC2::Utilities::file_log("framebuffer_texture1D_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) textarget (GLenum : %s) texture (GLuint : %u) level (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), GLenumToString(textarget).c_str(), texture, level);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture1D_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_texture2D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level), err ) {
			SC2::Utilities::file_log("framebuffer_texture2D_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) textarget (GLenum : %s) texture (GLuint : %u) level (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), GLenumToString(textarget).c_str(), texture, level);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture2D_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_texture3D_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset), err ) {
			SC2::Utilities::file_log("framebuffer_texture3D_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) textarget (GLenum : %s) texture (GLuint : %u) level (GLint : %i) zoffset (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), GLenumToString(textarget).c_str(), texture, level, zoffset);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture3D_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_renderbuffer_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer), err ) {
			SC2::Utilities::file_log("framebuffer_renderbuffer_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) renderbuffertarget (GLenum : %s) renderbuffer (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), GLenumToString(renderbuffertarget).c_str(), renderbuffer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_renderbuffer_EXT: %i", err);
		...
		MACH_OVERRIDE(void,get_framebuffer_attachment_parameteriv_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_framebuffer_attachment_parameteriv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_framebuffer_attachment_parameteriv_EXT: %i", err);
		
		MACH_OVERRIDE(void,generate_mipmap_EXT,(GLIContext ctx, GLenum target), err ) {
			SC2::Utilities::file_log("generate_mipmap_EXT called: ctx (GLIContext : %p) target (GLenum : %s)\n", ctx, GLenumToString(target).c_str());
			return generate_mipmap_EXT_reenter(ctx, target);
		} END_MACH_OVERRIDE_PTR(generate_mipmap_EXT, obj->disp.generate_mipmap_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override generate_mipmap_EXT: %i", err);
		
		MACH_OVERRIDE(void,buffer_parameteri_APPLE,(GLIContext ctx, GLenum target, GLenum pname, GLint param), err ) {
			SC2::Utilities::file_log("buffer_parameteri_APPLE called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) param (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override buffer_parameteri_APPLE: %i", err);
		
		MACH_OVERRIDE(void,flush_mapped_buffer_range_APPLE,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr size), err ) {
			SC2::Utilities::file_log("flush_mapped_buffer_range_APPLE called: ctx (GLIContext : %p) target (GLenum : %s) offset (GLintptr : %p) size (GLsizeiptr : %p)\n", ctx, GLenumToString(target).c_str(), offset, size);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override flush_mapped_buffer_range_APPLE: %i", err);
		...
		MACH_OVERRIDE(void,program_env_parameters4fv_EXT,(GLIContext ctx, GLenum target, GLuint index, GLsizei count, const GLfloat *params), err ) {
			...
			opengl_api_mutex.lock();
			OpenGL::Shared->program_env_parameters4fv_EXT(ctx, target, index, count, params);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_env_parameters4fv_EXT: %i", err);
		...
		MACH_OVERRIDE(void,program_local_parameters4fv_EXT,(GLIContext ctx, GLenum target, GLuint index, GLsizei count, const GLfloat *params), err ) {
			SC2::Utilities::file_log("program_local_parameters4fv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) count (GLsizei : %i) params (const GLfloat* : %p)\n", ctx, GLenumToString(target).c_str(), index, count, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_local_parameters4fv_EXT: %i", err);
		
		MACH_OVERRIDE(GLenum,object_purgeable_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum option), err ) {
			SC2::Utilities::file_log("object_purgeable_APPLE called: ctx (GLIContext : %p) objectType (GLenum : %s) name (GLuint : %u) option (GLenum : %s)\n", ctx, GLenumToString(objectType).c_str(), name, GLenumToString(option).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override object_purgeable_APPLE: %i", err);
		
		MACH_OVERRIDE(GLenum,object_unpurgeable_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum option), err ) {
			SC2::Utilities::file_log("object_unpurgeable_APPLE called: ctx (GLIContext : %p) objectType (GLenum : %s) name (GLuint : %u) option (GLenum : %s)\n", ctx, GLenumToString(objectType).c_str(), name, GLenumToString(option).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override object_unpurgeable_APPLE: %i", err);
		...
		MACH_OVERRIDE(void,get_object_parameteriv_APPLE,(GLIContext ctx, GLenum objectType, GLuint name, GLenum pname, GLint* params), err ) {
			SC2::Utilities::file_log("get_object_parameteriv_APPLE called: ctx (GLIContext : %p) objectType (GLenum : %s) name (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(objectType).c_str(), name, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_object_parameteriv_APPLE: %i", err);
		
		MACH_OVERRIDE(void,program_parameteri_EXT,(GLIContext ctx, GLuint program_name, GLenum pname, GLint value), err ) {
			SC2::Utilities::file_log("program_parameteri_EXT called: ctx (GLIContext : %p) program_name (GLuint : %u) pname (GLenum : %s) value (GLint : %i)\n", ctx, program_name, GLenumToString(pname).c_str(), value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_parameteri_EXT: %i", err);
		
		MACH_OVERRIDE(void,framebuffer_texture_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level), err ) {
			SC2::Utilities::file_log("framebuffer_texture_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) texture (GLuint : %u) level (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), texture, level);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_texture_layer_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer), err ) {
			SC2::Utilities::file_log("framebuffer_texture_layer_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) texture (GLuint : %u) level (GLint : %i) layer (GLint : %i)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), texture, level, layer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture_layer_EXT: %i", err);
		...
		MACH_OVERRIDE(void,framebuffer_texture_face_EXT,(GLIContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLenum face), err ) {
			SC2::Utilities::file_log("framebuffer_texture_face_EXT called: ctx (GLIContext : %p) target (GLenum : %s) attachment (GLenum : %s) texture (GLuint : %u) level (GLint : %i) face (GLenum : %s)\n", ctx, GLenumToString(target).c_str(), GLenumToString(attachment).c_str(), texture, level, GLenumToString(face).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override framebuffer_texture_face_EXT: %i", err);
		...
		MACH_OVERRIDE(void,bind_buffer_range_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size), err ) {
			SC2::Utilities::file_log("bind_buffer_range_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) buffer (GLuint : %u) offset (GLintptr : %p) size (GLsizeiptr : %p)\n", ctx, GLenumToString(target).c_str(), index, buffer, offset, size);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_buffer_range_EXT(ctx, target, index, buffer, offset, size);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_buffer_range_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_buffer_offset_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer, GLintptr offset), err ) {
			SC2::Utilities::file_log("bind_buffer_offset_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) buffer (GLuint : %u) offset (GLintptr : %p)\n", ctx, GLenumToString(target).c_str(), index, buffer, offset);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_buffer_offset_EXT(ctx, target, index, buffer, offset);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_buffer_offset_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_buffer_base_EXT,(GLIContext ctx, GLenum target, GLuint index, GLuint buffer), err ) {
			SC2::Utilities::file_log("bind_buffer_base_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) buffer (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), index, buffer);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_buffer_base_EXT(ctx, target, index, buffer);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_buffer_base_EXT: %i", err);
		
		MACH_OVERRIDE(void,begin_transform_feedback_EXT,(GLIContext ctx, GLenum primitiveMode), err ) {
			SC2::Utilities::file_log("begin_transform_feedback_EXT called: ctx (GLIContext : %p) primitiveMode (GLenum : %s)\n", ctx, GLenumToString(primitiveMode).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override begin_transform_feedback_EXT: %i", err);
		
		MACH_OVERRIDE(void,end_transform_feedback_EXT,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("end_transform_feedback_EXT called: ctx (GLIContext : %p)\n", ctx);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override end_transform_feedback_EXT: %i", err);
		...
		MACH_OVERRIDE(void,transform_feedback_varyings_EXT,(GLIContext ctx, GLuint program, GLsizei count, const GLchar* const *varyings, GLenum bufferMode), err ) {
			SC2::Utilities::file_log("transform_feedback_varyings_EXT called: ctx (GLIContext : %p) program (GLuint : %u) count (GLsizei : %i) varyings (const GLchar*const* : %p) bufferMode (GLenum : %s)\n", ctx, program, count, varyings, GLenumToString(bufferMode).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override transform_feedback_varyings_EXT: %i", err);
		...
		MACH_OVERRIDE(void,get_transform_feedback_varying_EXT,(GLIContext ctx, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLsizei *size, GLenum *type, GLchar *name), err ) {
			SC2::Utilities::file_log("get_transform_feedback_varying_EXT called: ctx (GLIContext : %p) program (GLuint : %u) index (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) size (GLsizei* : %p) type (GLenum* : %p) name (GLchar* : %p)\n", ctx, program, index, bufSize, length, size, type, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_transform_feedback_varying_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_integer_indexedv_EXT,(GLIContext ctx, GLenum param, GLuint index, GLint *values), err ) {
			SC2::Utilities::file_log("get_integer_indexedv_EXT called: ctx (GLIContext : %p) param (GLenum : %s) index (GLuint : %u) values (GLint* : %p)\n", ctx, GLenumToString(param).c_str(), index, values);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_integer_indexedv_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_boolean_indexedv_EXT,(GLIContext ctx, GLenum param, GLuint index, GLboolean *values), err ) {
			SC2::Utilities::file_log("get_boolean_indexedv_EXT called: ctx (GLIContext : %p) param (GLenum : %s) index (GLuint : %u) values (GLboolean* : %p)\n", ctx, GLenumToString(param).c_str(), index, values);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_boolean_indexedv_EXT: %i", err);
		
		MACH_OVERRIDE(void,uniform_buffer_EXT,(GLIContext ctx, GLuint program, GLint location, GLuint buffer), err ) {
			SC2::Utilities::file_log("uniform_buffer_EXT called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) buffer (GLuint : %u)\n", ctx, program, location, buffer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_buffer_EXT: %i", err);
		
		MACH_OVERRIDE(GLint,get_uniform_buffer_size_EXT,(GLIContext ctx, GLuint program, GLint location), err ) {
			SC2::Utilities::file_log("get_uniform_buffer_size_EXT called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i)\n", ctx, program, location);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_buffer_size_EXT: %i", err);
		
		MACH_OVERRIDE(GLintptr,get_uniform_buffer_offset_EXT,(GLIContext ctx, GLuint program, GLint location), err ) {
			SC2::Utilities::file_log("get_uniform_buffer_offset_EXT called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i)\n", ctx, program, location);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_buffer_offset_EXT: %i", err);
		
		MACH_OVERRIDE(void,clear_colorIi_EXT,(GLIContext ctx, GLint r, GLint g, GLint b, GLint a ), err ) {
			SC2::Utilities::file_log("clear_colorIi_EXT called: ctx (GLIContext : %p) r (GLint : %i) g (GLint : %i) b (GLint : %i) a (GLint : %i)\n", ctx, r, g, b, a);
			return clear_colorIi_EXT_reenter(ctx, r, g, b, a);
		} END_MACH_OVERRIDE_PTR(clear_colorIi_EXT, obj->disp.clear_colorIi_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override clear_colorIi_EXT: %i", err);
		
		MACH_OVERRIDE(void,clear_colorIui_EXT,(GLIContext ctx, GLuint r, GLuint g, GLuint b, GLuint a ), err ) {
			SC2::Utilities::file_log("clear_colorIui_EXT called: ctx (GLIContext : %p) r (GLuint : %u) g (GLuint : %u) b (GLuint : %u) a (GLuint : %u)\n", ctx, r, g, b, a);
			return clear_colorIui_EXT_reenter(ctx, r, g, b, a);
		} END_MACH_OVERRIDE_PTR(clear_colorIui_EXT, obj->disp.clear_colorIui_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override clear_colorIui_EXT: %i", err);
		
		MACH_OVERRIDE(void,tex_parameterIiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params ), err ) {
			SC2::Utilities::file_log("tex_parameterIiv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_parameterIiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,tex_parameterIuiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLuint *params ), err ) {
			SC2::Utilities::file_log("tex_parameterIuiv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLuint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_parameterIuiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_tex_parameterIiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_tex_parameterIiv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_parameterIiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_tex_parameterIuiv_EXT,(GLIContext ctx, GLenum target, GLenum pname, GLuint *params), err ) {
			SC2::Utilities::file_log("get_tex_parameterIuiv_EXT called: ctx (GLIContext : %p) target (GLenum : %s) pname (GLenum : %s) params (GLuint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_tex_parameterIuiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI1i_EXT,(GLIContext ctx, GLuint index, GLint x), err ) {
			SC2::Utilities::file_log("vertex_attribI1i_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLint : %i)\n", ctx, index, x);
			return vertex_attribI1i_EXT_reenter(ctx, index, x);
		} END_MACH_OVERRIDE_PTR(vertex_attribI1i_EXT, obj->disp.vertex_attribI1i_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI1i_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI2i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y), err ) {
			SC2::Utilities::file_log("vertex_attribI2i_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLint : %i) y (GLint : %i)\n", ctx, index, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI2i_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI3i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y, GLint z), err ) {
			SC2::Utilities::file_log("vertex_attribI3i_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLint : %i) y (GLint : %i) z (GLint : %i)\n", ctx, index, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI3i_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4i_EXT,(GLIContext ctx, GLuint index, GLint x, GLint y, GLint z, GLint w), err ) {
			SC2::Utilities::file_log("vertex_attribI4i_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLint : %i) y (GLint : %i) z (GLint : %i) w (GLint : %i)\n", ctx, index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4i_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI1ui_EXT,(GLIContext ctx, GLuint index, GLuint x), err ) {
			SC2::Utilities::file_log("vertex_attribI1ui_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLuint : %u)\n", ctx, index, x);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI1ui_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI2ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y), err ) {
			SC2::Utilities::file_log("vertex_attribI2ui_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLuint : %u) y (GLuint : %u)\n", ctx, index, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI2ui_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI3ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y, GLuint z), err ) {
			SC2::Utilities::file_log("vertex_attribI3ui_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLuint : %u) y (GLuint : %u) z (GLuint : %u)\n", ctx, index, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI3ui_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4ui_EXT,(GLIContext ctx, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w), err ) {
			SC2::Utilities::file_log("vertex_attribI4ui_EXT called: ctx (GLIContext : %p) index (GLuint : %u) x (GLuint : %u) y (GLuint : %u) z (GLuint : %u) w (GLuint : %u)\n", ctx, index, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4ui_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI1iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI1iv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI1iv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI2iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI2iv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI2iv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI3iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI3iv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI3iv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4iv_EXT,(GLIContext ctx, GLuint index, const GLint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4iv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4iv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI1uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI1uiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI1uiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI2uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI2uiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI2uiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI3uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI3uiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI3uiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4uiv_EXT,(GLIContext ctx, GLuint index, const GLuint *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4uiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLuint* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4uiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4bv_EXT,(GLIContext ctx, GLuint index, const GLbyte *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4bv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLbyte* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4bv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4sv_EXT,(GLIContext ctx, GLuint index, const GLshort *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4sv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLshort* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4sv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4ubv_EXT,(GLIContext ctx, GLuint index, const GLubyte *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4ubv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLubyte* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4ubv_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribI4usv_EXT,(GLIContext ctx, GLuint index, const GLushort *v), err ) {
			SC2::Utilities::file_log("vertex_attribI4usv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) v (const GLushort* : %p)\n", ctx, index, v);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI4usv_EXT: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attribI_pointer_EXT,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("vertex_attribI_pointer_EXT called: ctx (GLIContext : %p) index (GLuint : %u) size (GLint : %i) type (GLenum : %s) stride (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, index, size, GLenumToString(type).c_str(), stride, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribI_pointer_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attribIiv_EXT,(GLIContext ctx, GLuint index, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_vertex_attribIiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attribIiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attribIuiv_EXT,(GLIContext ctx, GLuint index, GLenum pname, GLuint *params), err ) {
			SC2::Utilities::file_log("get_vertex_attribIuiv_EXT called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLuint* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniformuiv_EXT: %i", err);
		
		MACH_OVERRIDE(void,bind_frag_data_location_EXT,(GLIContext ctx, GLuint program, GLuint colorNumber, const GLchar *name), err ) {
			SC2::Utilities::file_log("bind_frag_data_location_EXT called: ctx (GLIContext : %p) program (GLuint : %u) colorNumber (GLuint : %u) name (const GLchar* : %p)\n", ctx, program, colorNumber, name);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_frag_data_location_EXT(ctx, program, colorNumber, name);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_frag_data_location_EXT: %i", err);
		
		MACH_OVERRIDE(GLint,get_frag_data_location_EXT,(GLIContext ctx, GLuint program, const GLchar *name), err ) {
			SC2::Utilities::file_log("get_frag_data_location_EXT called: ctx (GLIContext : %p) program (GLuint : %u) name (const GLchar* : %p)\n", ctx, program, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_frag_data_location_EXT: %i", err);
		...
		MACH_OVERRIDE(void,color_mask_indexed_EXT,(GLIContext ctx, GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a), err ) {
			SC2::Utilities::file_log("color_mask_indexed_EXT called: ctx (GLIContext : %p) index (GLuint : %u) r (GLboolean : %i) g (GLboolean : %i) b (GLboolean : %i) a (GLboolean : %i)\n", ctx, index, r, g, b, a);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override color_mask_indexed_EXT: %i", err);
		
		MACH_OVERRIDE(void,enable_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			SC2::Utilities::file_log("enable_indexed_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), index);
			return enable_indexed_EXT_reenter(ctx, target, index);
		} END_MACH_OVERRIDE_PTR(enable_indexed_EXT, obj->disp.enable_indexed_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override enable_indexed_EXT: %i", err);
		
		MACH_OVERRIDE(void,disable_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			SC2::Utilities::file_log("disable_indexed_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), index);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override disable_indexed_EXT: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_enabled_indexed_EXT,(GLIContext ctx, GLenum target, GLuint index), err ) {
			SC2::Utilities::file_log("is_enabled_indexed_EXT called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), index);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_enabled_indexed_EXT: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix2x3fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2x3fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2x3fv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3x2fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3x2fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3x2fv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix2x4fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2x4fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2x4fv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4x2fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4x2fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix4x2fv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3x4fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3x4fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3x4fv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4x3fv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4x3fv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix4x3fv: %i", err);
		...
		MACH_OVERRIDE(void,blit_framebuffer_EXT,(GLIContext ctx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter), err ) {
			SC2::Utilities::file_log("blit_framebuffer_EXT called: ctx (GLIContext : %p) srcX0 (GLint : %i) srcY0 (GLint : %i) srcX1 (GLint : %i) srcY1 (GLint : %i) dstX0 (GLint : %i) dstY0 (GLint : %i) dstX1 (GLint : %i) dstY1 (GLint : %i) mask (GLbitfield : %u) filter (GLenum : %s)\n", ctx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, GLenumToString(filter).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override blit_framebuffer_EXT: %i", err);
		...
		MACH_OVERRIDE(void,renderbuffer_storage_multisample_EXT,(GLIContext ctx, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("renderbuffer_storage_multisample_EXT called: ctx (GLIContext : %p) target (GLenum : %s) samples (GLsizei : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), samples, GLenumToString(internalformat).c_str(), width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override renderbuffer_storage_multisample_EXT: %i", err);
		
		MACH_OVERRIDE(void,begin_conditional_render_NV,(GLIContext ctx, GLuint id, GLenum mode), err ) {
			SC2::Utilities::file_log("begin_conditional_render_NV called: ctx (GLIContext : %p) id (GLuint : %u) mode (GLenum : %s)\n", ctx, id, GLenumToString(mode).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override begin_conditional_render_NV: %i", err);
		
		MACH_OVERRIDE(void,end_conditional_render_NV,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("end_conditional_render_NV called: ctx (GLIContext : %p)\n", ctx);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override end_conditional_render_NV: %i", err);
		
		MACH_OVERRIDE(void,get_attached_shaders,(GLIContext ctx, GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders), err ) {
			SC2::Utilities::file_log("get_attached_shaders called: ctx (GLIContext : %p) program (GLuint : %u) maxCount (GLsizei : %i) count (GLsizei* : %p) shaders (GLuint* : %p)\n", ctx, program, maxCount, count, shaders);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_attached_shaders: %i", err);
		
		MACH_OVERRIDE(void,provoking_vertex_EXT,(GLIContext ctx, GLenum mode), err ) {
			SC2::Utilities::file_log("provoking_vertex_EXT called: ctx (GLIContext : %p) mode (GLenum : %s)\n", ctx, GLenumToString(mode).c_str());
			return provoking_vertex_EXT_reenter(ctx, mode);
		} END_MACH_OVERRIDE_PTR(provoking_vertex_EXT, obj->disp.provoking_vertex_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override provoking_vertex_EXT: %i", err);
		
		MACH_OVERRIDE(void,vertex_attrib_divisor,(GLIContext ctx, GLuint index, GLuint divisor), err ) {
			SC2::Utilities::file_log("vertex_attrib_divisor called: ctx (GLIContext : %p) index (GLuint : %u) divisor (GLuint : %u)\n", ctx, index, divisor);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib_divisor: %i", err);
		
		MACH_OVERRIDE(void,draw_arrays_instanced,(GLIContext ctx, GLenum mode, GLint first, GLsizei count, GLsizei instancecount), err ) {
			SC2::Utilities::file_log("draw_arrays_instanced called: ctx (GLIContext : %p) mode (GLenum : %s) first (GLint : %i) count (GLsizei : %i) instancecount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), first, count, instancecount);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_arrays_instanced(ctx, mode, first, count, instancecount);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_arrays_instanced: %i", err);
		...
		MACH_OVERRIDE(void,draw_elements_instanced,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount), err ) {
			SC2::Utilities::file_log("draw_elements_instanced called: ctx (GLIContext : %p) mode (GLenum : %s) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p) instancecount (GLsizei : %i)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices, instancecount);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_elements_instanced(ctx, mode, count, type, indices, instancecount);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_elements_instanced: %i", err);
		...
		MACH_OVERRIDE(void,draw_elements_base_vertex,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint base_vertex), err ) {
			SC2::Utilities::file_log("draw_elements_base_vertex called: ctx (GLIContext : %p) mode (GLenum : %s) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p) base_vertex (GLint : %i)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices, base_vertex);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_elements_base_vertex(ctx, mode, count, type, indices, base_vertex);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_elements_base_vertex: %i", err);
		...
		MACH_OVERRIDE(void,draw_range_elements_base_vertex,(GLIContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint base_vertex), err ) {
			SC2::Utilities::file_log("draw_range_elements_base_vertex called: ctx (GLIContext : %p) mode (GLenum : %s) start (GLuint : %u) end (GLuint : %u) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p) base_vertex (GLint : %i)\n", ctx, GLenumToString(mode).c_str(), start, end, count, GLenumToString(type).c_str(), indices, base_vertex);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_range_elements_base_vertex(ctx, mode, start, end, count, type, indices, base_vertex);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_range_elements_base_vertex: %i", err);
		...
		MACH_OVERRIDE(void,draw_elements_instanced_base_vertex,(GLIContext ctx, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount, GLint base_vertex), err ) {
			SC2::Utilities::file_log("draw_elements_instanced_base_vertex called: ctx (GLIContext : %p) mode (GLenum : %s) count (GLsizei : %i) type (GLenum : %s) indices (const GLvoid* : %p) instancecount (GLsizei : %i) base_vertex (GLint : %i)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices, instancecount, base_vertex);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_elements_instanced_base_vertex(ctx, mode, count, type, indices, instancecount, base_vertex);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_elements_instanced_base_vertex: %i", err);
		...
		MACH_OVERRIDE(void,multi_draw_elements_base_vertex,(GLIContext ctx, GLenum mode, const GLsizei *count, GLenum type, const GLvoid* const *indices, GLsizei drawcount, const GLint *base_vertex), err ) {
			SC2::Utilities::file_log("multi_draw_elements_base_vertex called: ctx (GLIContext : %p) mode (GLenum : %s) count (const GLsizei* : %p) type (GLenum : %s) indices (const GLvoid*const* : %p) drawcount (GLsizei : %i) base_vertex (const GLint* : %p)\n", ctx, GLenumToString(mode).c_str(), count, GLenumToString(type).c_str(), indices, drawcount, base_vertex);
			opengl_api_mutex.lock();
			OpenGL::Shared->multi_draw_elements_base_vertex(ctx, mode, count, type, indices, drawcount, base_vertex);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override multi_draw_elements_base_vertex: %i", err);
		
		MACH_OVERRIDE(void,bind_vertex_array_ARB,(GLIContext ctx, GLuint array), err ) {
			SC2::Utilities::file_log("bind_vertex_array_ARB called: ctx (GLIContext : %p) array (GLuint : %u)\n", ctx, array);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_vertex_array_ARB(ctx, array);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_vertex_array_ARB: %i", err);
		
		MACH_OVERRIDE(void,delete_vertex_arrays_ARB,(GLIContext ctx, GLsizei n, const GLuint *arrays), err ) {
			SC2::Utilities::file_log("delete_vertex_arrays_ARB called: ctx (GLIContext : %p) n (GLsizei : %i) arrays (const GLuint* : %p)\n", ctx, n, arrays);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_vertex_arrays_ARB: %i", err);
		
		MACH_OVERRIDE(void,gen_vertex_arrays_ARB,(GLIContext ctx, GLsizei n, GLuint *arrays), err ) {
			SC2::Utilities::file_log("gen_vertex_arrays_ARB called: ctx (GLIContext : %p) n (GLsizei : %i) arrays (GLuint* : %p)\n", ctx, n, arrays);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override gen_vertex_arrays_ARB: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_vertex_array_ARB,(GLIContext ctx, GLuint array), err ) {
			SC2::Utilities::file_log("is_vertex_array_ARB called: ctx (GLIContext : %p) array (GLuint : %u)\n", ctx, array);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_vertex_array_ARB: %i", err);
		
		MACH_OVERRIDE(void,point_size_pointer,(GLIContext ctx, GLenum type, GLsizei stride, const GLvoid *pointer), err ) {
			SC2::Utilities::file_log("point_size_pointer called: ctx (GLIContext : %p) type (GLenum : %s) stride (GLsizei : %i) pointer (const GLvoid* : %p)\n", ctx, GLenumToString(type).c_str(), stride, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override point_size_pointer: %i", err);
		
		MACH_OVERRIDE(void,vertex_point_sizef_APPLE,(GLIContext ctx, GLfloat size), err ) {
			SC2::Utilities::file_log("vertex_point_sizef_APPLE called: ctx (GLIContext : %p) size (GLfloat : %f)\n", ctx, size);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override client_wait_sync: %i", err);
		
		MACH_OVERRIDE(void,wait_sync,(GLIContext ctx, GLsync sync, GLbitfield flags, GLuint64 timeout), err ) {
			SC2::Utilities::file_log("wait_sync called: ctx (GLIContext : %p) sync (GLsync : %p) flags (GLbitfield : %u) timeout (GLuint64 : %u)\n", ctx, sync, flags, timeout);
			return wait_sync_reenter(ctx, sync, flags, timeout);
		} END_MACH_OVERRIDE_PTR(wait_sync, obj->disp.wait_sync);
		
		if (err)
			SC2::Utilities::console_log("Failed to override wait_sync: %i", err);
		
		MACH_OVERRIDE(void,get_integer64v_sync,(GLIContext ctx, GLenum pname, GLint64 *params), err ) {
			SC2::Utilities::file_log("get_integer64v_sync called: ctx (GLIContext : %p) pname (GLenum : %s) params (GLint64* : %p)\n", ctx, GLenumToString(pname).c_str(), params);
		...
		MACH_OVERRIDE(void,tex_image2D_multisample,(GLIContext ctx, GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations), err ) {
			SC2::Utilities::file_log("tex_image2D_multisample called: ctx (GLIContext : %p) target (GLenum : %s) samples (GLsizei : %i) internalformat (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) fixedsamplelocations (GLboolean : %i)\n", ctx, GLenumToString(target).c_str(), samples, internalformat, width, height, fixedsamplelocations);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_image2D_multisample: %i", err);
		...
		MACH_OVERRIDE(void,tex_image3D_multisample,(GLIContext ctx, GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations), err ) {
			SC2::Utilities::file_log("tex_image3D_multisample called: ctx (GLIContext : %p) target (GLenum : %s) samples (GLsizei : %i) internalformat (GLint : %i) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i) fixedsamplelocations (GLboolean : %i)\n", ctx, GLenumToString(target).c_str(), samples, internalformat, width, height, depth, fixedsamplelocations);
		...
		MACH_OVERRIDE(void,copy_buffer_sub_data,(GLIContext ctx, GLenum readtarget, GLenum writetarget, GLintptr readoffset, GLintptr writeoffset, GLsizeiptr size), err ) {
			SC2::Utilities::file_log("copy_buffer_sub_data called: ctx (GLIContext : %p) readtarget (GLenum : %s) writetarget (GLenum : %s) readoffset (GLintptr : %p) writeoffset (GLintptr : %p) size (GLsizeiptr : %p)\n", ctx, GLenumToString(readtarget).c_str(), GLenumToString(writetarget).c_str(), readoffset, writeoffset, size);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override copy_buffer_sub_data: %i", err);
		
		MACH_OVERRIDE(void,primitive_restart_index,(GLIContext ctx, GLuint index), err ) {
			SC2::Utilities::file_log("primitive_restart_index called: ctx (GLIContext : %p) index (GLuint : %u)\n", ctx, index);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override primitive_restart_index: %i", err);
		
		MACH_OVERRIDE(void,get_query_objecti64v,(GLIContext ctx, GLuint id, GLenum pname, GLint64EXT *params), err ) {
			SC2::Utilities::file_log("get_query_objecti64v called: ctx (GLIContext : %p) id (GLuint : %u) pname (GLenum : %s) params (GLint64EXT* : %p)\n", ctx, id, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_query_objecti64v: %i", err);
		
		MACH_OVERRIDE(void,get_query_objectui64v,(GLIContext ctx, GLuint id, GLenum pname, GLuint64EXT *params), err ) {
			SC2::Utilities::file_log("get_query_objectui64v called: ctx (GLIContext : %p) id (GLuint : %u) pname (GLenum : %s) params (GLuint64EXT* : %p)\n", ctx, id, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_query_objectui64v: %i", err);
		
		MACH_OVERRIDE(GLvoid,map_buffer_range,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr length, GLenum access), err ) {
			SC2::Utilities::file_log("map_buffer_range called: ctx (GLIContext : %p) target (GLenum : %s) offset (GLintptr : %p) length (GLsizeiptr : %p) access (GLenum : %s)\n", ctx, GLenumToString(target).c_str(), offset, length, GLenumToString(access).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override map_buffer_range: %i", err);
		
		MACH_OVERRIDE(void,flush_mapped_buffer_range,(GLIContext ctx, GLenum target, GLintptr offset, GLsizeiptr length), err ) {
			SC2::Utilities::file_log("flush_mapped_buffer_range called: ctx (GLIContext : %p) target (GLenum : %s) offset (GLintptr : %p) length (GLsizeiptr : %p)\n", ctx, GLenumToString(target).c_str(), offset, length);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_buffer_parameteri64v: %i", err);
		
		MACH_OVERRIDE(void,gen_samplers,(GLIContext ctx, GLsizei count, GLuint *samplers), err ) {
			SC2::Utilities::file_log("gen_samplers called: ctx (GLIContext : %p) count (GLsizei : %i) samplers (GLuint* : %p)\n", ctx, count, samplers);
			return gen_samplers_reenter(ctx, count, samplers);
		} END_MACH_OVERRIDE_PTR(gen_samplers, obj->disp.gen_samplers);
		
		if (err)
			SC2::Utilities::console_log("Failed to override gen_samplers: %i", err);
		
		MACH_OVERRIDE(void,delete_samplers,(GLIContext ctx, GLsizei count, const GLuint *samplers), err ) {
			SC2::Utilities::file_log("delete_samplers called: ctx (GLIContext : %p) count (GLsizei : %i) samplers (const GLuint* : %p)\n", ctx, count, samplers);
			return delete_samplers_reenter(ctx, count, samplers);
		} END_MACH_OVERRIDE_PTR(delete_samplers, obj->disp.delete_samplers);
		
		if (err)
			SC2::Utilities::console_log("Failed to override delete_samplers: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_sampler,(GLIContext ctx, GLuint sampler), err ) {
			SC2::Utilities::file_log("is_sampler called: ctx (GLIContext : %p) sampler (GLuint : %u)\n", ctx, sampler);
			GLboolean result = is_sampler_reenter(ctx, sampler);
			return result;
		} END_MACH_OVERRIDE_PTR(is_sampler, obj->disp.is_sampler);
		
		if (err)
			SC2::Utilities::console_log("Failed to override is_sampler: %i", err);
		
		MACH_OVERRIDE(void,bind_sampler,(GLIContext ctx, GLuint unit, GLuint sampler), err ) {
			SC2::Utilities::file_log("bind_sampler called: ctx (GLIContext : %p) unit (GLuint : %u) sampler (GLuint : %u)\n", ctx, unit, sampler);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_sampler(ctx, unit, sampler);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_sampler: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameteri,(GLIContext ctx, GLuint sampler, GLenum pname, GLint param), err ) {
			SC2::Utilities::file_log("sampler_parameteri called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (GLint : %i)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameteri: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameteriv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLint *param), err ) {
			SC2::Utilities::file_log("sampler_parameteriv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (const GLint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameterf,(GLIContext ctx, GLuint sampler, GLenum pname, GLfloat param), err ) {
			SC2::Utilities::file_log("sampler_parameterf called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (GLfloat : %f)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameterf: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameterfv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLfloat *param), err ) {
			SC2::Utilities::file_log("sampler_parameterfv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (const GLfloat* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameterIiv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLint *param), err ) {
			SC2::Utilities::file_log("sampler_parameterIiv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (const GLint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameterIiv: %i", err);
		
		MACH_OVERRIDE(void,sampler_parameterIuiv,(GLIContext ctx, GLuint sampler, GLenum pname, const GLuint *param), err ) {
			SC2::Utilities::file_log("sampler_parameterIuiv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) param (const GLuint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), param);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override sampler_parameterIuiv: %i", err);
		
		MACH_OVERRIDE(void,get_sampler_parameteriv,(GLIContext ctx, GLuint sampler, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_sampler_parameteriv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_sampler_parameteriv: %i", err);
		
		MACH_OVERRIDE(void,get_sampler_parameterfv,(GLIContext ctx, GLuint sampler, GLenum pname, GLfloat *params), err ) {
			SC2::Utilities::file_log("get_sampler_parameterfv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) params (GLfloat* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_sampler_parameterfv: %i", err);
		
		MACH_OVERRIDE(void,get_sampler_parameterIiv,(GLIContext ctx, GLuint sampler, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_sampler_parameterIiv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_sampler_parameterIiv: %i", err);
		
		MACH_OVERRIDE(void,get_sampler_parameterIuiv,(GLIContext ctx, GLuint sampler, GLenum pname, GLuint *params), err ) {
			SC2::Utilities::file_log("get_sampler_parameterIuiv called: ctx (GLIContext : %p) sampler (GLuint : %u) pname (GLenum : %s) params (GLuint* : %p)\n", ctx, sampler, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_sampler_parameterIuiv: %i", err);
		
		MACH_OVERRIDE(void,label_object_EXT,(GLIContext ctx, GLenum type, GLuint object, GLsizei length, const GLchar *label), err ) {
			SC2::Utilities::file_log("label_object_EXT called: ctx (GLIContext : %p) type (GLenum : %s) object (GLuint : %u) length (GLsizei : %i) label (const GLchar* : %p)\n", ctx, GLenumToString(type).c_str(), object, length, label);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override label_object_EXT: %i", err);
		...
		MACH_OVERRIDE(void,get_object_label_EXT,(GLIContext ctx, GLenum type, GLuint object, GLsizei bufSize, GLsizei *length, GLchar *label), err ) {
			SC2::Utilities::file_log("get_object_label_EXT called: ctx (GLIContext : %p) type (GLenum : %s) object (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) label (GLchar* : %p)\n", ctx, GLenumToString(type).c_str(), object, bufSize, length, label);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_object_label_EXT: %i", err);
		
		MACH_OVERRIDE(void,insert_event_marker_EXT,(GLIContext ctx, GLsizei length, const GLchar *marker), err ) {
			SC2::Utilities::file_log("insert_event_marker_EXT called: ctx (GLIContext : %p) length (GLsizei : %i) marker (const GLchar* : %p)\n", ctx, length, marker);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override insert_event_marker_EXT: %i", err);
		
		MACH_OVERRIDE(void,push_group_marker_EXT,(GLIContext ctx, GLsizei length, const GLchar *marker), err ) {
			SC2::Utilities::file_log("push_group_marker_EXT called: ctx (GLIContext : %p) length (GLsizei : %i) marker (const GLchar* : %p)\n", ctx, length, marker);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override push_group_marker_EXT: %i", err);
		
		MACH_OVERRIDE(void,pop_group_marker_EXT,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("pop_group_marker_EXT called: ctx (GLIContext : %p)\n", ctx);
			return pop_group_marker_EXT_reenter(ctx);
		} END_MACH_OVERRIDE_PTR(pop_group_marker_EXT, obj->disp.pop_group_marker_EXT);
		
		if (err)
			SC2::Utilities::console_log("Failed to override pop_group_marker_EXT: %i", err);
		
		MACH_OVERRIDE(void,use_program_stages,(GLIContext ctx, GLuint pipeline, GLbitfield stages, GLuint program), err ) {
			SC2::Utilities::file_log("use_program_stages called: ctx (GLIContext : %p) pipeline (GLuint : %u) stages (GLbitfield : %u) program (GLuint : %u)\n", ctx, pipeline, stages, program);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override use_program_stages: %i", err);
		
		MACH_OVERRIDE(void,active_shader_program,(GLIContext ctx, GLuint pipeline, GLuint program), err ) {
			SC2::Utilities::file_log("active_shader_program called: ctx (GLIContext : %p) pipeline (GLuint : %u) program (GLuint : %u)\n", ctx, pipeline, program);
			opengl_api_mutex.lock();
			OpenGL::Shared->active_shader_program(ctx, pipeline, program);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override active_shader_program: %i", err);
		
		MACH_OVERRIDE(GLuint,create_shader_programv,(GLIContext ctx, GLenum type, GLsizei count, const GLchar* const *strings), err ) {
			SC2::Utilities::file_log("create_shader_programv called: ctx (GLIContext : %p) type (GLenum : %s) count (GLsizei : %i) strings (const GLchar*const* : %p)\n", ctx, GLenumToString(type).c_str(), count, strings);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override create_shader_programv: %i", err);
		
		MACH_OVERRIDE(void,bind_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			SC2::Utilities::file_log("bind_program_pipeline called: ctx (GLIContext : %p) pipeline (GLuint : %u)\n", ctx, pipeline);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_program_pipeline(ctx, pipeline);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_program_pipeline: %i", err);
		
		MACH_OVERRIDE(void,delete_program_pipelines,(GLIContext ctx, GLsizei n, const GLuint *pipelines), err ) {
			SC2::Utilities::file_log("delete_program_pipelines called: ctx (GLIContext : %p) n (GLsizei : %i) pipelines (const GLuint* : %p)\n", ctx, n, pipelines);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_program_pipelines: %i", err);
		
		MACH_OVERRIDE(void,gen_program_pipelines,(GLIContext ctx, GLsizei n, GLuint *pipelines), err ) {
			SC2::Utilities::file_log("gen_program_pipelines called: ctx (GLIContext : %p) n (GLsizei : %i) pipelines (GLuint* : %p)\n", ctx, n, pipelines);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override gen_program_pipelines: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			SC2::Utilities::file_log("is_program_pipeline called: ctx (GLIContext : %p) pipeline (GLuint : %u)\n", ctx, pipeline);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_program_pipeline: %i", err);
		
		MACH_OVERRIDE(void,get_program_pipelineiv,(GLIContext ctx, GLuint pipeline, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_program_pipelineiv called: ctx (GLIContext : %p) pipeline (GLuint : %u) pname (GLenum : %s) params (GLint* : %p)\n", ctx, pipeline, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_pipelineiv: %i", err);
		
		MACH_OVERRIDE(void,validate_program_pipeline,(GLIContext ctx, GLuint pipeline), err ) {
			SC2::Utilities::file_log("validate_program_pipeline called: ctx (GLIContext : %p) pipeline (GLuint : %u)\n", ctx, pipeline);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override validate_program_pipeline: %i", err);
		...
		MACH_OVERRIDE(void,get_program_pipeline_info_log,(GLIContext ctx, GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog), err ) {
			SC2::Utilities::file_log("get_program_pipeline_info_log called: ctx (GLIContext : %p) pipeline (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) infoLog (GLchar* : %p)\n", ctx, pipeline, bufSize, length, infoLog);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_pipeline_info_log: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1i,(GLIContext ctx, GLuint program, GLint location, GLint x), err ) {
			SC2::Utilities::file_log("program_uniform1i called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLint : %i)\n", ctx, program, location, x);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1i: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y), err ) {
			SC2::Utilities::file_log("program_uniform2i called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLint : %i) y (GLint : %i)\n", ctx, program, location, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2i: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y, GLint z), err ) {
			SC2::Utilities::file_log("program_uniform3i called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLint : %i) y (GLint : %i) z (GLint : %i)\n", ctx, program, location, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3i: %i", err);
		
		MACH_OVERRIDE(void,program_uniform4i,(GLIContext ctx, GLuint program, GLint location, GLint x, GLint y, GLint z, GLint w), err ) {
			SC2::Utilities::file_log("program_uniform4i called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLint : %i) y (GLint : %i) z (GLint : %i) w (GLint : %i)\n", ctx, program, location, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4i: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1f,(GLIContext ctx, GLuint program, GLint location, GLfloat x), err ) {
			SC2::Utilities::file_log("program_uniform1f called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLfloat : %f)\n", ctx, program, location, x);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1f: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y), err ) {
			SC2::Utilities::file_log("program_uniform2f called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLfloat : %f) y (GLfloat : %f)\n", ctx, program, location, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2f: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z), err ) {
			SC2::Utilities::file_log("program_uniform3f called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLfloat : %f) y (GLfloat : %f) z (GLfloat : %f)\n", ctx, program, location, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3f: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform4f,(GLIContext ctx, GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w), err ) {
			SC2::Utilities::file_log("program_uniform4f called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLfloat : %f) y (GLfloat : %f) z (GLfloat : %f) w (GLfloat : %f)\n", ctx, program, location, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4f: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			SC2::Utilities::file_log("program_uniform1iv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1iv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			SC2::Utilities::file_log("program_uniform2iv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2iv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			SC2::Utilities::file_log("program_uniform3iv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3iv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform4iv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLint *value), err ) {
			SC2::Utilities::file_log("program_uniform4iv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4iv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform1fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1fv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform2fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2fv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform3fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3fv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform4fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix4fv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1ui,(GLIContext ctx, GLuint program, GLint location, GLuint x), err ) {
			SC2::Utilities::file_log("program_uniform1ui called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLuint : %u)\n", ctx, program, location, x);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1ui: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y), err ) {
			SC2::Utilities::file_log("program_uniform2ui called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLuint : %u) y (GLuint : %u)\n", ctx, program, location, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2ui: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y, GLuint z), err ) {
			SC2::Utilities::file_log("program_uniform3ui called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLuint : %u) y (GLuint : %u) z (GLuint : %u)\n", ctx, program, location, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3ui: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform4ui,(GLIContext ctx, GLuint program, GLint location, GLuint x, GLuint y, GLuint z, GLuint w), err ) {
			SC2::Utilities::file_log("program_uniform4ui called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLuint : %u) y (GLuint : %u) z (GLuint : %u) w (GLuint : %u)\n", ctx, program, location, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4ui: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			SC2::Utilities::file_log("program_uniform1uiv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLuint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1uiv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			SC2::Utilities::file_log("program_uniform2uiv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLuint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2uiv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			SC2::Utilities::file_log("program_uniform3uiv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLuint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3uiv: %i", err);
		
		MACH_OVERRIDE(void,program_uniform4uiv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value), err ) {
			SC2::Utilities::file_log("program_uniform4uiv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLuint* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4uiv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2x3fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2x3fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3x2fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3x2fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2x4fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2x4fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x2fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4x2fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix4x2fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x4fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3x4fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3x4fv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x3fv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4x3fv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLfloat* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix4x3fv: %i", err);
		...
		MACH_OVERRIDE(void,bind_frag_data_location_indexed,(GLIContext ctx, GLuint program, GLuint colorNumber, GLuint index, const GLchar *name), err ) {
			SC2::Utilities::file_log("bind_frag_data_location_indexed called: ctx (GLIContext : %p) program (GLuint : %u) colorNumber (GLuint : %u) index (GLuint : %u) name (const GLchar* : %p)\n", ctx, program, colorNumber, index, name);
			opengl_api_mutex.lock();
			OpenGL::Shared->bind_frag_data_location_indexed(ctx, program, colorNumber, index, name);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_frag_data_location_indexed: %i", err);
		
		MACH_OVERRIDE(GLint,get_frag_data_index,(GLIContext ctx, GLuint program, const GLchar *name), err ) {
			SC2::Utilities::file_log("get_frag_data_index called: ctx (GLIContext : %p) program (GLuint : %u) name (const GLchar* : %p)\n", ctx, program, name);
		...
		MACH_OVERRIDE(void,blend_func_separate_i,(GLIContext ctx, GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha), err ) {
			SC2::Utilities::file_log("blend_func_separate_i called: ctx (GLIContext : %p) buf (GLuint : %u) srcRGB (GLenum : %s) dstRGB (GLenum : %s) srcAlpha (GLenum : %s) dstAlpha (GLenum : %s)\n", ctx, buf, GLenumToString(srcRGB).c_str(), GLenumToString(dstRGB).c_str(), GLenumToString(srcAlpha).c_str(), GLenumToString(dstAlpha).c_str());
		...
		if (err)
			SC2::Utilities::console_log("Failed to override blend_equation_separate_i: %i", err);
		...
		MACH_OVERRIDE(void,named_string_ARB,(GLIContext ctx, GLenum type, GLint namelen, const GLchar *name, GLint stringlen, const GLchar *string), err ) {
			SC2::Utilities::file_log("named_string_ARB called: ctx (GLIContext : %p) type (GLenum : %s) namelen (GLint : %i) name (const GLchar* : %p) stringlen (GLint : %i) string (const GLchar* : %p)\n", ctx, GLenumToString(type).c_str(), namelen, name, stringlen, string);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override named_string_ARB: %i", err);
		
		MACH_OVERRIDE(void,delete_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name), err ) {
			SC2::Utilities::file_log("delete_named_string_ARB called: ctx (GLIContext : %p) namelen (GLint : %i) name (const GLchar* : %p)\n", ctx, namelen, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_named_string_ARB: %i", err);
		...
		MACH_OVERRIDE(void,compile_shader_include_ARB,(GLIContext ctx, GLuint shader, GLsizei count, const GLchar* const *path, const GLint *length), err ) {
			SC2::Utilities::file_log("compile_shader_include_ARB called: ctx (GLIContext : %p) shader (GLuint : %u) count (GLsizei : %i) path (const GLchar*const* : %p) length (const GLint* : %p)\n", ctx, shader, count, path, length);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override compile_shader_include_ARB: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name), err ) {
			SC2::Utilities::file_log("is_named_string_ARB called: ctx (GLIContext : %p) namelen (GLint : %i) name (const GLchar* : %p)\n", ctx, namelen, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_named_string_ARB: %i", err);
		...
		MACH_OVERRIDE(void,get_named_string_ARB,(GLIContext ctx, GLint namelen, const GLchar *name, GLsizei bufSize, GLint *stringlen, GLchar *string), err ) {
			SC2::Utilities::file_log("get_named_string_ARB called: ctx (GLIContext : %p) namelen (GLint : %i) name (const GLchar* : %p) bufSize (GLsizei : %i) stringlen (GLint* : %p) string (GLchar* : %p)\n", ctx, namelen, name, bufSize, stringlen, string);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_named_string_ARB: %i", err);
		
		MACH_OVERRIDE(void,get_named_string_iv_ARB,(GLIContext ctx, GLint namelen, const GLchar *name, GLenum pname, GLint *params), err ) {
			SC2::Utilities::file_log("get_named_string_iv_ARB called: ctx (GLIContext : %p) namelen (GLint : %i) name (const GLchar* : %p) pname (GLenum : %s) params (GLint* : %p)\n", ctx, namelen, name, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_named_string_iv_ARB: %i", err);
		
		MACH_OVERRIDE(void,release_shader_compiler,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("release_shader_compiler called: ctx (GLIContext : %p)\n", ctx);
			return release_shader_compiler_reenter(ctx);
		} END_MACH_OVERRIDE_PTR(release_shader_compiler, obj->disp.release_shader_compiler);
		
		if (err)
			SC2::Utilities::console_log("Failed to override release_shader_compiler: %i", err);
		...
		MACH_OVERRIDE(void,shader_binary,(GLIContext ctx, GLint n, GLuint *shaders, GLenum binaryformat, const GLvoid *binary, GLint length), err ) {
			SC2::Utilities::file_log("shader_binary called: ctx (GLIContext : %p) n (GLint : %i) shaders (GLuint* : %p) binaryformat (GLenum : %s) binary (const GLvoid* : %p) length (GLint : %i)\n", ctx, n, shaders, GLenumToString(binaryformat).c_str(), binary, length);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override shader_binary: %i", err);
		...
		MACH_OVERRIDE(void,get_shader_precision_format,(GLIContext ctx, GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision), err ) {
			SC2::Utilities::file_log("get_shader_precision_format called: ctx (GLIContext : %p) shadertype (GLenum : %s) precisiontype (GLenum : %s) range (GLint* : %p) precision (GLint* : %p)\n", ctx, GLenumToString(shadertype).c_str(), GLenumToString(precisiontype).c_str(), range, precision);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_shader_precision_format: %i", err);
		
		MACH_OVERRIDE(void,depth_rangef,(GLIContext ctx, GLclampf zNear, GLclampf zFar), err ) {
			SC2::Utilities::file_log("depth_rangef called: ctx (GLIContext : %p) zNear (GLclampf : %f) zFar (GLclampf : %f)\n", ctx, zNear, zFar);
			return depth_rangef_reenter(ctx, zNear, zFar);
		} END_MACH_OVERRIDE_PTR(depth_rangef, obj->disp.depth_rangef);
		
		if (err)
			SC2::Utilities::console_log("Failed to override depth_rangef: %i", err);
		
		MACH_OVERRIDE(void,clear_depthf,(GLIContext ctx, GLclampf depth), err ) {
			SC2::Utilities::file_log("clear_depthf called: ctx (GLIContext : %p) depth (GLclampf : %f)\n", ctx, depth);
			return clear_depthf_reenter(ctx, depth);
		} END_MACH_OVERRIDE_PTR(clear_depthf, obj->disp.clear_depthf);
		
		if (err)
			SC2::Utilities::console_log("Failed to override clear_depthf: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribP1ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			SC2::Utilities::file_log("vertex_attribP1ui called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (GLuint : %u)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP1ui: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribP2ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			SC2::Utilities::file_log("vertex_attribP2ui called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (GLuint : %u)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP2ui: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribP3ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			SC2::Utilities::file_log("vertex_attribP3ui called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (GLuint : %u)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP3ui: %i", err);
		
		MACH_OVERRIDE(void,vertex_attribP4ui,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, GLuint value), err ) {
			SC2::Utilities::file_log("vertex_attribP4ui called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (GLuint : %u)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP4ui: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attribP1uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			SC2::Utilities::file_log("vertex_attribP1uiv called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (const GLuint* : %p)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP1uiv: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attribP2uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			SC2::Utilities::file_log("vertex_attribP2uiv called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (const GLuint* : %p)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP2uiv: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attribP3uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			SC2::Utilities::file_log("vertex_attribP3uiv called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (const GLuint* : %p)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP3uiv: %i", err);
		...
		MACH_OVERRIDE(void,vertex_attribP4uiv,(GLIContext ctx, GLuint index, GLenum type, GLboolean normalized, const GLuint *value), err ) {
			SC2::Utilities::file_log("vertex_attribP4uiv called: ctx (GLIContext : %p) index (GLuint : %u) type (GLenum : %s) normalized (GLboolean : %i) value (const GLuint* : %p)\n", ctx, index, GLenumToString(type).c_str(), normalized, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attribP4uiv: %i", err);
		...
		MACH_OVERRIDE(void,get_program_binary,(GLIContext ctx, GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary), err ) {
			SC2::Utilities::file_log("get_program_binary called: ctx (GLIContext : %p) program (GLuint : %u) bufSize (GLsizei : %i) length (GLsizei* : %p) binaryFormat (GLenum* : %p) binary (GLvoid* : %p)\n", ctx, program, bufSize, length, binaryFormat, binary);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_binary: %i", err);
		...
		MACH_OVERRIDE(void,program_binary,(GLIContext ctx, GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length), err ) {
			SC2::Utilities::file_log("program_binary called: ctx (GLIContext : %p) program (GLuint : %u) binaryFormat (GLenum : %s) binary (const GLvoid* : %p) length (GLsizei : %i)\n", ctx, program, GLenumToString(binaryFormat).c_str(), binary, length);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_arrays_indirect: %i", err);
		
		MACH_OVERRIDE(void,draw_elements_indirect,(GLIContext ctx, GLenum mode, GLenum type, const GLvoid *indirect), err ) {
			SC2::Utilities::file_log("draw_elements_indirect called: ctx (GLIContext : %p) mode (GLenum : %s) type (GLenum : %s) indirect (const GLvoid* : %p)\n", ctx, GLenumToString(mode).c_str(), GLenumToString(type).c_str(), indirect);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_elements_indirect(ctx, mode, type, indirect);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override bind_transform_feedback: %i", err);
		
		MACH_OVERRIDE(void,gen_transform_feedbacks,(GLIContext ctx, GLsizei n, GLuint* ids), err ) {
			SC2::Utilities::file_log("gen_transform_feedbacks called: ctx (GLIContext : %p) n (GLsizei : %i) ids (GLuint* : %p)\n", ctx, n, ids);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override gen_transform_feedbacks: %i", err);
		
		MACH_OVERRIDE(void,delete_transform_feedbacks,(GLIContext ctx, GLsizei n, const GLuint* ids), err ) {
			SC2::Utilities::file_log("delete_transform_feedbacks called: ctx (GLIContext : %p) n (GLsizei : %i) ids (const GLuint* : %p)\n", ctx, n, ids);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override delete_transform_feedbacks: %i", err);
		
		MACH_OVERRIDE(void,pause_transform_feedback,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("pause_transform_feedback called: ctx (GLIContext : %p)\n", ctx);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override pause_transform_feedback: %i", err);
		
		MACH_OVERRIDE(void,resume_transform_feedback,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("resume_transform_feedback called: ctx (GLIContext : %p)\n", ctx);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override resume_transform_feedback: %i", err);
		
		MACH_OVERRIDE(GLboolean,is_transform_feedback,(GLIContext ctx, GLuint name), err ) {
			SC2::Utilities::file_log("is_transform_feedback called: ctx (GLIContext : %p) name (GLuint : %u)\n", ctx, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override is_transform_feedback: %i", err);
		
		MACH_OVERRIDE(void,draw_transform_feedback,(GLIContext ctx, GLenum mode, GLuint name), err ) {
			SC2::Utilities::file_log("draw_transform_feedback called: ctx (GLIContext : %p) mode (GLenum : %s) name (GLuint : %u)\n", ctx, GLenumToString(mode).c_str(), name);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_transform_feedback(ctx, mode, name);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_transform_feedback: %i", err);
		
		MACH_OVERRIDE(void,begin_query_indexed,(GLIContext ctx, GLenum target, GLuint index, GLuint id), err ) {
			SC2::Utilities::file_log("begin_query_indexed called: ctx (GLIContext : %p) target (GLenum : %s) index (GLuint : %u) id (GLuint : %u)\n", ctx, GLenumToString(target).c_str(), index, id);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_query_indexediv: %i", err);
		
		MACH_OVERRIDE(void,draw_transform_feedback_stream,(GLIContext ctx, GLenum mode, GLuint name, GLuint stream), err ) {
			SC2::Utilities::file_log("draw_transform_feedback_stream called: ctx (GLIContext : %p) mode (GLenum : %s) name (GLuint : %u) stream (GLuint : %u)\n", ctx, GLenumToString(mode).c_str(), name, stream);
			opengl_api_mutex.lock();
			OpenGL::Shared->draw_transform_feedback_stream(ctx, mode, name, stream);
			opengl_api_mutex.unlock();
		...
		if (err)
			SC2::Utilities::console_log("Failed to override draw_transform_feedback_stream: %i", err);
		
		MACH_OVERRIDE(void,program_uniform1d,(GLIContext ctx, GLuint program, GLint location, GLdouble x), err ) {
			SC2::Utilities::file_log("program_uniform1d called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLdouble : %f)\n", ctx, program, location, x);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1d: %i", err);
		
		MACH_OVERRIDE(void,program_uniform2d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y), err ) {
			SC2::Utilities::file_log("program_uniform2d called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLdouble : %f) y (GLdouble : %f)\n", ctx, program, location, x, y);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2d: %i", err);
		
		MACH_OVERRIDE(void,program_uniform3d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y, GLdouble z), err ) {
			SC2::Utilities::file_log("program_uniform3d called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLdouble : %f) y (GLdouble : %f) z (GLdouble : %f)\n", ctx, program, location, x, y, z);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3d: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform4d,(GLIContext ctx, GLuint program, GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w), err ) {
			SC2::Utilities::file_log("program_uniform4d called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) x (GLdouble : %f) y (GLdouble : %f) z (GLdouble : %f) w (GLdouble : %f)\n", ctx, program, location, x, y, z, w);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4d: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform1dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform1dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform1dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform2dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform2dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform3dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform3dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform4dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform4dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix4dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2x3dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2x3dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3x2dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3x2dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix2x4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix2x4dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix2x4dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x2dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4x2dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix4x2dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix3x4dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix3x4dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override program_uniform_matrix3x4dv: %i", err);
		...
		MACH_OVERRIDE(void,program_uniform_matrix4x3dv,(GLIContext ctx, GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("program_uniform_matrix4x3dv called: ctx (GLIContext : %p) program (GLuint : %u) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, program, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,uniform_matrix2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix4dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix2x3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2x3dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2x3dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3x2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3x2dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3x2dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix2x4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix2x4dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix2x4dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4x2dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4x2dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix4x2dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix3x4dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix3x4dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_matrix3x4dv: %i", err);
		...
		MACH_OVERRIDE(void,uniform_matrix4x3dv,(GLIContext ctx, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value), err ) {
			SC2::Utilities::file_log("uniform_matrix4x3dv called: ctx (GLIContext : %p) location (GLint : %i) count (GLsizei : %i) transpose (GLboolean : %i) value (const GLdouble* : %p)\n", ctx, location, count, transpose, value);
		...
		MACH_OVERRIDE(void,vertex_attrib_lpointer,(GLIContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride, const void *pointer), err ) {
			SC2::Utilities::file_log("vertex_attrib_lpointer called: ctx (GLIContext : %p) index (GLuint : %u) size (GLint : %i) type (GLenum : %s) stride (GLsizei : %i) pointer (const void* : %p)\n", ctx, index, size, GLenumToString(type).c_str(), stride, pointer);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override vertex_attrib_lpointer: %i", err);
		
		MACH_OVERRIDE(void,get_vertex_attrib_ldv,(GLIContext ctx, GLuint index, GLenum pname, GLdouble *params), err ) {
			SC2::Utilities::file_log("get_vertex_attrib_ldv called: ctx (GLIContext : %p) index (GLuint : %u) pname (GLenum : %s) params (GLdouble* : %p)\n", ctx, index, GLenumToString(pname).c_str(), params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_vertex_attrib_ldv: %i", err);
		...
		MACH_OVERRIDE(GLint,get_subroutine_uniform_location,(GLIContext ctx, GLuint program, GLenum shadertype, const GLchar *name), err ) {
			SC2::Utilities::file_log("get_subroutine_uniform_location called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) name (const GLchar* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_subroutine_uniform_location: %i", err);
		
		MACH_OVERRIDE(GLuint,get_subroutine_index,(GLIContext ctx, GLuint program, GLenum shadertype, const GLchar *name), err ) {
			SC2::Utilities::file_log("get_subroutine_index called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) name (const GLchar* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_subroutine_index: %i", err);
		...
		MACH_OVERRIDE(void,get_active_subroutine_uniformiv,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLenum pname, GLint *values), err ) {
			SC2::Utilities::file_log("get_active_subroutine_uniformiv called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) index (GLuint : %u) pname (GLenum : %s) values (GLint* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), index, GLenumToString(pname).c_str(), values);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_subroutine_uniformiv: %i", err);
		...
		MACH_OVERRIDE(void,get_active_subroutine_uniform_name,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name), err ) {
			SC2::Utilities::file_log("get_active_subroutine_uniform_name called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) index (GLuint : %u) bufsize (GLsizei : %i) length (GLsizei* : %p) name (GLchar* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), index, bufsize, length, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_subroutine_uniform_name: %i", err);
		...
		MACH_OVERRIDE(void,get_active_subroutine_name,(GLIContext ctx, GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name), err ) {
			SC2::Utilities::file_log("get_active_subroutine_name called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) index (GLuint : %u) bufsize (GLsizei : %i) length (GLsizei* : %p) name (GLchar* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), index, bufsize, length, name);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_active_subroutine_name: %i", err);
		
		MACH_OVERRIDE(void,uniform_subroutinesuiv,(GLIContext ctx, GLenum shadertype, GLsizei count, const GLuint *indices), err ) {
			SC2::Utilities::file_log("uniform_subroutinesuiv called: ctx (GLIContext : %p) shadertype (GLenum : %s) count (GLsizei : %i) indices (const GLuint* : %p)\n", ctx, GLenumToString(shadertype).c_str(), count, indices);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override uniform_subroutinesuiv: %i", err);
		
		MACH_OVERRIDE(void,get_uniform_subroutineuiv,(GLIContext ctx, GLenum shadertype, GLint location, GLuint *params), err ) {
			SC2::Utilities::file_log("get_uniform_subroutineuiv called: ctx (GLIContext : %p) shadertype (GLenum : %s) location (GLint : %i) params (GLuint* : %p)\n", ctx, GLenumToString(shadertype).c_str(), location, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_uniform_subroutineuiv: %i", err);
		
		MACH_OVERRIDE(void,get_program_stageiv,(GLIContext ctx, GLuint program, GLenum shadertype, GLenum pname, GLint *values), err ) {
			SC2::Utilities::file_log("get_program_stageiv called: ctx (GLIContext : %p) program (GLuint : %u) shadertype (GLenum : %s) pname (GLenum : %s) values (GLint* : %p)\n", ctx, program, GLenumToString(shadertype).c_str(), GLenumToString(pname).c_str(), values);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_program_stageiv: %i", err);
		...
		MACH_OVERRIDE(void,get_internal_formativ,(GLIContext ctx, GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint* params), err ) {
			SC2::Utilities::file_log("get_internal_formativ called: ctx (GLIContext : %p) target (GLenum : %s) internalformat (GLenum : %s) pname (GLenum : %s) bufSize (GLsizei : %i) params (GLint* : %p)\n", ctx, GLenumToString(target).c_str(), GLenumToString(internalformat).c_str(), GLenumToString(pname).c_str(), bufSize, params);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override get_internal_formativ: %i", err);
		
		MACH_OVERRIDE(void,tex_storage1D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width), err ) {
			SC2::Utilities::file_log("tex_storage1D called: ctx (GLIContext : %p) target (GLenum : %s) levels (GLsizei : %i) internalformat (GLenum : %s) width (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), levels, GLenumToString(internalformat).c_str(), width);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_storage1D: %i", err);
		...
		MACH_OVERRIDE(void,tex_storage2D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height), err ) {
			SC2::Utilities::file_log("tex_storage2D called: ctx (GLIContext : %p) target (GLenum : %s) levels (GLsizei : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), levels, GLenumToString(internalformat).c_str(), width, height);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_storage2D: %i", err);
		...
		MACH_OVERRIDE(void,tex_storage3D,(GLIContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth), err ) {
			SC2::Utilities::file_log("tex_storage3D called: ctx (GLIContext : %p) target (GLenum : %s) levels (GLsizei : %i) internalformat (GLenum : %s) width (GLsizei : %i) height (GLsizei : %i) depth (GLsizei : %i)\n", ctx, GLenumToString(target).c_str(), levels, GLenumToString(internalformat).c_str(), width, height, depth);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override tex_storage3D: %i", err);
		
		MACH_OVERRIDE(void,label_object_with_responsible_process_APPLE,(GLIContext ctx, GLenum type, GLuint name, GLint pid), err ) {
			SC2::Utilities::file_log("label_object_with_responsible_process_APPLE called: ctx (GLIContext : %p) type (GLenum : %s) name (GLuint : %u) pid (GLint : %i)\n", ctx, GLenumToString(type).c_str(), name, pid);
		...
		if (err)
			SC2::Utilities::console_log("Failed to override label_object_with_responsible_process_APPLE: %i", err);
		
		MACH_OVERRIDE(void,texture_barrier_NV,(GLIContext ctx), err ) {
			SC2::Utilities::file_log("texture_barrier_NV called: ctx (GLIContext : %p)\n", ctx);
			return texture_barrier_NV_reenter(ctx);
		} END_MACH_OVERRIDE_PTR(texture_barrier_NV, obj->disp.texture_barrier_NV);
		
		if (err)
			SC2::Utilities::console_log("Failed to override texture_barrier_NV: %i", err);
		
		SC2::Utilities::unsuspend_all_threads();
		
		SC2::Utilities::console_log("Finished overriding Context Function PTRs");
		SC2::Utilities::screen_log("Finished overriding Context Function PTRs");
	}
}
...
void OverrideCGLGetContext()
{
	...
	if (!handle)
		SC2::Utilities::console_log("Failed to open libGL.  %s", dlerror());
	
	void* opengl_function = dlsym(handle, "CGLGetCurrentContext");
	
	if (!opengl_function)
		SC2::Utilities::console_log("Failed to find _CGLGetCurrentContext.  %s", dlerror());
	...
	if (err)
		SC2::Utilities::console_log("OpenGLFileLogger: Error overriding OpenGL call 'CGLGetCurrentContext' %i", err);
