...
extern "C" OpenGL::StateMachine* make_new_state_machine()
{
	SC2::Utilities::screen_log("SC2 State Machine v%s (%s) Loaded.", VERSION, BUILD_NUMBER);

	return new OpenGL::SC2_StateMachine;
}

extern "C" void set_shared(OpenGL::StateMachine* machine)
{
	OpenGL::Shared = machine;
}
